      ...
      <div class="panel panel-info">
            ...
            <div class="box-body fixed-panel-side-dos mCustomScrollbar" data-mcs-theme="dark">
                <ul class="nav nav-pills nav-stacked">
                 <li class="my_hover"><a style='cursor: pointer;' href="<?php echo base_url()?>app/downloadable_forms/get_downloadable_company/All"><i class='fa fa-circle-o'></i> <span>All Downloadable Forms </span></a></li>
                    <?php
  ...
  <div class="col-md-9" style="padding-bottom: 50px;">
    <div class="box box-success">
      <div class="panel panel-info"  id="fetch_all_result">
       <ol class="breadcrumb"><h4 class="text-danger" style="font-weight: bold;"><i class="fa fa-bars"></i>Downloadable Forms <?php if($company_id=='All'){}else{?> | <?php echo $company_name;?>  
      <?php echo "<a type='button' class='<?php echo $add_dl_forms;?> btn btn-success btn-xs pull-right' data-toggle='modal' data-target='#modal' href='".base_url('app/downloadable_forms/add_downloadable_forms')."/".$company_id."'>";?>Add New</a><?php } ?>
       </h4>
      </ol>
          ...
          if(result==true)
          {
            ...
            {// code for IE6, IE5
              ...
              xmlhttp.onreadystatechange=function()
                ...
                xmlhttp.open("GET","<?php echo base_url();?>app/downloadable_forms/action_downloadable/"+action+"/"+company+"/"+id,true);
                xmlhttp.send();
          }
      }
    </script>