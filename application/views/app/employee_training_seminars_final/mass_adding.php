<ol class="breadcrumb"><h4 class="text-danger" style="font-weight: bold;"><i class="fa fa-bars"></i>Mass Adding Employee Trainings and Seminars
<n id="assign_employee_id">

</n>
</h4></ol>
  
            <form enctype="multipart/form-data" method="post" action="<?php echo base_url()?>app/employee_training_seminars_final/save_mass_adding" >
            ...
            <div class="col-md-12" style="margin-top: 5px;">
              ...
              <div class="col-md-6">
                  <div class="col-md-4"><label>Training Title</label></div>
                    <div class="col-md-8">
                      <select class="form-control" id="title" name="title" required onchange="get_all_trainings_details_mass_adding(this.value);">
