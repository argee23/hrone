...
<?php foreach($details as $d) { ?>
  ...
  <div class="col-md-8">
        ...
        <?php if($d->fee_type=='company'){ $df=''; } else{ $df='disabled'; }?>
        <div class="col-md-12" style="margin-top: 10px;" id="requiredMonthscompany">
                        <div class="col-md-4"><label>Months required</label></div>
                          <div class="col-md-8"> 
                            <input type="text" class="form-control" id="requiredmonths" name="requiredmonths" value="<?php echo $d->monthsRequired;?>" onkeypress="return isNumberKey(this, event);" <?php echo $df;?>>
...
<div class="col-md-12" style="margin-top:20px;"><button type="submit" id="smbt_ind" class="col-md-12 btn btn-success" style="display: none;">SAVE</button></div>
