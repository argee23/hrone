<ol class="breadcrumb"><h4 class="text-danger" style="font-weight: bold;"><i class="fa fa-bars"></i>Add New Employee Trainings and Seminars</h4></ol>

            <form enctype="multipart/form-data" method="post" action="<?php echo base_url()?>app/employee_training_seminars_final/save_individual_adding/individual_adding" >
            ...
            <div class="col-md-12" style="margin-top: 5px;">
              ...
              <div class="col-md-6">
                  ...
                  <div class="col-md-6">
                    <a data-toggle="modal" data-target="#add_employee"> <input type="text" class="form-control" name="employee_name" id="employee_name" required> </a>
