...
<ol class="breadcrumb">
  <h4 class="text-danger" style="font-weight: bold;"><i class="fa fa-bars"></i>Training and Seminar Details 
    <button class="btn btn-info btn-xs pull-right" style="cursor: pointer;"  data-toggle='modal' data-target='#modal' href="<?php echo base_url('app/employee_training_seminars_final/add_mass_employees');?>"><i class="fa fa-pencil"></i>&nbsp;Update Employees</button>
...
<form enctype="multipart/form-data" method="post" action="<?php echo base_url()?>app/employee_training_seminars_final/incomingtraining_seminar_modify/<?php echo $id;?>">
 ...
 <?php foreach($details as $training_seminar){?>
  <input type="hidden" name="training_seminar_id" value="<?php echo $training_seminar->training_seminar_id;?>">
    <div>
     <div class="col-md-8">   
     <div class="panel panel-success panel-heading"  id='action_trans' >
              ...
              <div class="col-md-12"  style="margin-top: 10px;">
               <div class="col-md-12">
                  <input type="hidden" name="seminarid" id="seminarid" value="<?php echo $training_seminar->training_seminar_id;?>">
                    <div class="text-danger" id="date_list" style="padding-left: 30px;height:200px;overflow-y:scroll;" >
                      <center>
                        <?php  $dates = $this->employee_training_seminars_final_model->get_incoming_trainingseminars_date($training_seminar->training_seminar_id); ?>    
