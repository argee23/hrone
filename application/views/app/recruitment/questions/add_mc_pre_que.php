<div class="well">
<!-- form start -->
  <form class="form-horizontal" method="post" action="<?php echo base_url()?>app/recruitment/save_mc_pre_que" >
    <div class="box-body">
      <div class="form-group">
        ...
        <div class="col-sm-12">
          <select class="form-control select2" name="mc_company[]" id="mc_company" style="width: 100%;" multiple="multiple" required="required">
            <?php 
