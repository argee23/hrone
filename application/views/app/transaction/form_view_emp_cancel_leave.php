...
<div  id="printableArea"> <!-- this is important -->
 ...
 $cur_form= $this->uri->segment('6');
  foreach($file as $file_doc){
    ...
    $getcompany = $this->transaction_employees_model->get_emp_company_id($file_doc->doc_number);
    $cID=$getcompany; 
  ...
  <tr>
    <th colspan="4" style="text-align: center">APPLICATION FOR CANCEL LEAVE OR ABSENCE FORM 
  ...
  <tr>
    ...
    <td>
    <p class="text-primary">DOCUMENT NO:</p></td>  <td><?php echo $file_doc->doc_number;?>
    </td>   
  </tr>
  <tr>
  ...
  ?>
  <?php $style=""; if ($file_doc->stat == 'approved') { $style= "style='color: green; border: 2px solid green'"; } ?>
  <td colspan="4" style="text-align: center" <?php echo $style; ?>><label style="transform: rotate(-40deg);
  transform-origin: left top 50;"><p class="rubber_stamp t" <?php echo $style; ?> ><?php echo $file_doc->stat; ?></p></label></td></tr>
  ...
  <tr>
      <td ><p class="text-primary">Leave Doc Number</p></td> 
      <td><a target="_blank" href="<?php echo base_url();?>app/transaction_employees/form_view/<?php echo $file_doc->cancelled_doc_no;?>/employee_leave/HR002"><?php echo $file_doc->cancelled_doc_no; ?></a></td> 
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td><?php echo $file_doc->days; if($file_doc->no_of_days==1){ echo " (Wholeday) ";} else{ echo " (Halfday) ";} ?></td>  
    <td ><p class="text-primary">EFFECTIVE DATE:</p></td>
    <td> 
        <?php 
  ...
  <tr>
    ...
    <td><?php echo $file_doc->apply_reason;?></td> 
     <td><p class="text-primary">REASON FOR CANCELLING LEAVE:</p></td> 
...
$doc= $file_doc->doc;
$get_all_app=$this->transaction_employees_model->get_docno_approvers($doc,$table_name);
...
$app_position=$doc_app->position_name;
  ...
  $dt = "";
  $type="";
$trans_stat=$this->transaction_employees_model->get_trans_status($doc_app->approver,$file_doc->doc_number, $table_name,$doc_app->approval_level);
