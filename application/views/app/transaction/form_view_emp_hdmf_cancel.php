...
<div  id="printableArea"> <!-- this is important -->
  ...
  <tr>
    <th colspan="4" style="text-align: center">REQUEST FOR CANCELLATION OF HDMF LOAN PAYMENTS FORM
 ...
 <tr>
  ...
  <?php if(!empty($file_doc->reason)){?>  <p class="text-danger">reason of cancelling:</p>  <?php echo $file_doc->reason;?><?php } ?>
