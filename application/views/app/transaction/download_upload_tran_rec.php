...
<strong>Download/Upload Employee Transactions</strong> 
  ...
  <div class="box-body">
	...
	<div class="col-md-6">
		...
		<div class="col-md-6">
		 <form target="_blank" action="<?php echo base_url();?>app/transaction_employees_upload/manual_upload_forms/" method="post" name="upload_excel" enctype="multipart/form-data">
		<div class="box box-success">
			...
			<div class="box-body">
				...
				<div class="form-group" >
					<div class="col-sm-12">	
					<input type="hidden" name="add_edit" value="new">
