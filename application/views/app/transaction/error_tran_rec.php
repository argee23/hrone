...
<div class="content-wrapper2">
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li class="active">Error <?php echo urldecode($this->uri->segment('5'));?> Transactions</li>
    </ol>
  </section>
    ...
    <div class="col-md-12">
      ...
      <div class="box box-info">
        ...
        <div class="box-header">
          <strong><a class="text-danger"><i class="fa fa-info-circle"></i> Error</a>&nbsp;<u> <?php echo urldecode($this->uri->segment('5'));?> Transactions</u></strong>     
...
$get_all_app=$this->transaction_employees_model->get_all_app($dept,$sect,$clas,$cur_form);
if(empty($get_all_app)){echo ' <i class="fa fa-question text-danger"></i>  no assigned approvers ';}
else{
	echo 'with approver';
}
?>	
