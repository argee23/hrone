...
if($tran_sdf_act_deac=="hidden "){
      echo '<i class="fa fa-info" title="Not Allowed . Check Access Rights"></i>';
}else{
          echo anchor('app/transaction_file_maintenance/activate_transaction/'.$file_doc->identification,'<i class="fa fa-'.$system_defined_icons->icon_enable.' fa-'.$system_defined_icons->icon_size.'x" style="color:'.$system_defined_icons->icon_enable_color.';"></i>',array('data-toggle'=>'tooltip','data-placement'=>'left','title'=>'Activate?','onclick'=>"return confirm('Are you sure you want to Activate?')"));
}
...
if($tran_sdf_act_deac=="hidden "){
      echo '<i class="fa fa-info" title="Not Allowed . Check Access Rights"></i>';
        ...
        echo anchor('app/transaction_file_maintenance/deactivate_transaction/'.$file_doc->identification,'<i class="fa fa-'.$system_defined_icons->icon_disable.' fa-'.$system_defined_icons->icon_size.'x" style="color:'.$system_defined_icons->icon_disable_color.';"></i>',array('data-toggle'=>'tooltip','data-placement'=>'left','title'=>'DeActivate?','onclick'=>"return confirm('Are you sure you want to DeActivate?')"));
}
