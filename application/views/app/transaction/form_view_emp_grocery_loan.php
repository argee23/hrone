...
<div  id="printableArea"> <!-- this is important -->
  ...
  <tr>
    <th colspan="4" style="text-align: center">GROCERY ITEMS LOAN AUTHORIZATION FORM
 ...
 <tr>
  ...
  <tr>
    <td><p class="text-primary">Loan Granted - (grocery items worth)</p></td>
    <td><?php echo $file_doc->grocery_items_worth;?></td>
    <td><p class="text-primary">Last payroll period</p></td>
    <td><?php 
  ...
  <tr>
    <td><p class="text-primary">Net Pay</p></td>
    <td><?php echo $file_doc->net_pay;?></td>
    <td><p class="text-primary">Cripples / Coop Balance</p></td>
    <td><?php echo $file_doc->coop_balance;?></td>
  </tr>
      <tr>
    <td colspan="4"><hr></td>
  </tr>
