...
<div  id="printableArea"> <!-- this is important -->
  ...
  <tr>
    <th colspan="4" style="text-align: center">LOAN APPLICATION FORM
...
<tr>
  <td><p class="text-primary">LOAN TYPE:</p></td>
  <td><?php echo $file_doc->loan_type_desc?></td>
  <td><p class="text-primary">REQUESTED SCHEDULE DEDUCTION:</p></td>
  <td><?php echo $this->transaction_employees_model->get_cutoff_details($file_doc->deduction);?></td>

</tr>
<tr>
  <td><p class="text-primary">LOAN AMOUNT:</p></td>
  <td><?php echo number_format($file_doc->loan_amount,2)?></td>
  <td><p class="text-primary">REQUESTED DATE GRANTED:</p></td>
  <td><?php
...
<tr>
  ...
  <td><p class="text-primary">REQUESTED AMORTIZATION:</p></td>
