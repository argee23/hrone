...
<div  id="printableArea"> <!-- this is important -->
  ...
  <tr>
    <th colspan="4" style="text-align: center">REQUEST OF CHANGE IN REST DAY
...
<!--   <tr>
  ...
  <tr>
  <td><p class="text-primary">CURRENT REST DAY:</p></td>
  <td>
  <?php 
  ...
  <td><p class="text-primary">PAYROLL PERIOD</p></td>
  <td>
   <?php 
  ...
  ?>
   ...
   <td><p class="text-primary">REQUESTED REST DAY:</p></td>
    <td>
        <?php 
