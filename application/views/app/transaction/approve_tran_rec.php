...
<div class="content-wrapper2">
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li class="active">Approve <?php echo urldecode($this->uri->segment('5'));?> Transactions</li>
    </ol>
  </section>
    ...
    <div class="col-md-12">
      ...
      <div class="box box-info">
        ...
        <div class="box-header">
          <strong><a class="text-danger"><i class="fa fa-check-square-o"></i> Approve</a>&nbsp;<u> <?php echo urldecode($this->uri->segment('5'));?> Transactions</u></strong>     
          <form name="f" method="post" action="<?php echo base_url()?>app/transaction_employees/approve_all_transactions/<?php echo $this->uri->segment('4');?>/<?php echo $this->uri->segment('5');?>" > 
...
<button type="button" id="to_view" class="btn btn-success pull-right btn-xs " onclick ="show_view()"><i class="fa fa-folder-open"></i> view mode?</button>
                   ...
                   <button type="submit" class="btn btn-danger btn-xs pull-right" onclick="return confirm('Are you sure you want to approve all <?php echo urldecode($this->uri->segment('5'));?> ?')" data-toggle="tooltip" data-placement="left" title="" data-original-title="Click to approve all <?php echo urldecode($this->uri->segment('5'));?> "><i class="fa fa-floppy-o"></i> Approve All?</button>              
	</form>
        </div>
        <div class="box-body">

<div class="table-responsive" id="viewing">
<form name="f1" method="post" action="<?php echo base_url()?>app/transaction_employees/save_approve_transactions/<?php echo $this->uri->segment('4');?>/<?php echo $this->uri->segment('5');?>" >        
            ...
            <table class="table table-bordered table-striped">
              <thead>
                <tr>
                  ...
                  <td width="5%">Status</td>
                  <td width="20%"> 
 <button type="submit" class="btn btn-warning btn-xs pull-right" onclick="return confirm('Are you sure you want to approve selected <?php echo urldecode($this->uri->segment('5'));?> ?')" data-toggle="tooltip" data-placement="left" title="" data-original-title="Click to approve selected <?php echo urldecode($this->uri->segment('5'));?> "><i class="fa fa-floppy-o text-success"></i> Approve / Update?</button>         
                   </td>
                </tr>
              </thead>
              <tbody>
              ...
              echo $pos->position_name;
               ...
               <td>  
                  <div class="form-group">
                      ...
                      <input type="text" name="<?php echo $file_doc->id;?>" value="<?php echo $file_doc->remarks;?>" class="form-control"></input>
