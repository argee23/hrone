...
<div  id="printableArea"> <!-- this is important -->
  ...
  <tr>
    <th colspan="4" style="text-align: center">REQUEST FOR SSS CANCELLATION FORM
 ...
 <tr>
  ...
  <tr>
  <td colspan="4"><p style="text-align: center;">I am requesting for a cancellation of my current SSS, Loan effective payroll period <?php echo $file_doc->payroll_period;?>.</p>
  <p style="text-align: center;">This is In connection with my renewal application of SSS Loan.</p>
  <p class="text-danger">note:</p>
  This form is applicable for those employee who want to renew their SSS loan before the end of their amortization period. ( Fill out this form before filing a renewal ) 
  </td>
  </tr>
  <tr>
    <td colspan="4"><hr></td>
