                  ...
                  <table class="table table-bordered" id="blocked_leave"  style="margin-top:20px;">
                      ...
                      <?php foreach ($tripticket as $l) { ?>
                        <tr>
                          ...
                          <td>
                              <a class='fa fa-<?php echo $system_defined_icons->icon_delete;?>' style='cursor:pointer;color:<?php echo $system_defined_icons->icon_delete_color;?>' aria-hidden='true' data-toggle='tooltip' title='Click to delete record!'  onclick='delete_trip_ticket(<?php echo $l->id?>)'></a>
                               <a class='fa fa-<?php echo $system_defined_icons->icon_edit;?>' style='cursor:pointer;color:<?php echo $system_defined_icons->icon_edit_color;?>' aria-hidden='true' data-toggle='tooltip' title='Click to update record!'  onclick='edit_trip_ticket(<?php echo $l->id?>)'></a>
                          </td>
                        </tr>
                      <?php } ?>
                      </tbody>
