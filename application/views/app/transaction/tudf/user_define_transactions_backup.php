...
function pagdatepicker(val){
   ...
   if(data ==='Textarea')
  {
      ...
      $('#for_ml'+val).show('show');
       $('#max_length'+val).attr('readonly', false);
     $('#for_ml'+val).attr('readonly', false); 
     $('#accept_value'+val).attr('readonly', false);
     $('#for_av'+val).attr('readonly', false);
     $('#for_ml'+val).attr('readonly', false);
    ...
    $('#max_length'+val).show('show');
     ...
     $('#max_length'+val).attr('readonly', true);
     $('#for_ml'+val).attr('readonly', true); 
     $('#accept_value'+val).attr('readonly', true);
     $('#for_av'+val).attr('readonly', true);
     $('#for_ml'+val).attr('readonly', true);
     document.getElementById('for_ml'+val).innerHTML = 'Max Length';
      $("#max_length"+val).attr("placeholder", "Max Length").blur();
  }
