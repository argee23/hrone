...
<div  id="printableArea"> <!-- this is important -->
  ...
  <tr>
    <th colspan="4" style="text-align: center">TIME KEEPING COMPLAINT
  ...
  <tr>
  <td><p class="text-primary">TIME IN DATE:</p></td>
  <td>
  <?php  
  ...
  <tr >
    <td><p class="text-primary">TIME OUT DATE:</p></td>  
    <td>
    <?php  
  ...
  ?>
    ...
    <td ><p class="text-primary">TIME OUT:</p></td><td ><?php echo $file_doc->time_out;?></td> 
  </tr>
  <tr>
    <td><p class="text-primary">REASON:</p></td> 
    <td><?php echo $file_doc->reason;?> </td> 
    <td><p class="text-primary">COVERED DATE:</p></td> 
    <td>
         <?php  
  ...
  <tr>
    <td><p class="text-primary">ACTUAL LOGS [upon filing]:</p></td> 
    <td><?php echo $file_doc->my_time;?> </td> 
    <td></td> 
    <td>
