...
<div  id="printableArea"> <!-- this is important -->
  ...
  <tr>
    <th colspan="4" style="text-align: center">PAYROLL COMPLAINT FORM
  ...
  <tr>
    <td><p class="text-primary">TYPE OF COMPLAINT:</p></td>
    <td><?php echo $file_doc->complaint?></td>
    <td><p class="text-primary">PAYROLL COMPLAINTS:</p></td>
