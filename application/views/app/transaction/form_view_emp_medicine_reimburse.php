...
<div  id="printableArea"> <!-- this is important -->
  ...
  <tr>
    <th colspan="4" style="text-align: center">PURCHASED MEDICINE REIMBURSEMENT FORM
 ...
 <tr>
  ...
  <tr>
    ...
    transform-origin: left top 50;"><p class="rubber_stamp t" <?php echo $style; ?> ><?php echo $file_doc->status; ?></p></label></td>
  </tr>
  ...
  <tr>
  <td><p class="text-primary">MEDICATION OF:</p></td>
  <td><?php echo $file_doc->medication_of;?></td>
  <td><p class="text-primary">TOTAL AMOUNT TO BE REIMBURSED:</p></td>
  <td><?php echo $file_doc->amount;?></td>
  </tr>
