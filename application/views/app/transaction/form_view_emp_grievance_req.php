...
<div  id="printableArea"> <!-- this is important -->
 ...
 <tr>
  ...
  transform-origin: left top 50;"><p class="rubber_stamp t" <?php echo $style; ?> ><?php echo $file_doc->status; ?></p></label><br></td>
  </tr>
  ...
  <tr>
    <td><p class="text-primary" style="text-align: left">NATURE OF OFFENSE :<br>(case violation and sanction) </p>
    </td>
    <td>
    <?php echo $file_doc->offense_nature;?>
    </td>
    <td><p class="text-primary">LENGTH OF SERVICE</p></td>
    <td><?php echo $file_doc->service_length;?></td>
  </tr>
  <tr>
    <td><p class="text-primary" style="text-align: left">TYPE AND REASON OF GRIEVANCE : </p></td>
