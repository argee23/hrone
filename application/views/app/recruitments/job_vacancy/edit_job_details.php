...
<div class="modal-content">
     ...
     <div class="modal-header well well-sm bg-olive" >
      ...
      <div class="modal-body">
       <form class="form-horizontal" method="post" action="<?php echo base_url()?>app/recruitments/update_job_position/<?php echo $j->job_id."/".$company_id."/".$employer_type;?>">
          ...
          <span class="dl-horizontal col-sm-10">
            ...
            <dd>
                ...
                <select class="form-control" style="margin-top: 5px;" id="city" name="city" required>
                   <?php 
                        $city =  $this->recruitments_model->get_city($j->loc_province); 
        ...
        <div class="panel-body">
          ...
          else
          {
            $i=0; foreach($requirements as $r){ 
              $check_exist = $this->recruitments_model->check_if_exist($j->job_id,'req_per_jobs','req_id',$r->id);
