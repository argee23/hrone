              ...
              <div id='interview_process_details' style="display: none;">
                  ...
                  <div class="panel-body">
                    <span class="dl-horizontal col-sm-12">
                         ...
                         <?php if($recheck_added=='none'){ ?>

                             <div class="callout callout-danger">
                                <h4><i class="icon fa fa-warning"></i>No Applicant Interview Process History Found!</h4>
                             </div>

                        <?php } else {  foreach($interview_status as $is){
...
function save_interview_request(id,numbering,app_id)
{
    ...
    else
    {
        ...
        xmlhttp2.open("GET","<?php echo base_url();?>app/recruitments/save_interview_request_first/"+date+"/"+time+"/"+message_final+"/"+address_final+"/"+id+"/"+numbering+"/"+app_id+"/"+interviewer,false);
        xmlhttp2.send();
    }
...
function save_company_response(id)
{
  ...
  else
  {
    ...
    xmlhttp2.open("GET","<?php echo base_url();?>app/recruitments/save_company_response/"+id+"/"+response+"/"+date+"/"+time,false);
    xmlhttp2.send();
  }
