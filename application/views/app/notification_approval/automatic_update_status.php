 <?php 
  /*
    ...
    -----------------------------------
    */
    $add_auto_discactmem_approve=$this->session->userdata('add_auto_discactmem_approve');
    $edit_auto_discactmem_approve=$this->session->userdata('edit_auto_discactmem_approve');
    $del_auto_discactmem_approve=$this->session->userdata('del_auto_discactmem_approve');
    $ena_dis_auto_discactmem_approve=$this->session->userdata('ena_dis_auto_discactmem_approve');
...
<?php  
     if($add_auto_discactmem_approve=="hidden "){
          ...
          <table id="automatic_approver" class="col-md-12 table table-hover table-striped">
                ...
                <?php foreach($details as $d){?>
                  <tr>
                    ...
                    <td>
                        <a class='<?php echo $edit_auto_discactmem_approve;?> fa fa-<?php echo $system_defined_icons->icon_edit;?>' style='cursor:pointer;color:<?php echo $system_defined_icons->icon_edit_color;?>' aria-hidden='true' data-toggle='tooltip' title='Click to edit!' 
                          onclick='settings_update_automatic_update_status("<?php echo $d->company_id;?>");'></a>
                          
                         <a class='<?php echo $del_auto_discactmem_approve;?> fa fa-<?php echo $system_defined_icons->icon_delete;?>' style='cursor:pointer;color:<?php echo $system_defined_icons->icon_delete_color;?>' aria-hidden='true' data-toggle='tooltip' title='Click to delete record!'  
                         onclick='settings_automatic_update_status("delete","<?php echo $d->company_id;?>");'></a>

                         <?php if($d->InActive==1)
                         { ?>
                            <a class='<?php echo $ena_dis_auto_discactmem_approve;?> fa fa-<?php echo $system_defined_icons->icon_disable;?>' style='cursor:pointer;color:<?php echo $system_defined_icons->icon_disable_color;?>' aria-hidden='true' data-toggle='tooltip' title='Click to enable record!'  onclick='settings_automatic_update_status("enable","<?php echo $d->company_id;?>");'></a>
                         <?php }
                         else
                         { ?> 
                            <a class='<?php echo $ena_dis_auto_discactmem_approve;?> fa fa-<?php echo $system_defined_icons->icon_enable;?>' style='cursor:pointer;color:<?php echo $system_defined_icons->icon_enable_color;?>' aria-hidden='true' data-toggle='tooltip' title='Click to disable record!'  onclick='settings_automatic_update_status("disable","<?php echo $d->company_id;?>");'></a>
                         <?php } ?>
                    </td>
                  </tr>
                <?php }?>
