...
<br><ol class="breadcrumb"><h4 class="text-danger" style="font-weight: bold;"><i class="fa fa-bars"></i>Company Notification 
    <?php if($trans_id==1){ ?>
    ...
    <?php } else{}?>
    <a class='btn btn-warning btn-xs pull-right' onclick="status_setting(<?php echo $trans_id?>);" style="margin-right: 5px;" >Settings</a>
    <a class='btn btn-danger btn-xs pull-right'  style="margin-right: 5px;" onclick="transfer_approver('<?php echo $identification?>');">Transfer of Approver</a> 
    <a class='btn btn-success btn-xs pull-right' style="margin-right: 5px;" onclick="approver_filtering('<?php echo $trans_id?>','<?php echo $identification?>');">Approver List</a>  
    <a class='btn btn-primary btn-xs pull-right' style="margin-right: 5px;" onclick="add_approver(<?php echo $trans_id?>);">Add Approver</a></h4></ol>
