...
<div class="col-md-12">
    ...
    <div class="col-md-4">
        <div class="col-md-12">
            <div class="col-md-4">Crystal Type</div>
            <div class="col-md-8">
                <n class='text-danger' ><?php if(empty($details->crystal_type)) {} else { if($details->crystal_type=='training_seminar'){ echo "Training and Seminar"; } else { echo  "Training and Seminar Attendees"; } }?></n>
            </div>
        </div>
    </div>
