...
<!-- Start Content Header (Page header) -->
  ...
  <!---END LIST-->
      ...
      function get_crystal_reports(action,notif)
      {
        ...
        if (window.XMLHttpRequest)
          ...
          {// code for IE6, IE5
            ...
            xmlhttp.open("GET","<?php echo base_url();?>app/notifications_report/manage_crystal_report_notification/"+company+"/"+notif+"/"+action,true);
            xmlhttp.send();
      ...
      else
      {
          if (window.XMLHttpRequest)
            ...
            {// code for IE6, IE5
              ...
              xmlhttp.open("GET","<?php echo base_url();?>app/notifications_report/save_crystal_report/"+company+"/"+notif+"/"+action+"/"+name+"/"+desc+"/"+data+"/"+action_id,true);
              xmlhttp.send();
      }
    ...
    function generate_report()
    {
          ...
          if (window.XMLHttpRequest)
            ...
            {// code for IE6, IE5
              ...
              xmlhttp.open("GET","<?php echo base_url();?>app/notifications_report/generate_report/",true);
              xmlhttp.send();
    }
   function get_notifications_filter(company)
    ...
    // function get_crystal_reports(notif)
    // {
    ...
    //               }
    //             }
    //         xmlhttp.open("GET","<?php //echo base_url();?>app/notifications_report/get_crystal_reports/"+company+"/"+notif,true);
    //         xmlhttp.send();
    // }
     ...
     function select_emp(id,name)
    {
     ...
     function filter_report()
     {
        ...
        if(employee=='all')
        {
           ...
           get_filtered_report(company,notification,crystal_report,status,status_view,from,to,employee,department,section,subsection,employee_id,loc,emp,classs);

        }
        else
        {
            get_filtered_report(company,notification,crystal_report,status,status_view,from,to,employee,employee_id,employee,employee,employee_id,employee,employee,employee);
        }

     }

     function get_filtered_report(company,notification,crystal_report,status,status_view,from,to,employee,department,section,subsection,employee_id,loc,emp,classs)
     {
      if(company=='' || notification=='' || crystal_report=='' || status_view=='' || from=='' || to=='' || employee=='' || department=='' || section=='' ||
        subsection=='' || employee_id=='' || loc=='' || emp=='' || classs=='')
        {
        ...
        else
        {
          ...
          xmlhttp.onreadystatechange=function()
           ...
           xmlhttp.open("GET","<?php echo base_url();?>app/notifications_report/get_filtered_report_results/"+company+"/"+notification+"/"+crystal_report+"/"+status+"/"+status_view+"/"+from+"/"+to+"/"+employee+"/"+department+"/"+section+"/"+subsection+"/"+employee_id+"/"+loc+"/"+emp+"/"+classs,true);
          xmlhttp.send();
        }
     }
     ...
     function get_crystal_reports_generate(val)
     {
      var company = document.getElementById('company').value;
       ...
       xmlhttp.open("GET","<?php echo base_url();?>app/notifications_report/get_crystal_reports_generate/"+val+"/"+company,true);
        xmlhttp.send();
     }
    </script>
  <!--END ajaxX FUNCTIONS-->
