            ...
            <div class="col-md-12" style="padding-top: 10px;padding-bottom: 10px;" >
              <input type="hidden" name="transaction_name" id="transaction_name" value="<?php echo $trans->form_name;?>">
                <div class="col-md-5" >
                  ...
                  <div class="col-md-7">
                    <input type="text" name="report_name" id="report_name" class="form-control" value="<?php if(!empty($details->title)){ echo $details->title;}?>">
                    <input type="hidden" name="report_name" id="reportname">
                  </div>
                </div>
                ...
                <div class="col-md-7">
                  ...
                  <div class="col-md-7">
                      <input type="text" name="report_desc" id="report_desc" class="form-control" value="<?php if(!empty($details->description)){ echo $details->description;}?>" >
                       <input type="hidden" name="report_name" id="reportdesc">
                  </div>
                </div>
              ...
              <?php  $i=0; foreach($transaction_field as $row) {
               ...
               <div class="col-md-4">
                      ...
                      <div class="col-md-1"><input type="checkbox" class="option" name="<?php echo $row->crystal_report_transaction_id?>" id="<?php echo $row->crystal_report_transaction_id?>" value="<?php echo $row->crystal_report_transaction_id?>" <?php echo $ch;?>></div>
                  </div>
              <?php  $i = $i + 1; } echo "<input type='hidden' id='crystal_fields' value='".$i."'>";?>
                ...
                <div class="col-md-12" style="padding-top: 20px;padding-bottom: 20px;">
                 <div class="box box-default"></div>
                  ...
                  <button class="btn btn-success pull-right" style="margin-left: 4px;margin-right: 4px;" onclick="saveupdate_report('<?php echo $company;?>','<?php echo $transaction;?>','<?php echo $type;?>','<?php echo $id;?>');">SAVE</button>
