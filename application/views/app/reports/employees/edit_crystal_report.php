...
<div class="col-md-12">
    ...
    <div class="col-md-6">
        <div class="col-md-12">
            ...
            <div class="col-md-8">
                <textarea class="form-control" rows="2"  id="name"><?php if(empty($details->report_name)) {} else { echo $details->report_name; }?></textarea>
    ...
    <div class="col-md-12">
            ...
            <div class="col-md-8">
                <textarea class="form-control" rows="2" id="description"><?php if(empty($details->report_description)) {} else { echo $details->report_description; }?></textarea>
...
<div class="col-md-12" style="margin-top: 15px;">
  <center><h4 class="text-danger">Check the fields you want to view in printing reports</h4></center>
    ...
    <?php $i=0; foreach($fields_default as $fd){ 
         $checked=$this->employee_reports_model->crystal_report_details_fields($id,$fd->idd);
