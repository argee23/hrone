    ...
    <div class="box box-success">
      <div class="col-md-12">
       ...
       <div class="box-body">
            <form class="form-horizontal" method="post" action="<?php echo base_url()?>app/employee_reports/extract_coe" target="_blank" >
            <div class="col-md-12">
...
<!--             <div class="col-md-12" style="display: hidden;">
     ...
     <!--        </div>
            ...
            <div class="col-md-6">        
            <input type="date" class="form-control" name="signed_date" value="<?php echo date('Y-m-d');?>">
            </div>
            </div> 
            <div class="col-md-12">
            <div class="col-md-3">Reason for COE</div>
            <div class="col-md-6">        
            <input type="text" class="form-control" name="coe_reason" >
            </div>
            </div>
            <div class="col-md-12">
            <div class="col-md-3">Include Salary?</div>
            <div class="col-md-6">        
            <input type="radio" name="inc_salary" value="yes"> YES <br>
            <input type="radio" name="inc_salary" value="no" checked> NO 
            </div>
            </div>
