     ...
     <div class="col-md-3" style="padding-bottom: 50px;margin-top: 10px;"> 
      <div class="box box-primary box-solid">
            ...
            <div class="box-body" id="quickview">              
              <ul class="list-group">
                <li class="list-group-item"><a style="cursor: pointer;" ><b><n class='text-danger'>System Default Report</n></b></a></li>

 <li class="list-group-item"  id="setting_div">
  <a style="cursor: pointer;margin-left: 30px;" onclick="generate_coe();">Certificate Of Employment</a><br>
  <a style="cursor: pointer;margin-left: 30px;" onclick="generate_coe_format_2();">Certificate Of Employment [Format 2]</a>
...
function select_emp(val)
      ...
      function save_crystal_report(action,action_id)
      {
        ...
        function generate_coe()
        {
            ...
            {// code for IE6, IE5
              ...
              xmlhttp.open("GET","<?php echo base_url();?>app/employee_reports/generate_coe/",true);
              xmlhttp.send();
        }
        ...
        function viewing_option_actionnn(val,code)
        {
          ...
          if(val=='count')
          {
            ...
            {
              document.getElementById('viewing_type'+code).disabled=false;
               document.getElementById('crystal_report'+code).disabled=true;
            }
            else
            {
          ...
          else
          {
            ...
            {
              document.getElementById('viewing_type'+code).disabled=true;
               document.getElementById('crystal_report'+code).disabled=false;
            }
            else
            {
    ...
    function generate_coe_format_3()
        {
            if (window.XMLHttpRequest)
            {
              xmlhttp=new XMLHttpRequest();
            ...
            {// code for IE6, IE5
              ...
              xmlhttp.open("GET","<?php echo base_url();?>app/employee_reports/generate_coe_format_3/",true);
              xmlhttp.send();
        }
       ...
       function E7_classification_multiple(classification,code)
        ...
        function e20_result(code)
        {
         ...
         var viewing_option = document.getElementById('viewing_option'+code).value;
          ...
          var classification = document.getElementById('classification'+code).value;
          var employment = document.getElementById('employment'+code).value;
          var month = document.getElementById('month'+code).value;
          var day = document.getElementById('day'+code).value;
          


          if(crystal_report=='' || company=='' || division=='' || department=='' || section=='' || subsection=='' || location=='' || classification=='' ||
            employment=='' ||  month=='' || day=='' || viewing_option=='' || viewing_type=='')
            {
              alert('Fill all fields to continue');
            }
            else if(viewing_data=='')
            ...
            else
            {
                ...
                {// code for IE6, IE5
                  ...
                  xmlhttp.open("GET","<?php echo base_url();?>app/employee_reports/e20_result/"+code+"/"+company+"/"+crystal_report+"/"+division+"/"+department+"/"+section+"/"+subsection+"/"+location+"/"+classification+"/"+employment+"/"+viewing_option+"/"+viewing_type+"/"+viewing_data+"/"+month+"/"+day,true);
                  xmlhttp.send();
            }
        ...
        //coe format 2
         ...
         function generate_coe_format_2()
        {
            if (window.XMLHttpRequest)
            {
              xmlhttp=new XMLHttpRequest();
            ...
            {// code for IE6, IE5
              ...
              xmlhttp.open("GET","<?php echo base_url();?>app/employee_reports/generate_coe_format_2/",true);
              xmlhttp.send();
        }


        function coe_2_checker(option,id)
        {
          if(document.getElementById(option).checked==true)
          {
            document.getElementById(id).value=id+'_01';
            document.getElementById(id+'_02').disabled=true;
            
          }
          else
          {
             document.getElementById(id).value=id+'_02';
             document.getElementById(id+'_02').disabled=false;
          }
        }

        // function validateForm() {
        //   var company_address = document.forms["format2_coe"]["company_address"].value;
        //   if (x == "") {
        ...
        function coe_2_namee(option,id)
        {
