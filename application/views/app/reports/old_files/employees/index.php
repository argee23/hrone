    ...
    <script>
      ...
      function save_crystal_report(action,action_id)
      {
        ...
        function department(code)
        {
            ...
            if (window.XMLHttpRequest)
                ...
                {// code for IE6, IE5
                  ...
                  xmlhttp.open("GET","<?php echo base_url();?>app/employee_reports/get_department/"+company+"/"+division,true);
                  xmlhttp.send();
        }
        ...
        function section(code,department)
        {
            ...
            if (window.XMLHttpRequest)
                ...
                {// code for IE6, IE5
                  ...
                  xmlhttp.open("GET","<?php echo base_url();?>app/employee_reports/get_section/"+company+"/"+division+"/"+department,true);
                  xmlhttp.send();
        }
        ...
        function subsection(code,section)
        {
            ...
            if (window.XMLHttpRequest)
                ...
                {// code for IE6, IE5
                  ...
                  xmlhttp.open("GET","<?php echo base_url();?>app/employee_reports/get_subsection/"+company+"/"+division+"/"+department+"/"+section,true);
                  xmlhttp.send();
        }
        ...
        function get_location(code)
        {
              ...
              if (window.XMLHttpRequest)
                ...
                {// code for IE6, IE5
                  ...
                  xmlhttp.open("GET","<?php echo base_url();?>app/employee_reports/get_location/"+company,true);
                  xmlhttp.send();
        }
        ...
        function get_classification(code)
        {
              ...
              if (window.XMLHttpRequest)
                ...
                {// code for IE6, IE5
                  ...
                  xmlhttp.open("GET","<?php echo base_url();?>app/employee_reports/get_classification/"+company,true);
                  xmlhttp.send();
        }
           ...
           else
           {
              if (window.XMLHttpRequest)
                ...
                {// code for IE6, IE5
                  ...
                  xmlhttp.open("GET","<?php echo base_url();?>app/employee_reports/E1_result/"+company+"/"+companylist+"/"+code+"/"+crystal_report,true);
                  xmlhttp.send();
           }
          ...
          else
          {
               if (window.XMLHttpRequest)
                ...
                {// code for IE6, IE5
                  ...
                  xmlhttp.open("GET","<?php echo base_url();?>app/employee_reports/E2_result/"+code+"/"+company+"/"+crystal_report+"/"+division,true);
                  xmlhttp.send();
          }
          ...
          else
          {
               if (window.XMLHttpRequest)
                ...
                {// code for IE6, IE5
                  ...
                  xmlhttp.open("GET","<?php echo base_url();?>app/employee_reports/E3_result/"+code+"/"+company+"/"+crystal_report+"/"+division+"/"+department,true);
                  xmlhttp.send();
          }
          ...
          else
          {
               if (window.XMLHttpRequest)
                ...
                {// code for IE6, IE5
                  ...
                  xmlhttp.open("GET","<?php echo base_url();?>app/employee_reports/E4_result/"+code+"/"+company+"/"+crystal_report+"/"+division+"/"+department+"/"+section,true);
                  xmlhttp.send();
          }
          ...
          else
          {
               if (window.XMLHttpRequest)
                ...
                {// code for IE6, IE5
                  ...
                  xmlhttp.open("GET","<?php echo base_url();?>app/employee_reports/E5_result/"+code+"/"+company+"/"+crystal_report+"/"+division+"/"+department+"/"+section+"/"+subsection,true);
                  xmlhttp.send();
          }
          ...
          else
          {
               if (window.XMLHttpRequest)
                ...
                {// code for IE6, IE5
                  ...
                  xmlhttp.open("GET","<?php echo base_url();?>app/employee_reports/E6_result/"+code+"/"+company+"/"+crystal_report+"/"+division+"/"+department+"/"+section+"/"+subsection+"/"+location,true);
                  xmlhttp.send();
          }
          ...
          else
          {
               if (window.XMLHttpRequest)
                ...
                {// code for IE6, IE5
                  ...
                  xmlhttp.open("GET","<?php echo base_url();?>app/employee_reports/E7_result/"+code+"/"+company+"/"+crystal_report+"/"+division+"/"+department+"/"+section+"/"+subsection+"/"+location+"/"+classification,true);
                  xmlhttp.send();
          }
          ...
          else
          {
               if (window.XMLHttpRequest)
                ...
                {// code for IE6, IE5
                  ...
                  xmlhttp.open("GET","<?php echo base_url();?>app/employee_reports/E8_result/"+code+"/"+company+"/"+crystal_report+"/"+division+"/"+department+"/"+section+"/"+subsection+"/"+location+"/"+classification+"/"+employment,true);
                  xmlhttp.send();
          }
        ...
        function all_result(code)
        {
          ...
          //alert(crystal_report+company+division+department+section+subsection+location+classification+employment+taxcode+status+gender+civil_status+position+paytype+religion);

          if(crystal_report=='' || company=='' || division=='' || department=='' || section=='' || subsection=='' || location=='' || classification=='' ||
            employment=='' || taxcode=='' || status=='' || gender=='' || civil_status=='' || position=='' || paytype=='' || religion=='' || age_from=='' || age_to=='' ||
            dateemp_from=='' || dateemp_to=='' || yremp_from=='' || yremp_to=='')
            {
            ...
            else
            {
                ...
                {// code for IE6, IE5
                  ...
                  xmlhttp.open("GET","<?php echo base_url();?>app/employee_reports/all_result/"+code+"/"+company+"/"+crystal_report+"/"+division+"/"+department+"/"+section+"/"+subsection+"/"+location+"/"+classification+"/"+employment+"/"+taxcode+"/"+status+"/"+gender+"/"+civil_status+"/"+position+"/"+paytype+"/"+religion+"/"+age_from+"/"+age_to+"/"+dateemp_from+"/"+dateemp_to+"/"+yremp_from+"/"+yremp_to,true);
                  xmlhttp.send();
            }
        }
