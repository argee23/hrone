...
<?php $rep_type=$this->uri->segment('4')?>
  ...
  <form class="form-horizontal" method="post" action="<?php echo base_url()?>app/reports_time/update_report_save/<?php echo $details_report->report_type?>" >

<br> <ol class="breadcrumb">
                <h4 class="text-default" style="font-weight: bold;"><i class="fa fa-bars"></i>Update Working Schedule Reports</h4>
            </ol><br>
