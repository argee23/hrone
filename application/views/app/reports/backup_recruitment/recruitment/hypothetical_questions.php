    <div class="row">
      <div class="col-md-3">
          <label>Company :</label>
          <select class="form-control select2" name="company" id="company" style="width: 100%;" onchange="hypothetical()">
          <option selected="selected" value="0"> All Companies </option>
          <?php 
      ...
      <div class="col-md-3">
        <label> Status :</label>
        <select class="form-control" name="status" id="status" style="width: 100%;" onchange="hypothetical()">
