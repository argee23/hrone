    ...
    <div class="col-md-12">
      ...
      <div class="col-md-8">
              ...
              <div class="col-md-12" style="margin-bottom: 30px;margin-top: 30px;">
                  <button class="col-md-12 btn-success" onclick="get_application_filtering_results_VR1('<?php echo $application_code;?>')"> GENERATE REPORT</button>
              </div>
      </div>
      <div class="col-md-2"></div>
    </div>
      ...
      <div class="col-md-12">
        ...
        <div class="col-md-8">
              ...
              <div style="margin-top: 20px;">
                ...
                <div class="col-md-12" style="margin-bottom: 30px;margin-top: 30px;">
                    <button class="col-md-12 btn-success" onclick="get_application_filtering_results_VR2('<?php echo $application_code;?>')"> GENERATE REPORT</button>
                </div>
        </div>
        <div class="col-md-2"></div>
      </div>
      ...
      <div class="col-md-12">
        ...
        <div class="col-md-8">
             ...
             <div  id="interview_id">
                ...
                <div class="col-md-12" style="margin-bottom: 30px;margin-top: 30px;">
                    <button class="col-md-12 btn-success" onclick="get_application_filtering_results_VR3('<?php echo $application_code;?>')"> GENERATE REPORT</button>
                </div>
        </div>
        <div class="col-md-2"></div>
      </div>
      ...
      <div class="col-md-12">
        ...
        <div class="col-md-8">
             ...
             <div style="margin-top: 20px;">
                ...
                <div class="col-md-12" style="margin-bottom: 30px;margin-top: 30px;">
                    <button class="col-md-12 btn-success" onclick="get_application_filtering_results_VR4('<?php echo $application_code;?>')"> GENERATE REPORT</button>
                </div>
        </div>
        <div class="col-md-2"></div>
      </div>
      ...
      <div class="col-md-12">
        ...
        <div class="col-md-8">
              ...
              <div>
                ...
                <div class="col-md-12" style="margin-bottom: 30px;margin-top: 30px;">
                    <button class="col-md-12 btn-success" onclick="get_application_filtering_results_VR5('<?php echo $application_code;?>')"> GENERATE REPORT</button>
                </div>
        </div>
        <div class="col-md-2"></div>
      </div>
      ...
      <div class="col-md-12">
        ...
        <div class="col-md-8">
              ...
              <div>
                ...
                <div class="col-md-12" style="margin-bottom: 30px;margin-top: 30px;">
                    <button class="col-md-12 btn-success" onclick="get_application_filtering_results_VR6('<?php echo $application_code;?>')"> GENERATE REPORT</button>
                </div>
        </div>
        <div class="col-md-2"></div>
      </div>
      ...
      <div class="col-md-12">
        ...
        <div class="col-md-8">
              ...
              <div>
                ...
                <div class="col-md-12" style="margin-bottom: 30px;margin-top: 30px;">
                    <button class="col-md-12 btn-success" onclick="get_application_filtering_results_VR7('<?php echo $application_code;?>')"> GENERATE REPORT</button>
                </div>
        </div>
        <div class="col-md-2"></div>
      </div>
      ...
      <div class="col-md-12">
        ...
        <div class="col-md-8">
             ...
             <div  id="interview_id">
               ...
               <div>
                  <div class="col-md-12"><label>Interview Result</label></div>
                  <div class="col-md-12">
                     <select class="form-control" id="application_interview_result" name="application_interview_result">
                ...
                <div class="col-md-12" style="margin-bottom: 30px;margin-top: 30px;">
                    <button class="col-md-12 btn-success" onclick="get_application_filtering_results_VR8('<?php echo $application_code;?>')"> GENERATE REPORT</button>
                </div>
        </div>
        <div class="col-md-2"></div>
      </div>
