		...
		foreach($companyList as $comp){
			...
			if(!empty($ws_data)){
				...
				foreach($ws_data as $emp){
						$total=$emp->philhealth_employee+$emp->philhealth_employer;
						$overall_total+=$total;
						$ee_total+=$emp->philhealth_employee;
						$er_total+=$emp->philhealth_employer;
				

					echo '<tr>';
					echo '<td class="bg-success" width="10%">'.$emp->employee_id.'</td>';
					echo '<td class="bg-success" width="10%">'.$emp->name_lname_first.'</td>';
					echo '<td class="bg-success" width="10%">'.$emp->philhealth_number.'</td>';
					echo '<td class="bg-success" width="10%">'.$emp->philhealth_employee.'</td>';
					echo '<td class="bg-success" width="10%">'.$emp->philhealth_employer.'</td>';
