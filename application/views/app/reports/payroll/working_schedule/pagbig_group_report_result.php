		...
		foreach($companyList as $comp){
			...
			if(!empty($ws_data)){
				...
				foreach($ws_data as $emp){
						$total=$emp->pagibig+$emp->pagibig_employer;
						$overall_total+=$total;
						$ee_total+=$emp->pagibig;
						$er_total+=$emp->pagibig_employer;
				

					echo '<tr>';
					echo '<td class="bg-success" width="10%">'.$emp->employee_id.'</td>';
					echo '<td class="bg-success" width="10%">'.$emp->name_lname_first.'</td>';
					echo '<td class="bg-success" width="10%">'.$emp->pagibig_number.'</td>';
					echo '<td class="bg-success" width="10%">'.$emp->pagibig.'</td>';
					echo '<td class="bg-success" width="10%">'.$emp->pagibig_employer.'</td>';
