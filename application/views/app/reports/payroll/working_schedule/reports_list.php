      ...
      <?php echo validation_errors(); ?>
            ...
            <br><ol class="breadcrumb">
                <h4 class="text-danger" style="font-weight: bold;"><i class="fa fa-bars"></i>Payroll Reports | Report List 
             ...
             <table id="table_home" class="table table-hover table-striped">
                ...
                <?php foreach($report as $row){ ?>
                  <tr>
                   ...
                   <a  class='fa fa-<?php echo $system_defined_icons->icon_delete.'  fa-'.$system_defined_icons->icon_size.'x'; ?>' <?php echo 'style="color:'.$system_defined_icons->icon_delete_color.';"';?> data-toggle="tooltip" data-placement="left" title="Delete Report" href="<?php echo site_url('app/reports_payroll/deleteReport/'. $row->report_id.'/'.$row->report_type.''); ?>" onClick="return confirm('Are you sure you want to permanently delete report type?')"></a> |
