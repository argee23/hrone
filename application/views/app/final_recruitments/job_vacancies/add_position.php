            ...
            <div class="panel-body">
              <span class="dl-horizontal col-sm-12">
                  ...
                  <div class="col-md-6">
                        <dt>Department</dt>
                        <dd>
                            <select class="form-control" name="department" id="adepartment" >
                        ...
                        <dt>Plantilla</dt>
                        <dd>
                            <select class="form-control" name="plantilla" id="aplantilla" >
                  ...
                  <div class="col-md-6">
                        <dt>Location</dt>
                        <dd>
                            <select class="form-control" name="location" id="alocation" >
                        ...
                        <dt>Position</dt>
                        <dd>
                            <select class="form-control" name="position" id="apositionn" onchange="check_plantilla_position('<?php echo $company_id;?>','<?php echo $employer_type;?>');">
                             <?php 
                                if(empty($position))
                                {
