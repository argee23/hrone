...
<?php 
      $recheck_added = $this->recruitments_model->check_last_added_interview_process($app_id);
      $admin_comment = $this->final_recruitments_model->admin_comment($app_id,4);
?> 
 <div class="modal-content">
           ...
           <form class="form-horizontal" method="post" action="<?php echo base_url()?>app/final_recruitments/save_blocked_applicant_job_application/<?php echo $app_id."/".$employer_type;?>">
