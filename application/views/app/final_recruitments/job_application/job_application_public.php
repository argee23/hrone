                        ...
                        <tr>
                          ...
                          <td>
                           ...
                           <td>
                              ...
                              <?php } } else{?>
                                  <a style="cursor:pointer;color:red;" data-toggle='modal' data-target='#modal' href="<?php echo base_url('app/final_recruitments/view_application_history')."/".$app->idd."/".$app->comp_id."/".$employer_type."/".$app->job_id."/".$app->applicant_id;?>" ><i class="btn btn-sm">View Status History</i></a><br>
                              <?php
