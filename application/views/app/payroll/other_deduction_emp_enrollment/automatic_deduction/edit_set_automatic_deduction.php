  ...
  <div class="form-horizontal">
   <div class="box-body">
    ...
    <?php
          ...
          $other_deduction_id =$this->uri->segment('7'); 
     ...
     EDIT PAYROLL SET AUTOMATIC DEDUCTION
      </strong>
      </div>  
                 <div align="center">
                        ...
                        <input type="hidden" name="deduction_id" id="deduction_id" value="<?php echo $other_deduction_id; ?>">
                        ...
                        <div class="form-group">
                          <label class="col-sm-4 control-label">ADDITION</label>
                           <div class="col-sm-8">  
                           <?php
                                 $od_id = $other_deduction_id;
                                 $od_type = $this->payroll_other_deduction_automatic_model->getting_deduction($od_id);
                                
                            ?>
                                 <input class="form-control" type="text" name="deduction_id" id="deduction_id" value="<?php echo $od_type->other_deduction_type; ?>">
                ...
                <?php
                      ...
                      $paytype_auto = $this->db->query('SELECT * FROM other_deduction_automatic WHERE `company_id`= '.$company_id.' and `pay_type` = '.$pay_type.' and `other_deduction_id` ='.$other_deduction_id.' and `cutoff` = '.$cutoff.'');
