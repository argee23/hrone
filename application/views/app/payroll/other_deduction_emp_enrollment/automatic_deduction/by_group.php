 ...
 <div class="box-body table-responsive" >
  <div class="panel panel-success">
         ...
         <form  method="post" action="<?php echo base_url()?>app/payroll_other_deduction_automatic/generate_employee_automatic_deduct/" target="blank_">   
      ...
      <div class="table-responsive">       
                        ...
                        <div class="form-group"   >
                          <label for="next" class="col-sm-5 control-label">Employee Group</label>
                            <div class="col-sm-7" >
                              <select name="pay_type_group" class="form-control" id="pay_type_group"  required onchange="fetch_payroll_period_automatic_deduct();">
                              <option disabled selected="">Select Group</option>

                              <?php
                                      $pay_per_group=$this->payroll_other_deduction_automatic_model->get_active_payroll_period_groups($company_id,$pay_type_id);
