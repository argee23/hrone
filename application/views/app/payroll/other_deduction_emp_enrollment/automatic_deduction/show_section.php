...
<label for="section" class="col-sm-5 control-label"><?php $check_dept=$this->uri->segment('4');?></label>
        <div class="col-sm-7" style="width:602px; display: table-cell;
  padding:0; margin:0; background-color: gray;">
    <select class="form-control" name="section"  id="section" ng-model="section" required onchange="fetch_sub_section_automatic_deduct()">
