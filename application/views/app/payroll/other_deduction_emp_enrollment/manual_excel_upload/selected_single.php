...
<div class="panel panel-success" >
  <div class="panel-heading table-responsive " >
        ...
        //$key_location="1";
         ...
         ?>
      </strong><strong>(PAYROLL OTHER DEDUCTION MANUAL EXCEL SINGLE UPLOAD)
...
<form target="_blank" action="<?php echo base_url(); ?>app/other_deduction_manual_upload/single_upload" method="post" name="upload_excel" enctype="multipart/form-data">
