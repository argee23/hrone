...
<input type="hidden" name="entry_type" value="upload_import">
    ...
    <div class="form-group">
      <label for="next" class="col-sm-5 control-label">Select Deduction</label>
        <div class="col-sm-7">
            <select class="form-control" name="other_deduction_id"  id="other_deduction_id" required>
      ...
      <label for="next" class="col-sm-5 control-label">Select Option</label>
        <div class="col-sm-7">
            <select class="form-control" name="option"  id="option" required onchange="single_upload_action(this.value);">
                  ...
                  <option value="reset">Reset other deduction</option>
                  <option value="add">Overwrite Existing Other Deduction (if no existing data system will add other deduction)</option>     
            </select>
        </div>
    </div>  
