...
?>    
    ...
    <div class="form-group"   >
      <label for="next" class="col-sm-5 control-label">Employee Group</label>
        <div class="col-sm-7" >
          <select name="pay_type_group" class="form-control" id="pay_type_group"  required onchange="fetch_excel_payroll_period_mass();">
          <option disabled selected="">Select Group</option>
          <?php
            $pay_per_group=$this->payroll_other_deduction_excel_upload_model->get_active_excel_payroll_period_groups($company_id,$pay_type_id);
