...
<section class="content-header">
    <h1>
      Payroll
       <small>Generate Retro Pay</small>
    <?php
if($current_account_logged_in!="employer_account"){
...
echo ' <small>Employer panel</small>';
  ...
  <ol class="breadcrumb">
    ...
    <li>Payroll</li>
    <li class="active">Generate Retro Pay</li>
  </ol>
      ...
      <div class="modal-header bg-success">
        ...
        <div class="collapse" id="add_formula_collapse">
          <div class="well">
            ...
            <form action="<?php echo base_url()?>app/payroll_generate_retro/add_formula" method="post" id="add_formula">
              <div class="row">
...
{ 
  ...
  xmlhttp.open("GET","<?php echo base_url();?>app/payroll_generate_retro/showSearchEmployee/"+val+"/"+info,true);
  xmlhttp.send();
}
...
function select_emp(val)
        ...
        xmlhttp2.open("GET","<?php echo base_url();?>app/payroll_generate_retro/select_emp/"+val,false);
        xmlhttp2.send();
    ...
    function view(val)
        ...
        xmlhttp.open("GET","<?php echo base_url();?>app/payroll_generate_retro/view_option/"+val,true);
        xmlhttp.send();
    ...
    function manage_formula(val)
        ...
        xmlhttp.open("GET","<?php echo base_url();?>app/payroll_generate_retro/manage_formula/"+val,true);
        xmlhttp.send();
 ...
 function fetch_pay_period_group()
        ...
        xmlhttp.open("GET","<?php echo base_url();?>app/payroll_generate_retro/comp_payroll_period_group/"+company_id+"/"+pay_type,true);
        xmlhttp.send();
 ...
 function fetch_payroll_period()
        ...
        xmlhttp.open("GET","<?php echo base_url();?>app/payroll_generate_retro/comp_payroll_period/"+company_id+"/"+pay_type+"/"+pay_type_group+"/"+payroll_option,true);
        xmlhttp.send();
 ...
 function fetch_payroll_period_individual(company_id,pay_type,pay_type_group)
        ...
        xmlhttp.open("GET","<?php echo base_url();?>app/payroll_generate_retro/comp_payroll_period_individual/"+company_id+"/"+pay_type+"/"+pay_type_group+"/"+payroll_option,true);
        xmlhttp.send();
 ...
 function fetch_section()
        ...
        xmlhttp.open("GET","<?php echo base_url();?>app/payroll_generate_retro/show_section/"+department_id,true);
        xmlhttp.send();
 ...
 function fetch_sub_section()
        ...
        xmlhttp.open("GET","<?php echo base_url();?>app/payroll_generate_retro/show_sub_section/"+section,true);
        xmlhttp.send();
 ...
 function clear_fetched_sub_sec()
        ...
        xmlhttp.open("GET","<?php echo base_url();?>app/payroll_generate_retro/clear_fetched_sub_sec/",false);
        xmlhttp.send();
 ...
 function fetch_division_dept()
        ...
        xmlhttp.open("GET","<?php echo base_url();?>app/payroll_generate_retro/show_div_dept/"+company_id+"/"+division_id,true);
        xmlhttp.send();
