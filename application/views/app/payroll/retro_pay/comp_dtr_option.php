...
<div class="form-group"   >
		<label for="next" class="col-sm-5 control-label">Payrol Period- (Release of Retro Pay)</label>
	<div class="col-sm-7">
		...
		if(!empty($pay_per_dtr)){
			foreach($pay_per_dtr as $pay_period){
			 ...
			 if($payroll_option=="view_saved_retro" OR $payroll_option=="reset_retro_pay"){

				$check_posted_payroll_period=$this->payroll_generate_retro_model->check_payroll_period_retro($pay_period->id,$pay_period->month_cover);
...
<?php
	if($payroll_option=="view_saved_retro" OR $payroll_option=="reset_retro_pay" OR $payroll_option=="manual_bonus" ){
		echo '
...
?>
<!-- //==============================Coverage From of Retro Pay -->
<div class="form-group"   >
		<label for="next" class="col-sm-5 control-label">Retro Pay Coverage From</label>
	<div class="col-sm-7">
...
<div class="form-group"   >
		<label for="next" class="col-sm-5 control-label">Retro Pay Coverage To</label>
	<div class="col-sm-7">
