...
<div class="panel panel-success">
  <div class="panel-heading"><strong>SALARY REASON MANAGEMENT</strong></div>
  <div class="box-body">
  <div class="panel panel-success">
         <div class="box-body">
         <div class="row">
			...
			<label for="company">Select a Company</label>
				<select class="form-control" name="company" id="company" onchange="get_company_reason(this.value)" required>
