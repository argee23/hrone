...
<div class="panel panel-success" >
  <div class="panel-heading table-responsive " >
        ...
        <?php 
         ...
         ?>
      </strong><strong>(PAYROLL PERCENTAGE TABLE)</strong>

      

      <strong> <a onclick="add_new_pagibig_per_list(<?php echo $company_id;?>)" type="button" class="btn btn-xs btn-default pull-right" data-toggle="tooltip" data-placement="left" title="Add New Pagibig Percentage"><i class="fa fa-plus fa-2x text-success"></i></a></strong>
...
<div id="add_edit_table"></div>
  ...
  <div class="panel panel-success">
     ...
     <div class="table">
      <br>
     <b> <p>With the Signing of Republic Act NO. 9679, membership to the Fund shall be mandatory for the following:</p></b>
       <input type="hidden" name="company_id" id="company_id" value="<?php echo $company_id;?>">
       <div class="col-md-3">
                        <div class="form-group">
                        <label for="company">Effective year</label>
                          <select class="form-control" name="date" id="date" onchange="applyFilterpagibigyear();">
                          <?php
                            ...
                            ?>
                            <option value="<?php echo $date->covered_year;?>" <?php echo $selected;?>><?php echo $date->covered_year;?></option>
                          <?php }?>
                          </select>
                        </div>
                        </div>
   ...
   <table id="example1" class="table table-striped table-bordered table-condensed">
        ...
        <tbody border="1">
          <?php foreach($pagibig_per_list as $pi_per_list){if($pi_per_list->InActive == 0){ $inactive = 'Enabled';}else{ $inactive = 'Disabled';}?>
