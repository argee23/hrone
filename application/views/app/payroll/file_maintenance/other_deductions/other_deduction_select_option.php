          ...
          <div class="col-md-12" >
              <div class="form-group">
                  <div class="btn-group-vertical btn-block">
                     <a onclick="other_deduction_category_view(<?php echo $company_id;?>)" type='button' class='btn btn-default btn-flat'><p class='text-left'><strong>Other Deductions Category</strong></p></a>
                     <a onclick="other_deduction_list(<?php echo $company_id;?>)" type='button' class='btn btn-default btn-flat'><p class='text-left'><strong>Types of Other Deductions</strong></p></a>
                 </div>
