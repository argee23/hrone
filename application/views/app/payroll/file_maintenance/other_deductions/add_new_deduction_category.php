<div class="well">
<!-- form start -->
  <form class="form-horizontal" method="post" action="<?php echo base_url()?>app/payroll_file_maintenance_deductions/save_add_new_deduction_category" >
    <div class="box-body">
    ...
    <?php 
     ...
     Add New Other Deductions Category
      </strong>
      </div>
