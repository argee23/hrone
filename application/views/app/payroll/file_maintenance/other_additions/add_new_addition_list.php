...
<div class="well">
<!-- form start -->
  <form class="form-horizontal" method="post" action="<?php echo base_url()?>app/payroll_file_maintenance_additions/save_add_new_list" >
    <div class="box-body">
            ...
            <tr>
              <td>  
                    <label class="col-sm-2">CODE</label>
                      <input type="text" class="form-control"  onchange="return trim(this)" name="other_addition_code" id="other_addition_code" placeholder="Code" required maxlength="20"> 
                     
                    <label class="col-sm-2">TYPE</label>
                      <textarea  class="form-control"  onchange="return trim(this)" name="other_addition_type" id="other_addition_type" placeholder="Type"> </textarea>
              ...
              <td>
                    ...
                    <label class="col-sm-2 form-control" style="background: transparent;border:0;padding-left:50px;">LEAVE
                      <input style="margin-left: 158px;" type="checkbox" id="myCheck6" onclick="myFunctionleave()"> 
                       ...
                       <input class="form-control" name="other_addition_leave"  type="hidden" id="myText6" value="0">
                       <br>
