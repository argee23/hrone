<div class="well">
<!-- form start -->
  <form class="form-horizontal" method="post" action="<?php echo base_url()?>app/payroll_file_maintenance_additions/addition_category_edit_save/<?php echo $this->uri->segment("4");?>" > 
   <div class="box-body">
