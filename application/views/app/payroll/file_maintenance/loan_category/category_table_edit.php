<div class="well">
<!-- form start -->
  <form class="form-horizontal" method="post" action="<?php echo base_url()?>app/payroll_loan_category/category_edit_save/<?php echo $this->uri->segment("4");?>" > 
   <div class="box-body">
...
<br></br>
        <div class="form-group">
          <label  class="col-sm-4 control-label">Category</label>
            <div class="col-sm-8">
              <input type="text" class="form-control" name="category" id="category" onchange="return trim(this)" maxlength="15" value="<?php echo $categories->category;?>">
            </div>
        </div>    
