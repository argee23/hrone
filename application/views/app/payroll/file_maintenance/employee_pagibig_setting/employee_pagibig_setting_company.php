...
<div class="panel panel-success">
  <div class="panel-heading"><strong>EMPLOYEE PAGIBIG SETTING</strong></div>
  <div class="box-body">
  <div class="panel panel-success">
         <div class="box-body">
         <div class="row">
			...
			<label for="company">Select a Company</label>
				<select class="form-control" name="company" id="company" onchange="getCompany_employeeSetting(this.value)" required>
			...
			<div id = "company_employee_setting">
			</div>
