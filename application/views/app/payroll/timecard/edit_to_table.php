...
<input type="hidden" name="id" id="id" value="<?php echo $timecard_data->id ?>">

<table class="table table-bordered table-responsive table-hover" >
<tr class="success">
	<td colspan="3"><strong>Pay Type: </strong><?php echo $timecard_data->pay_type_name ?></td>
	<td colspan="3" align="right"><strong>Employment: </strong><?php echo $timecard_data->employment_name ?></td>
</tr>
<tr align="center">
