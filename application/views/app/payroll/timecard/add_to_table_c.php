...
<tr class="success">
	<td colspan="2"><strong>Salary Type: </strong><?php echo $st->salary_rate_name ?></td>
	<td colspan="2" align="center"><strong>Pay Type: </strong><?php echo $pt->pay_type_name ?></td>
	<td colspan="2" align="right"><strong>Employment: </strong><?php echo $e->employment_name ?></td>
</tr>
<tr align="center">
