<form method="post" action="<?php echo base_url()?>app/payroll_incentive_leave/add_save/<?php echo $company_info->company_id; ?>" >
...
<div class="col-md-12">
  ...
  <tbody>
      <tr>
      <td align="center" >
        <input type="number" class="form-control" name="start_ot_hour" id="start_ot_hour" placeholder="00.00" step="0.125" value="" required>
      </td>
      <td align="center" >
      <input type="number" class="form-control" name="end_ot_hour" id="end_ot_hour" placeholder="00.00" step="0.125" value="" required>
      </td>
      <td align="center" >
        <input type="number" name="equivalent_incentive_credit" class="form-control" placeholder="00.00" step="0.125" value="" required>
      </td>
