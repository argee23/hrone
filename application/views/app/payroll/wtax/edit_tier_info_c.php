<div class="modal-header bg-success">
  ...
  <h4 class="modal-title" id="myModalLabel">Edit for <strong><?php echo $tax_tier_info->pay_type_name ?></strong> Pay Type Exemption <strong><?php echo $tax_tier_info->order_no ?></strong> for <strong><?php echo $company->company_name ?></strong></h4>
</div>
<div class="modal-body">
  <input type="hidden" name="pay_type" id="pay_type" value="<?php echo $tax_tier_info->pay_type?>">
  <input type="hidden" name="salary_rate" id="salary_rate" value="<?php echo $tax_tier_info->salary_rate?>">
...
<div class="modal-footer">
  ...
  <button type="button" class="btn btn-primary" id="saveBtn" onclick="saveChanges_c()">Save changes</button>
</div>