    <form  method="post" action="<?php echo base_url()?>app/payroll_other_addition_emp_enrollment/generate_addition/" target="_blank">  
...
<div class="panel panel-success" >
  <div class="panel-heading table-responsive " >
        ...
        //$key_location="1";
         ...
         ?>
      </strong><strong>(PAYROLL OTHER ADDITION EMPLOYEE ENROLLMENT)</strong>
