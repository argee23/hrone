...
<div class="panel panel-success" >
  <div class="panel-heading table-responsive " >
        ...
        //$key_location="1";
         ...
         ?>
      </strong><strong>(PAYROLL OTHER ADDITION MANUAL EXCEL SINGLE UPLOAD)
    ...
    <div class="panel panel-success">
      <div class="box-body " >
        <div class="row">
          ...
          <form target="_blank" action="<?php echo base_url(); ?>app/other_addition_manual_upload/single_upload" method="post" name="upload_excel" enctype="multipart/form-data">
              <div class="col-md-12" >
                    <div class="form-group">
                       ...
                       <input type="hidden" name="company_id" id="company_id" value="<?php echo $company_id?>">
                        ...
                        <div class="col-md-7">
                            <select name="pay_type" class="form-control" id="pay_type"  required onchange="fetch_excel_pay_period_group();"> <!-- fetch_payroll_period(); -->
...
<div class="col-md-4"  id="col_3"></div>
