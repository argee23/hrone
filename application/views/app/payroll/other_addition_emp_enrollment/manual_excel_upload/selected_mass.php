...
<div class="panel panel-success" >
  <div class="panel-heading table-responsive " >
        ...
        //$key_location="1";
         ...
         ?>
      </strong><strong>(PAYROLL OTHER ADDITION MANUAL EXCEL MASS UPLOAD)
...
<form target="_blank" action="<?php echo base_url(); ?>app/other_addition_manual_upload/mass_upload" method="post" name="upload_excel" enctype="multipart/form-data">
              <div class="col-md-12" >
