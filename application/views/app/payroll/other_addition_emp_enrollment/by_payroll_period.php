...
<div class="form-group">
    <label for="next" class="col-sm-5 control-label"><br>Other Addition Types</label>
      <div class="col-sm-7"><br>
    <?php
    if(!empty($addition_type)){
        $d_count=0;
        foreach($addition_type as $d){
            $d_count++;
            if($d_count=="1"){
                $check_me="checked";
            }else{
                ...
                echo '<input type="checkbox" value="'.$d->id.",".$d->other_addition_type.'" '.$check_me.' name="od_types[]">'.$d->other_addition_type.'<br>'; 
