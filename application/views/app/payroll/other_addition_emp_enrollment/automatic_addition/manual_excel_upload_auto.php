...
<div class="well">
  <div class="form-horizontal">
   ...
   <div class="col-md-12" >
<center>
           <form target="_blank" action="<?php echo base_url(); ?>app/payroll_other_addition_automatic/manual_upload_automatic_allowance" method="post" name="upload_excel" enctype="multipart/form-data">

                             <input type="hidden" name="company_id" id="company_id" value="<?php echo $company_id; ?>">
                             <input type="hidden" name="other_addition_id" id="other_addition_id" value="<?php echo $oa_id; ?>">
                      ...
                      <div class="panel-heading"><strong><center>UPLOADING TEMPLATE</center></strong></div>
                        ...
                        <div class="box-body" style="height:330px;" >
                          ...
                          <div style="padding-top: 80px;"> 
                           ...
                           <button type="submit" id="submit" name="import" class="btn btn-success btn-xs" ><i class="fa fa-upload"></i> Import</button>
              </form>
          </center>
    </div>
  </div>
