...
<div class="form-group"   >
    ...
    <div class="col-sm-7" style="margin-bottom: 5px;">
        <select name="division" class="form-control" id="division_id"  required  onchange="fetch_division_dept_automatic();">
...
<div class="form-group" >
    ...
    <div class="col-sm-7" style="margin-bottom: 5px;">
        <select name="department" class="form-control" id="department_id"  required onchange="fetch_section_automatic()">
        <option value="All" selected>All</option>
