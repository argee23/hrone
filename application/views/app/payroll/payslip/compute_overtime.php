...
//regot_withnd_rate : for working schedule ND
        ...
        /**/$ws_nd_formula_text=str_replace("ot_table_rate","ws_nd",$ws_nd_formula_text);  
        ...
        /**/$ws_nd_formula_text=str_replace("ot_table_rate","ws_nd",$ws_nd_formula_2nd);   
        ...
        /**/$ws_nd_formula_text="<i>(Working Schedule Night Diff)</i> <i class='fa fa-arrow-right'></i> $for_translation = $ws_nd_value";
            ...
            //echo "HEY $total_regular_nd * $hourly_value * $ws_nd  = $ws_nd_value <br>";
