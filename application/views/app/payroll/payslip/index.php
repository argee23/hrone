...
{ 
  ...
  xmlhttp.open("GET","<?php echo base_url();?>app/payroll_generate_payslip/showSearchEmployee/"+val+"/"+info,true);
  xmlhttp.send();
}
...
function select_emp(val)
        ...
        xmlhttp2.open("GET","<?php echo base_url();?>app/payroll_generate_payslip/select_emp/"+val,false);
        xmlhttp2.send();
    ...
    function view(val)
        ...
        xmlhttp.open("GET","<?php echo base_url();?>app/payroll_generate_payslip/view_option/"+val,true);
        xmlhttp.send();
 ...
 function fetch_pay_period_group()
        ...
        xmlhttp.open("GET","<?php echo base_url();?>app/payroll_generate_payslip/comp_payroll_period_group/"+company_id+"/"+pay_type,true);
        xmlhttp.send();
 ...
 function fetch_payroll_period()
        ...
        xmlhttp.open("GET","<?php echo base_url();?>app/payroll_generate_payslip/comp_payroll_period/"+company_id+"/"+pay_type+"/"+pay_type_group,true);
        xmlhttp.send();
 ...
 function fetch_payroll_period_individual(company_id,pay_type,pay_type_group,employee_id)
        ...
        xmlhttp.open("GET","<?php echo base_url();?>app/payroll_generate_payslip/comp_payroll_period_individual/"+company_id+"/"+pay_type+"/"+pay_type_group+"/"+employee_id,true);
        xmlhttp.send();
 ...
 function fetch_section()
        ...
        xmlhttp.open("GET","<?php echo base_url();?>app/payroll_generate_payslip/show_section/"+department_id,true);
        xmlhttp.send();
 ...
 function fetch_sub_section()
        ...
        xmlhttp.open("GET","<?php echo base_url();?>app/payroll_generate_payslip/show_sub_section/"+section,true);
        xmlhttp.send();
 ...
 function clear_fetched_sub_sec()
        ...
        xmlhttp.open("GET","<?php echo base_url();?>app/payroll_generate_payslip/clear_fetched_sub_sec/",false);
        xmlhttp.send();
 ...
 function fetch_division_dept()
        ...
        xmlhttp.open("GET","<?php echo base_url();?>app/payroll_generate_payslip/show_div_dept/"+company_id+"/"+division_id,true);
        xmlhttp.send();
