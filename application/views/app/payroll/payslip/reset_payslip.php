...
<div class="row">
  ...
  <div class="col-md-6">  
    <div class="box box-primary">
        <div class="panel-heading "><strong><?php echo $reset_payslip_remarks;?></strong> 
<?php 
if($reset_payslip_state>=1){
echo '<i class="fa fa-check text-success"></i><br><i class="fa fa-arrow-right"></i> You may recompute at payroll> generate payslip  <i>OR</i>';
echo " <a href=".base_url()."app/payroll_generate_payslip>Click Me</a>";
}else{
     ...
     <?php
      ...
      if($reset_payslip_state>=1){
        ...
        <table border=1>
          ...
          foreach($reset_payslip_data as $rd){ // rd : reset data
            echo '<tr><td> '.$rd->employee_id.'</td><td> '.$rd->fullname.'</td><td> '.$rd->net_pay.'</td><td> Successfully Reset. <i class="fa fa-check text-success"></i> </td></tr>';
          }
