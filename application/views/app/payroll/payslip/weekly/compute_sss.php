...
//============GET SSS GROSS
	if($sss_formula==""){// no formula for sss gross yet
				...
				/*every 1stcutoff*/	if($sss_deduct_on=="1"){ 
											...
											$sss_formula_value=$daily_rate*$mysalary_no_of_days_monthly;
											$sss_formula_text="1st Cut Off Deduction will base on net basic only : ".number_format($sss_formula_value);
