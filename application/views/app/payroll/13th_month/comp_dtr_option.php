...
<div class="form-group"   >
		<label for="next" class="col-sm-5 control-label">Payrol Period- (Release of 13th Month).</label>
	<div class="col-sm-7">
...
<?php
	if($payroll_option=="manual_tertin_month"){
		echo '<input type="hidden" name="formula" id="formula" value="not_involved">';
	}else{
