...
<div class="form-group"   >
		<label for="next" class="col-sm-5 control-label">Payrol Period- (Release of Bonus)</label>
	<div class="col-sm-7">
		...
		if(!empty($pay_per_dtr)){
			foreach($pay_per_dtr as $pay_period){
				...
				if($payroll_option=="print_payslip" OR $payroll_option=="reset_payslip"){
					$check_posted_payroll_period=$this->Payroll_generate_bonus_model->check_posted_payroll_period($pay_period->id);
...
<?php
	if($payroll_option=="print_payslip" OR $payroll_option=="reset_payslip" OR $payroll_option=="manual_bonus" ){
		echo '
...
<div class="form-group"   >
		<label for="next" class="col-sm-5 control-label">13th Month Coverage From</label>
	<div class="col-sm-7">
...
<div class="form-group"   >
		<label for="next" class="col-sm-5 control-label">13th Month Coverage To</label>
	<div class="col-sm-7">
...
<div class="form-group"   >
		<label for="next" class="col-sm-5 control-label">Choose Formula</label>
	<div class="col-sm-7">
