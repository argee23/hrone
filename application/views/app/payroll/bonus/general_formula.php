  ...
  <div class="box box-primary">
    <div class="box-header with-title bg-warning">
      ...
      <div class="box-tools pull-right">
        ...
        <button data-toggle="modal" data-target="#payroll_formula" class="btn btn-box-tool text-danger"><i class="fa fa-gear"></i> Manage 13th Month Formulas</button>
      </div>
    </div>
      ...
      <div class="modal-header bg-success">
        ...
        <div class="collapse" id="add_formula_collapse">
          <div class="well">
            ...
            <form action="<?php echo base_url()?>app/payroll_generate_13th_month/add_formula" method="post" id="add_formula">
              <div class="row">
...
function select_emp(val)
 ...
 function fetch_pay_period_group()
        ...
        xmlhttp.open("GET","<?php echo base_url();?>app/payroll_generate_13th_month/comp_payroll_period_group/"+company_id+"/"+pay_type,true);
        xmlhttp.send();
