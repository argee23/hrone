...
if($selected_payroll_option=="manual_bonus"){
?>
  ...
  <input type="hidden" name="payroll_option" value="manual_bonus">
...
if($selected_payroll_option=="manual_bonus"){
    ...
    require(APPPATH.'views/app/payroll/bonus/payslip_header.php');  
}
...
require(APPPATH.'views/app/payroll/bonus/print_payslip_body.php');    
...
require(APPPATH.'views/app/payroll/bonus/reset_payslip.php');    //print_payslip_body
              
               $reset_posted_tertin_month=$this->Payroll_generate_bonus_model->reset_posted_tertin_month($company_id,$employee_id,$pay_period);
