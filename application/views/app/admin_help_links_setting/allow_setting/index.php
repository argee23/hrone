...
<!-- Start Content Header (Page header) -->
  <section class="content-header">
    ...
    <h1>
       Settings
       <small>Allow to view the quick links and system help</small>
    </h1>
   <ol class="breadcrumb">
      ...
      <div class="panel panel-info">
            ...
            <div class="box-body fixed-panel-side-dos mCustomScrollbar" data-mcs-theme="dark">
                ...
                <?php foreach($companyList as $company){?>
                  <li class="my_hover"><a style='cursor: pointer;' onclick="setting('<?php echo $company->company_id;?>');"><i class='fa fa-circle-o'></i> <span><?php echo $company->company_name;?></span></a></li>
                <?php } ?>
                </ul>
  ...
  <div class="col-md-9" style="padding-bottom: 50px;">
    ...
    <script type="text/javascript">
      ...
      function setting(company)
      {
        ...
        xmlhttp.open("GET","<?php echo base_url();?>app/system_help_link_settings/allow_setting_main/"+company,true);
        xmlhttp.send();
      }
