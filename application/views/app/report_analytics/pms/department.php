              ...
              <div class="row">
                <div class="col-md-3">
                  <div class="form-group">
                    ...
                    <select  class="selectpicker"  data-live-search="true" id='company' data-width="100%" name="company" onchange="get_depart(this.value);" data-style="btn-default"  required="">
                  ...
                  <div class="form-group">
                    ...
                    <select name="department" id="sel_depart" class="selectpicker" required="" data-live-search="true" data-width="100%"   data-style="btn-default" >
...
<span class="pull-right">Page rendered in <strong>{elapsed_time}</strong> seconds. <b>Version</b> 1.0</span>
    ...
    $(document).on('click','#btnFilters',function(s){

        if ($("#btnFilter")[0].checkValidity()){
        $.ajax({
            url: "<?php echo base_url();?>app/report_analytics_pms/filtered_department/",
...
function get_depart(element)
 {$('#sel_depart').selectpicker('refresh').empty();
     ...
     jQuery.ajax({
        type: "POST",
        url: "<?php echo base_url();?>app/report_analytics_pms/get_depart/",
        dataType: 'json',
        data: {"id" : element},
        success: function(res) {
               $.each(res,function(index,data){
                    $('#sel_depart').append('<option value="'+data['department_id']+'|'+data['dept_name']+'">'+data['dept_name']+'</option>');
