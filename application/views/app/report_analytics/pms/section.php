              ...
              <div class="row">
                ...
                <div class="col-md-3">
                  <div class="form-group">
                    ...
                    <select name="section" id="sel_depart" class="selectpicker" data-live-search="true" data-width="100%" data-style="btn-default" >
...
<span class="pull-right">Page rendered in <strong>{elapsed_time}</strong> seconds. <b>Version</b> 1.0</span>
    ...
    $(document).on('click','#btnFilters',function(){
     ...
     if ($("#btnFilter")[0].checkValidity()){
        $.ajax({
            url: "<?php echo base_url();?>app/report_analytics_pms/filtered_section/",
 ...
 { $('#sel_depart').selectpicker('refresh').empty();
     ...
     jQuery.ajax({
        type: "POST",
        url: "<?php echo base_url();?>app/report_analytics_pms/get_section/",
        dataType: 'json',
        data: {"id" : element},
        success: function(res) {
               $.each(res,function(index,data){
                    $('#sel_depart').append('<option value="'+data['section_id']+'|'+data['section_name']+'">'+data['section_name']+'</option>');
