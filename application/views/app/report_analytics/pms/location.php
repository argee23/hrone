            ...
            <div class="box-body">
              ...
              <div class="row">
                  ...
                  <div class="form-group">
                    ...
                    <select name="company" class="selectpicker" data-live-search="true" data-width="100%" onchange="get_depart(this.value);" data-style="btn-default" required="" >
                ...
                <div class="col-md-3">
                  <div class="form-group">
                    ...
                    <select name="location" id="sel_depart" class="selectpicker" data-live-search="true" data-width="100%" data-style="btn-default" >
...
<span class="pull-right">Page rendered in <strong>{elapsed_time}</strong> seconds. <b>Version</b> 1.0</span>
    ...
    $(document).on('click','#btnFilters',function(){
        ...
        $.ajax({
            url: "<?php echo base_url();?>app/report_analytics_pms/filtered_location/",
 ...
 {$('#sel_depart').selectpicker('refresh').empty();
     ...
     jQuery.ajax({
        type: "POST",
        url: "<?php echo base_url();?>app/report_analytics_pms/get_location/",
        dataType: 'json',
        data: {"id" : element},
        success: function(res) {
               $.each(res,function(index,data){
                    $('#sel_depart').append('<option value="'+data['location_id']+'|'+data['location_name']+'">'+data['location_name']+'</option>');
