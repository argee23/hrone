  ...
  <div class="box box-default">
              ...
              <div class="row">
                <div class="col-md-4">
                  <div class="form-group">
                    ...
                    <select name="location" id="location" class="selectpicker" data-live-search="true" data-width="100%" data-style="btn-default" >
                          <?php foreach ($companyList as $company): ?>
                        <option value="<?php echo $company->company_id.'|'.$company->company_name; ?>"><?php echo $company->company_name ?></option>
                      <?php endforeach ?>
                    </select>
                  </div>
                </div>
    ...
    <option value="<?php echo $get_appraisal_schedule->appraisal_period_type_dates; ?>"><?php echo date("d-M-Y", strtotime($get_appraisal_schedule->appraisal_period_type_dates)); ?></option>
        <?php } ?>
                ...
                <div class="col-md-4">
                  <label for=""></label>
                  <button  type="button" class="btn btn-warning btn-block" onclick="btnFilter();" ><i class="fa fa-filter" ></i> Filter</button>
                </div>
                <!-- col-md-4 -->
              </div>
              <!-- row -->
...
<span class="pull-right">Page rendered in <strong>{elapsed_time}</strong> seconds. <b>Version</b> 1.0</span>
    ...
    function btnFilter(){
        ...
        $.ajax({
            url: "<?php echo base_url();?>app/report_analytics_pms/get_employee_count_recommendation/",
