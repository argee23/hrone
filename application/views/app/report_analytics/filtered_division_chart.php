        ...
        <div class="col-md-9">
          <div class="box box-danger">
            ...
            <div class="box-body">
              ...
              <form action="<?php echo base_url()?>app/report_analytics/get_employee_count_division" method="post" id="get_employee_count">
              <div class="row">
                <div class="col-md-4">
            ...
            <table class="table table-hover table-responsive table-bordered">
              ...
              <tbody>
                <?php foreach ($this->input->post("division") as $key => $div_id): 

                  $div = $this->report_analytics_model->get_division_details($div_id);
                ?>
                <tr>
                  <td><?php echo $div->division_name ?></td>
                  <td><?php echo $div->company_name ?></td>
                  <?php
                    $ci = & get_instance();
                    $ci->load->model("app/report_analytics_model");
                    $count_filter = $ci->report_analytics_model->get_division_filtered($div->division_id);?>
                 ...
                 <script>
                  ...
                  var myChart = new Chart(ctx, {
                      ...
                      data: {
                          ...
                          foreach ($this->input->post("division") as $key => $division1) {

                            $div1 = $this->report_analytics_model->get_division_details($division1);

                            $viewby = $div1->division_name;
                          ...
                          datasets: [
                          {
                              ...
                              data: [
                              <?php  $b = 1;
                                foreach ($this->input->post("division") as $key => $division) {
                                  $ci = & get_instance();
                                  $ci->load->model("app/report_analytics_model");
                                  $division_count = $this->report_analytics_model->get_division_count($division);
