        ...
        <div class="col-md-9">
          <div class="box box-danger">
            ...
            <table class="table table-hover table-responsive table-bordered">
              ...
              <tbody>
                <?php foreach ($subsectionList as $subsection2): 
                  $subsec_id = $subsection2->subsection_id;
                 ...
                 <script>
                  ...
                  var myChart = new Chart(ctx, {
                      ...
                      data: {
                          ...
                          foreach ($subsectionList as $subsection1) {
                          ...
                          datasets: [
                          {
                              ...
                              <?php  $b = 1;
                                foreach ($subsectionList as $subsection) {
                                  $ci = & get_instance();
                                  $ci->load->model("app/report_analytics_model");
                                  $subsection_count = $this->report_analytics_model->get_subsection_count($subsection->subsection_id);
