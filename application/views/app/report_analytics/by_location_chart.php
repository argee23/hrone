        ...
        <div class="col-md-9">
          <div class="box box-danger">
            ...
            <table class="table table-hover table-responsive table-bordered">
              ...
              <tbody>
                <?php foreach ($locationList as $location2): 
                  $loc_id = $location2->location_id;
                ...
                var myChart = new Chart(ctx, {
                    ...
                    data: {
                        ...
                        foreach ($locationList as $location1) {
                        ...
                        datasets: [
                        {
                            ...
                            <?php  $b = 1;
                              foreach ($locationList as $location) {
                                $ci = & get_instance();
                                $ci->load->model("app/report_analytics_model");
                                $location_count = $this->report_analytics_model->get_location_count($location->location_id);
