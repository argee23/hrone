        ...
        <div class="col-md-9">
          <div class="box box-danger">
            ...
            <div class="box-body">
              ...
              <form action="<?php echo base_url()?>app/report_analytics/get_employee_count_section" method="post" id="get_employee_count">
              <div class="row">
                <div class="col-md-4">
            ...
            <table class="table table-hover table-responsive table-bordered">
              ...
              <tbody>
                <?php foreach ($this->input->post("section") as $key => $sec_id): 

                  $sec = $this->report_analytics_model->get_section_details($sec_id);
                ?>
                <tr>
                  <td><?php echo $sec->section_name ?></td>
                  <td><?php echo $sec->dept_name ?></td>
                  <?php
                    $ci = & get_instance();
                    $ci->load->model("app/report_analytics_model");
                    $count_filter = $ci->report_analytics_model->get_section_filtered($sec->section_id);?>
                 ...
                 <script>
                  ...
                  var myChart = new Chart(ctx, {
                      ...
                      data: {
                          ...
                          foreach ($this->input->post("section") as $key => $sec_id) {

                            $section1 = $this->report_analytics_model->get_section_details($sec_id);
                            $viewby = $section1->section_name;
                          ...
                          datasets: [
                          {
                              ...
                              data: [
                              <?php  $b = 1;
                                foreach ($this->input->post("section") as $key => $section_id) {
                                  $ci = & get_instance();
                                  $ci->load->model("app/report_analytics_model");
                                  $section_count = $this->report_analytics_model->get_section_count($section_id);
