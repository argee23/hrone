        ...
        <div class="col-md-9">
          <div class="box box-danger">
            ...
            <table class="table table-hover table-responsive table-bordered">
              ...
              <tbody>
                <?php foreach ($sectionList as $section2): 
                  $sec_id = $section2->section_id;
                 ...
                 <script>
                  ...
                  var myChart = new Chart(ctx, {
                      ...
                      data: {
                          ...
                          foreach ($sectionList as $section1) {
                          ...
                          datasets: [
                          {
                              ...
                              <?php  $b = 1;
                                foreach ($sectionList as $section) {
                                  $ci = & get_instance();
                                  $ci->load->model("app/report_analytics_model");
                                  $section_count = $this->report_analytics_model->get_section_count($section->section_id);
