        ...
        <div class="col-md-9">
          <div class="box box-danger">
            ...
            <table class="table table-hover table-responsive table-bordered">
              ...
              <tbody>
                <?php foreach ($divisionList as $division2): 
                  $div_id = $division2->division_id;
                  ...
                  var myChart = new Chart(ctx, {
                      ...
                      data: {
                          ...
                          foreach ($divisionList as $division1) {
                            ...
                            $viewby = $division1->division_name;
                          ...
                          datasets: [
                          {
                              ...
                              <?php  $b = 1;
                                foreach ($divisionList as $division) {
                                  $ci = & get_instance();
                                  $ci->load->model("app/report_analytics_model");
                                  $division_count = $this->report_analytics_model->get_division_count($division->division_id);
