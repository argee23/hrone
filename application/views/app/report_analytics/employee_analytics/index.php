        ...
        <div class="col-md-4">
          ...
          <div class="box box-primary box-solid">
            <div class="box-header">
              <h4 class="box-title"><a href="#quickview" data-toggle="collapse">Employee Analytics</a></h4>
            </div>
            <div class="box-body" id="quickview">              
              <ul class="list-group">
              <?php foreach($analytics as $a){  
              $code = $a->code;
              if($code=='E19' || $code=='E11' || $code=='E16' || $code=='E12' || $code=='E10'){} else{
              ?>
                <li class="list-group-item"><a style="cursor: pointer;" onclick="get_filtering_employee('<?php echo $a->code;?>')"><?php echo $a->title;?></a></li>
              <?php }} ?>
              </ul>
            </div>
          </div>
