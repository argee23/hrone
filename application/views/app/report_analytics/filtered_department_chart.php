        ...
        <div class="col-md-9">
          <div class="box box-danger">
            ...
            <div class="box-body">
              ...
              <form action="<?php echo base_url()?>app/report_analytics/get_employee_count_dept" method="post" id="get_employee_count">
              <div class="row">
                <div class="col-md-4">
            ...
            <table class="table table-hover table-responsive table-bordered">
              ...
              <tbody>
                <?php foreach ($this->input->post("department") as $key => $d_id): 
                  $dept = $this->report_analytics_model->get_dept_details($d_id);
                ?>
                <tr>
                  <td><?php echo $dept->dept_name ?></td>
                  <td><?php echo $dept->company_name?></td>
                  <?php
                    $ci = & get_instance();
                    $ci->load->model("app/report_analytics_model");
                    $count_filter = $ci->report_analytics_model->get_dept_filtered($dept->department_id);?>
              ...
              <script>
                ...
                var myChart = new Chart(ctx, {
                    ...
                    data: {
                        ...
                        foreach ($this->input->post("department") as $key => $dept_id) {
                          $ci = & get_instance();
                          $ci->load->model("app/report_analytics_model");
                          $dept1 = $this->report_analytics_model->get_dept_details($dept_id);
                          $viewby = $dept1->dept_name;
                        ...
                        datasets: [
                        {
                            ...
                            data: [
                            <?php  $b = 1;
                              foreach ($this->input->post("department") as $key => $dept_id2) {
                                
                                $dept_count = $this->report_analytics_model->get_dept_count($dept_id2);
