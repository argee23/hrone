...
<div class="box box-danger">
    <div class="box-header">
     <n class='text-danger'><b>ANALYTICS</b></n>
    </div>
    <div class="box-body">
      ...
      <div class="col-md-12">
                ...
                <div class="col-md-8">
                 ...
                 <div class="col-md-12" id="multiplecompany" style="display: none;">
                  ...
                  <div class="col-md-12"  style="margin-top: 10px;">
                    ...
                    <div class="col-md-12">
                      <select class="form-control" name="date_range_option" id="date_range_option" onchange="date_checker_range();">
                  ...
                  <div class="col-md-12"  style="margin-top: 10px;">
                    ...
                    <div class="col-md-12"><input type="color" name="color" id="color" class="form-control" required></div>
                  </div>

                   <div class="col-md-12"  style="margin-top: 10px;">
                    <div class="col-md-12"><label>Analytics Title:</label></div>
                    <div class="col-md-12"><input type="text" name="title" id="title" class="form-control" required></div>
                  </div>
          ...
          <?php } else if($code=='A3'){  ?>
             ...
             <form action="<?php echo base_url()?>app/report_analytics_recruitment/analytics_month_hired/<?php echo $code;?>" method="post" id="get_employee_count" target="_blank">
                <div class="col-md-2"></div>
                <div class="col-md-8">
                  <div class="col-md-12">
          ...
          <?php } else if($code=='A9'){ ?>
             ...
             <form action="<?php echo base_url()?>app/report_analytics_recruitment/get_analytics_results/<?php echo $code;?>" method="post" id="get_employee_count" target="_blank">
                ...
                <div class="col-md-8">
                  ...
                  <div class="col-md-12"  style="margin-top: 10px;">
                    <label>Date From (Date Posted):</label>
                    <input type="date" name="datefrom" id="datefrom" class="form-control" required> 
                  </div>

                  <div class="col-md-12"  style="margin-top: 10px;">
                    <label>Date To (Date Posted):</label>
                    <input type="date" name="dateto" id="dateto" class="form-control" required> 
                  </div>
