        ...
        <div class="col-md-9">
          <div class="box box-danger">
            ...
            <div class="box-body">
              ...
              <form action="<?php echo base_url()?>app/report_analytics/get_employee_count_location" method="post" id="get_employee_count">
              <div class="row">
                <div class="col-md-4">
            ...
            <table class="table table-hover table-responsive table-bordered">
              ...
              <tbody>
                <?php foreach ($this->input->post("location") as $key => $loc_id): 
                  $loc = $this->report_analytics_model->get_location_details($loc_id);
                ?>
                <tr>
                  ...
                  <?php
                    ...
                    $count_filter = $ci->report_analytics_model->get_location_filtered($loc->location_id);?>
                ...
                var myChart = new Chart(ctx, {
                    ...
                    data: {
                        ...
                        foreach ($this->input->post("location") as $key => $location_id) {
                          ...
                          $location1 = $this->report_analytics_model->get_location_details($location_id);
                          $viewby = $location1->location_name;
                        ...
                        datasets: [
                        {
                            ...
                            data: [
                            <?php  $b = 1;
                              foreach ($this->input->post("location") as $key => $location_id2) {
                                $ci = & get_instance();
                                $ci->load->model("app/report_analytics_model");
                                $location_count = $this->report_analytics_model->get_location_count($location_id2);
