        ...
        <div class="col-md-9">
          <div class="box box-danger">
            ...
            <div class="box-body">
              ...
              <form action="<?php echo base_url()?>app/report_analytics/get_employee_count_subsection" method="post" id="get_employee_count">
              <div class="row">
                <div class="col-md-4">
            ...
            <table class="table table-hover table-responsive table-bordered">
              ...
              <tbody>
                <?php foreach ($this->input->post("subsection") as $key => $subsec_id): 
                  
                  $subsec = $this->report_analytics_model->get_subsection_details($subsec_id);
                ?>
                <tr>
                  <td><?php echo $subsec->subsection_name ?></td>
                  <td><?php echo $subsec->section_name ?></td>
                  <?php
                    $ci = & get_instance();
                    $ci->load->model("app/report_analytics_model");
                    $count_filter = $ci->report_analytics_model->get_subsection_filtered($subsec->subsection_id);?>
                 ...
                 <script>
                  ...
                  var myChart = new Chart(ctx, {
                      ...
                      data: {
                          ...
                          foreach ($this->input->post("subsection") as $key => $subsec_id1) {

                            $subsection1 = $this->report_analytics_model->get_subsection_details($subsec_id1);

                            $viewby = $subsection1->subsection_name;
                          ...
                          datasets: [
                          {
                              ...
                              data: [
                              <?php  $b = 1;
                                foreach ($this->input->post("subsection") as $key => $subsection_id) {
                                  $ci = & get_instance();
                                  $ci->load->model("app/report_analytics_model");
                                  $subsection_count = $this->report_analytics_model->get_subsection_count($subsection_id);

                                echo $subsection_count.",";
                                $b++;}
                               ?>
                              ],
                              backgroundColor: [
