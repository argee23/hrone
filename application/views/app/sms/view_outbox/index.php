...
?>
	...
	<a class="btn btn-danger col-md-12" style="text-align:left;cursor: pointer !important;float:right;" title="Click to View Grouped Contacts" 
onclick="getOutBox(<?php echo $c->company_id?>);"  > <strong>
