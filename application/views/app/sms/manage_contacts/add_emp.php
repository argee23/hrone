<strong>GROUP NAME: <?php echo $gcInfo->group_name;?></strong>

<form class="form-horizontal" method="post" action="<?php echo base_url()?>app/sms/filter_for_grouped_employees/" target="_blank">
