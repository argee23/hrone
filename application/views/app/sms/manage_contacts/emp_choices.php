...
<div class="col-md-6">
		<div class="panel panel-danger">
			<div class="panel-heading"><strong>Check employee you want to enroll in Contact Group Name <u><?php echo $gcInfo->group_name;?></u></strong></div>
...
?>
			...
			<form class="form-horizontal" method="post" action="<?php echo base_url()?>app/sms/enrol_employee_grouped_contact/" >
...
<div class="col-md-6">
		<div class="panel panel-success">
			<div class="panel-heading"><strong>Currently Enrolled Employees in Group Named <u><?php echo $gcInfo->group_name;?></u></strong></div>
			<div class="panel-body">
...
?>
			...
			<span class="text-danger">Click to Check | Uncheck All</span>
	<form class="form-horizontal" method="post" action="<?php echo base_url()?>app/sms/un_enrol_employee_grouped_contact/" >
<?php
