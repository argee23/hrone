<?php 
    $nof = $this->uri->segment("4");
       ...
       while($noff!=$count){
        ...
        <div class="col-sm-7">
                  <input type="text" class="form-control" name="disobedience[]" id="disobediencea"  onblur="return trim(this)" placeholder="Disobedience" value="" required>
     ...
     <br></br>
      ...
      <label for="for-numdis" id="fornumdis[]"  class="col-sm-3 control-label">No. of Disobedience</label>
        <div class="col-sm-7">
                    <input type="text" name="numdis[]" id="numdis" class="form-control" placeholder="No.of Disobedience" value="'.$noff.'">
