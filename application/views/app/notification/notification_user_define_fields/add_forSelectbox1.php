      ...
      <div class="form-group">
        <label for="max_length" class="col-sm-2 control-label" id="for_ml">No. of Option</label>
        <div class="col-sm-10">
            <input type="number" class="form-control" name="max_length" id="max_length" placeholder="How Many Option(s)" value=""  min="1" max="255" required>
        </div>
      </div>