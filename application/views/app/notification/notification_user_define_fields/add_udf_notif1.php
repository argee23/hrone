...
<?php 
    ...
    //echo $company_id."UDN ni NEMZ";
        $companyName3=$this->notification_user_define_fields_model->companyName3($company_id);

       ?>
 <form class="form-horizontal" method="post" action="<?php echo base_url()?>app/notification_user_define_fields/save_udn_col1_new/<?php echo $this->uri->segment("4");?>" >
