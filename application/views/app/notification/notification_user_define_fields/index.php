...
<section class="content-header">
  <h1>
    ...
    <small>User Define Notification (Notification Form)</small>
  </h1>
  <ol class="breadcrumb">
    <li><a href="<?php echo base_url()?>app/dashboard"><i class="fa fa-dashboard"></i> Home</a></li>
    <li>Notification Form</li>
    <li class="active">User Define Notification</li>
  </ol>
</section>
      ...
      <div class="row">
        ...
        <div class="col-md-4">
          <div class="box box-primary">
                ...
                <div class="panel-heading"><strong>Select a company</strong> 
                </div>
                ...
                <div class="box-body">
                <!-- <div class="col-sm-10"> -->
                  <select class="form-control" name="company" id="company" onchange="view_company_udn(this.value)" required>
...
////////////////////////////////////////////////////////////////////////////////
 ...
 {          
        ...
        xmlhttp.open("GET","<?php echo base_url();?>app/notification_user_define_fields/create_new/"+val,true);
        xmlhttp.send();
   ...
   function next_new()
        ...
        xmlhttp.open("GET","<?php echo base_url();?>app/notification_user_define_fields/next_create_new/"+no_of_field+"/"+company_id,false);
        xmlhttp.send();

        }

   function editUDNCol1(val)
    {          
            ...
            xmlhttp.open("GET","<?php echo base_url();?>app/notification_user_define_fields/edit_udn_new/"+val,true);
            xmlhttp.send();
    }


      function viewUDNCol(val)
    {          
            ...
            xmlhttp.open("GET","<?php echo base_url();?>app/notification_user_define_fields/view_emp_udn/"+val,true);
            xmlhttp.send();
    }

    function addNewUDNCol1(val)
 {          
        ...
        xmlhttp.open("GET","<?php echo base_url();?>app/notification_user_define_fields/add_new_notif_udf1/"+val+"/"+t_table_name+"/"+company_id,true);
        xmlhttp.send();
    ...
    {          
            ...
            xmlhttp.open("GET","<?php echo base_url();?>app/notification_user_define_fields/edit_emp_udf_col_new/"+val,true);
            xmlhttp.send();
    }
    ...
    {          
            ...
            xmlhttp.open("GET","<?php echo base_url();?>app/notification_user_define_fields/view_emp_udf_opt/"+val,true);
            xmlhttp.send();
    }
    ...
    {               
        ...
        xmlhttp.open("GET","<?php echo base_url();?>app/notification_user_define_fields/view_add_forTextfield1/"+val,true);
        xmlhttp.send();
    }
    ...
    {          
          ...
          xmlhttp.open("GET","<?php echo base_url();?>app/notification_user_define_fields/add_opt_emp_udf/"+val,true);
          xmlhttp.send();
...
function editUDFOpt(val)
    {          
            ...
            xmlhttp.open("GET","<?php echo base_url();?>app/notification_user_define_fields/edit_emp_udf_opt/"+val,true);
          xmlhttp.send();
    }
    ...
    {               
        ...
        xmlhttp.open("GET","<?php echo base_url();?>app/notification_user_define_fields/view_edit_forTextfield/"+val,true);
        xmlhttp.send();
    }  
  
        ////////////////////////////////////////START FOR DELETING CODES///////////////////////////////////////
    ...
    {              
        ...
        xmlhttp.onreadystatechange=function()
          ...
          if (xmlhttp.readyState==4 && xmlhttp.status==200)
            ...
            document.getElementById("view_company_udn").innerHTML=xmlhttp.responseText;
            }
          }
        xmlhttp.open("GET","<?php echo base_url();?>app/notification_user_define_fields/view_company_udn/"+val,true);
        xmlhttp.send();
    }       
