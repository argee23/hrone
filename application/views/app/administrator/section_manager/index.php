            ...
            <div id="collapse2" class="panel-collapse collapse in">
                <div class="panel-body">
                  <ul>
                    ...
                    if($manage_sect_mngr_settings=="hidden "){
                    ?>
                      <li class="set_text"><a type="button" disabled title="No Access Rights">By Classification/Level</a></li>
                      <li class="set_text"><a type="button" disabled title="No Access Rights">Allow to access personnel working schedule?</a></li>
                      <li class="set_text"><a type="button" disabled title="No Access Rights">Allow Section Manager to plot their own schedule?</a>
                      </li>
                    ...
                    <li class="set_text"><a style='cursor: pointer;' onclick="setup_plot_own_sched();">Allow Section Manager to plot their own schedule?</a>
                    </li>
...
function loadDept(val)
   ...
   function setup_plot_own_sched()
  {
    if (window.XMLHttpRequest)
        ...
        xmlhttp2.open("GET","<?php echo base_url();?>app/section_manager/setup_plot_own_sched/",false);
        xmlhttp2.send(); 
  }

  function save_plot_own_schedule(action)
  {
    var company = document.getElementById('company_allow').value;
    var option = document.getElementById('option_allow').value;
    if(company=='' || option=='')
      ...
      if (window.XMLHttpRequest)
        ...
        xmlhttp2.open("GET","<?php echo base_url();?>app/section_manager/save_plot_own_schedule/"+action+"/"+company+"/"+option,false);
        xmlhttp2.send();
    }
  }

  function deleteDetails_plotschedule(id)
  {
      ...
      if (window.XMLHttpRequest)
        ...
        xmlhttp2.open("GET","<?php echo base_url();?>app/section_manager/deleteDetails_plotschedule/"+id,false);
        xmlhttp2.send();
       } 
  }
  function editDetails_plotSchedule(id)
  {
      if (window.XMLHttpRequest)
          {
          xmlhttp2=new XMLHttpRequest();
        ...
        xmlhttp2.open("GET","<?php echo base_url();?>app/section_manager/editform_plotschedule/"+id,false);
        xmlhttp2.send();
  }
</script>