          ...
          <div class="col-md-12" id='viewing_filtering'>
                ...
                <?php foreach($sectionmgrsList as $row) {?>
                  <tr>
                    ...
                    <td>
                        <a onclick="delete_manager_one('<?php echo $row->id?>','<?php echo $row->company_id?>')"><i  class="<?php echo $del_sect_mngr;?> fa fa-<?php echo $system_defined_icons->icon_delete;?> fa-lg pull-left" style='cursor:pointer;color:<?php echo $system_defined_icons->icon_delete_color;?>'></i></a>
                        <?php if($row->InActive==0)
                        {?>
                        <a onclick="status_manager_one('<?php echo $row->company_id?>','<?php echo $row->id?>','1');"><i  class="<?php echo $ena_dis_sect_mngr;?> fa fa-<?php echo $system_defined_icons->icon_enable;?> fa-lg pull-left" style='cursor:pointer;color:<?php echo $system_defined_icons->icon_enable_color;?>'></i></a>
                        <?php } else{ ?>
                          <a onclick="status_manager_one('<?php echo $row->company_id?>','<?php echo $row->id?>','0');"><i  class="<?php echo $ena_dis_sect_mngr;?> fa fa-<?php echo $system_defined_icons->icon_disable;?> fa-lg pull-left" style='cursor:pointer;color:<?php echo $system_defined_icons->icon_disable_color;?>'
></i></a>
                        <?php } ?>
                    </td>
                  </tr>
