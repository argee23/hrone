          ...
          <table id="classlevel" class="col-md-12 table table-hover table-striped">
                ...
                <?php  foreach ($classlevelList as $row) {?>
                    <tr>
                      ...
                      <td>
                        <a class='fa fa-<?php echo $system_defined_icons->icon_edit;?>' style='cursor:pointer;color:<?php echo $system_defined_icons->icon_edit_color;?>'
                      aria-hidden='true' data-toggle='tooltip' title='Click to edit!'  onclick='editDetails("<?php echo $row->id;?>","<?php echo $row->company_id?>")'></a>
                        <a class='fa fa-<?php echo $system_defined_icons->icon_delete;?>' style='cursor:pointer;color:<?php echo $system_defined_icons->icon_delete_color;?>' aria-hidden='true' data-toggle='tooltip' title='Click to delete record!'  onclick='deleteDetails(<?php echo $row->id;?>)'></a>
                      </td>
                    </tr>
                <?php } ?>
