...
<div class="well">
<!-- form start -->
  <form class="form-horizontal" method="post" action="<?php echo base_url()?>app/file_maintenance/modify_city/<?php echo $id;?>">
    <div class="box-body">
      ...
      <div class="form-group">
        ...
        <div class="col-sm-10">
          ...
          value="<?php if(empty($details->name)){} else{ echo $details->name; } ?>" disabled>
        </div>
      </div>
      ...
      <div class="form-group">
        ...
        <div class="col-sm-10">
          ...
          value="<?php if(empty($details->city_name)){} else{ echo $details->city_name; } ?>" required>
        </div>
      </div>
