    ...
    <li class="active">User Roles</li>
      ...
      <div class="row">
          ...
          <div class="col-md-3">
              ...
              <?php 
              echo   
              // "<a onclick='masterList"."()' type='button' class='btn btn-default btn-flat'><p class='text-left'><strong>User Master List</strong></p></a>".
              "<a onclick='userRoles"."()' type='button' class='btn btn-default btn-flat'><p class='text-left'><strong>User Roles</strong></p></a>";             
              ?>
              </div>
          </div>
...
<script>
 ...
 function userRoles()
        ...
        xmlhttp.open("GET","<?php echo base_url();?>app/roles/user_roles/",true);
        xmlhttp.send();
        }
