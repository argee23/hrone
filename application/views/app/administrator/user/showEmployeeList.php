...
<tbody>
    ...
    <tr>
        ...
        <td>   
            <a href="<?php echo base_url() ?>app/user/employee_select/<?php echo $showEmployeeList->id ?>" title="Select this user" ><font color="#ffffff"><i class="fa fa-external-link fa-lg" aria-hidden="true"></i></font>
            </a>
        </td>
    </tr>
    <?php }?>
