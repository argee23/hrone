          ...
          <table id="settingaccess" class="col-md-12 table table-hover table-striped">
                ...
                <?php  foreach ($accessList as $row) {?>
                    <tr>
                      ...
                      <td>
                        <a class='fa fa-pencil-square-o' aria-hidden='true' data-toggle='tooltip' title='Click to edit!'  onclick='editDetails_allowaccess(<?php echo $row->section_manager_access_id;?>)'></a>
                        <a class='fa fa-trash' aria-hidden='true' data-toggle='tooltip' title='Click to delete record!'  onclick='deleteDetails_allowaccess(<?php echo $row->section_manager_access_id;?>)'></a>
                      </td>
                    </tr>
                <?php } ?>
