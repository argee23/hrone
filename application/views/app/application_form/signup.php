...
<html>
  ...
  <br>
    <body class="signup-bg fixed sidebar-mini" ng-app="myApp" ng-controller="appCtrl" ng-init="selected_job = '<?php echo $selected; ?>'" ng-cloak>
       ...
       <!-- Shown when there is no selected job. -->
        ...
        <div class="panel panel-default">
         <div class="panel-body">
          ...
          <button type="button" class="btn btn-info btn-flat btn-block" ng-click="getQualifyingQuestions()" onclick="scroll()">APPLY NOW</b></button>
                                ...
                                <div class="col-lg-12">                
                                  ...
                                  <div class="form-group has-feedback" ng-class="{'has-error' : apply_form.password.$invalid}">
                                    ...
                                    <div class="form-group col-lg-12">
                                     <input type='checkbox' id="terms_condition" name="terms_condition" ng-model="terms_condition" ng-value="terms_condition" required ><n class="text-danger">By signing up, I have read and agreed to UNIHRIS. <a style="cursor: pointer;" href="<?php echo base_url();?>app/application_forms/view_terms_condition/terms_of_use" target="_blank">Terms of Use</a> and  <a style="cursor: pointer;" href="<?php echo base_url();?>app/application_forms/view_terms_condition/privacy_policy" target="_blank"> Privacy Policy</a></n>
                                    </div>
