<?php
  /*
    ...
    -----------------------------------
    */
    $add_max_salary_app=$this->session->userdata('add_max_salary_app');
    $edit_max_salary_app=$this->session->userdata('edit_max_salary_app');
    $del_max_salary_app=$this->session->userdata('del_max_salary_app');
          ...
          <div class="col-md-12">
                 <div class='col-md-5'>
                  <div class="col-md-4"><label>Company:</label></div>
                    <div class="col-md-8">
                   <select class="form-control" id='setting_company' onchange="loadPending_trans(this.value)">
                             <option selected disabled value='0'>Select Company</option>
                            <?php foreach($companyList as $company){ 
                              $recheck_if_exist_no_approver =  $this->salary_approval_model->recheck_if_exist_no_approver($company->company_id);?>
          ...
          <table id="no_approver" class="col-md-12 table table-hover table-striped">
              ...
              {?>
                    <tr>
                      ...
                      <td>
                        <a class='<?php echo $edit_max_salary_app;?> fa fa-<?php echo $system_defined_icons->icon_edit;?>' style='cursor:pointer;color:<?php echo $system_defined_icons->icon_edit_color;?>' aria-hidden='true' data-toggle='tooltip' title='Click to edit!' onclick='edit_setting_no_approver("<?php echo $no->no_approver_id;?>","<?php echo $no->company_id?>")'></a>
                         <a class='<?php echo $del_max_salary_app;?> fa fa-<?php echo $system_defined_icons->icon_delete;?>' style='cursor:pointer;color:<?php echo $system_defined_icons->icon_delete_color;?>' aria-hidden='true' data-toggle='tooltip' title='Click to delete record!'  onclick='delete_setting_no_approver(<?php echo $no->no_approver_id;?>)'></a>
                      </td>
                    </tr>
              <?php } ?>
                    </tbody>
