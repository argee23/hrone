  ...
  <div class="col-md-3"></div>
    <div class="col-md-6">
        <select class="form-control" name="data" id="data" required>
        	...
        	<option value="automatic" <?php if(!empty($details->data)){ if($details->data=='automatic'){ echo "selected"; } }?> >Automatic Adding</option>
        	<option value="manual" <?php if(!empty($details->data)){ if($details->data=='manual'){ echo "selected"; } }?> >Manual Adding</option>
        </select>
