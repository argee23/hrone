                  ...
                  <tr>
                    ...
                    <td>
                      ...
                      <div id="original<?php echo $d->interview_id;?>">
                        ...
                        <a style='cursor:pointer;color:<?php echo $system_defined_icons->icon_delete_color;?>' aria-hidden='true' data-toggle='tooltip' title='Click to delete interview process' onclick="interview_process_action('<?php echo $company_id;?>','<?php echo $d->interview_id;?>','delete');">
