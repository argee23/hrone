 <div class="modal-content">
      <div class="modal-header well well-sm bg-olive" > <i class="fa fa-times-circle pull-right text-danger fa-lg" style="cursor: pointer;" onclick="window.location.reload()"></i>
        <h4 style="font-weight: serif;"><center><?php echo $job_title; ?></center>
       </h4>
      </div>
      ...
      <div class="modal-body">
        ...
        <div class="panel-body">
          ...
          <?php foreach($jobs as $j){?>
            ...
            <dd>
              <?php 
                   echo $j->plantilla_no."(".$j->plantilla_from." to ".$j->plantilla_to.")";
              ?>
            </dd>
            <br>

            <dt>Plantilla Date</dt>
            <dd>
              <?php 
                   echo "(".$j->plantilla_from." to ".$j->plantilla_to.")";
              ?>
            </dd>
            <br>
            ...
            <dt>Industry</dt>
            <dd>
                <?php $job_specs=$this->final_recruitments_model->getjob_specs($j->job_specialization);
