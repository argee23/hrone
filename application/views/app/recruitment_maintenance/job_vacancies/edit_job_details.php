...
<div class="modal-content">
     ...
     <div class="modal-header well well-sm bg-olive" >
      ...
      <div class="modal-body">
       <form class="form-horizontal" method="post" action="<?php echo base_url()?>app/recruitment_plantilla/update_job_position/<?php echo $j->job_id."/".$company_id."/".$employer_type;?>">
