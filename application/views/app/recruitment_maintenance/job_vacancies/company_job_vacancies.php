                    ...
                    <?php foreach ($job_vacancies as $j) {?>
                        <tr>
                          ...
                          <td>
                               ...
                               <a style='cursor:pointer;color:blue;' style="cursor: pointer;" data-toggle='modal' data-target='#modal' href="<?php echo base_url('app/recruitment_plantilla/job_vacancy_history')."/".$j->company_id."/".$employer_type."/".$j->job_id;?>" aria-hidden='true' data-toggle='tooltip' title='Click to View Job Vacancy Histories'><i  class="fa fa-file-text fa-lg  pull-left"></i></a>
