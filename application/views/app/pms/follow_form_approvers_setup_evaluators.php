                ...
                <div class="accordion">
                    ...
                    <div class="accordion-group">
                        ...
                        <div class="accordion-heading area">
                            <a class="accordion-toggle" data-toggle="collapse" href="#<?php echo $get_department->department_id ?>"><?php echo $get_department->dept_name; ?></a>
                        </div><!-- /Área -->
                   ...
                   <?php $load_section=  $this->pms_model->load_section($get_department->department_id); foreach($load_section as $load_section){ ?> 
                                    <div class="accordion-group">
                                        <div class="accordion-heading equipamento">
                                            ...
                                            <a class="accordion-toggle" data-parent="#equipamento1-1" data-toggle="collapse" href="#s<?php echo $load_section->section_id ?>"><?php  echo $load_section->section_name; ?></a>
                                            ...
                                            <div class="accordion-inner">
                                                     ...
                                                     <table class="table">
                                                                  ...
                                                                  <?php $qw = array(); foreach($a as $a){
                                                                    ...
                                                                    <td><?php if($a->approval_level == 1){ $c = 'st'; }elseif($a->approval_level == 2){ $c = 'nd';}elseif($a->approval_level == 3){$c == 'rd';}else{$c = 'th';} echo $a->approval_level.$c;?></td>
