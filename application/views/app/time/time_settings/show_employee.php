...
<input type="hidden" class="form-control" placeholder="Select Employee" name="employee" value="<?php echo $this->uri->segment('4'); ?>">
<input type="text" class="form-control" placeholder="Select Employee" value="<?php echo $name; ?>" required name="employee_string">
</a>