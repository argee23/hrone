<div class="well">
<!-- form start -->
  <form class="form-horizontal" method="post" action="<?php echo base_url()?>app/time_shift_table/save_edit_controlled/<?php echo $this->uri->segment("4");?>" >
    <div class="box-body">
      <div class="form-group">
      <strong>
    <?php 
         $company_id =$ws_controlled->company_id;
       ...
       ?>
         ...
         <br>
      <i class="fa fa-edit text-danger"></i> Rest day auto match schedule references
      <!-- //wsc: working schedule complete -->
      </strong>
      </div>
      <input type="hidden" name="company_name" value="<?php echo $company_name; ?>">
      <input type="hidden" name="company_id" value="<?php echo $company_id; ?>">
      <input type="hidden" name="classification_id" value="<?php echo $ws_controlled->classification; ?>">
      <?php 
      $time_in_hr=substr($ws_controlled->time_in, 0,2);
      $time_in_minute=substr($ws_controlled->time_in, 3,2);
      $time_out_hr=substr($ws_controlled->time_out, 0,2);
      $time_out_minute=substr($ws_controlled->time_out, 3,2);
      ...
      <div class="form-group">
        ...
        <div class="col-sm-8">
          <select name="lunch_break" class="form-control select2" required>
            <option value="<?php echo $ws_controlled->lunch_break;?>"><?php echo $ws_controlled->lunch_break;?></option>
            <?php $n="00";while($n!=65){ ?>
      ...
      <div class="form-group">
        ...
        <div class="col-sm-8">
          <select name="break_1" class="form-control select2">
            <option value="<?php echo $ws_controlled->break_1;?>"><?php echo $ws_controlled->break_1;?></option>
            <?php $n="00";while($n!=65){ ?>
            <option value="<?php echo sprintf("%02d", $n);?>" ><?php echo sprintf("%02d", $n);?></option>
            <?php $n=$n+5;} ?>
          </select>
      ...
      <div class="form-group">
        ...
        <div class="col-sm-8">
          <select name="break_2" class="form-control select2">
            <option value="<?php echo $ws_controlled->break_2;?>"><?php echo $ws_controlled->break_2;?></option>
            <?php $n="00";while($n!=65){ ?>
            <option value="<?php echo sprintf("%02d", $n);?>" ><?php echo sprintf("%02d", $n);?></option>
            <?php $n=$n+5;} ?>
          </select>
      ...
      <div class="form-group">
        ...
        <div class="col-sm-8">
    <!--      <input type="text" class="form-control" name="no_of_hours" placeholder="Registered Hours" maxlength="10" required value="<?php //echo $ws_controlled->no_of_hours;?>"> -->

        <select name="no_of_hours" class="form-control">
        <option value="<?php echo $ws_controlled->no_of_hours;?>"><?php echo $ws_controlled->no_of_hours;?></option>
          <?php 
      ...
      <div class="form-group">
        ...
        <div class="col-sm-8">
          <input type="text" class="form-control" name="description" id="description" placeholder="Description" value="<?php echo $ws_controlled->description;?>">
        </div>
      </div>
