...
<div class="col-md-12" style="padding-top:10px;" id='admin_enroll_employee'>
    <div class="col-md-12"><center><h4><b>List of Employees Enrolled</b></h4></center></div>
      ...
      <div class="col-md-12" id='upd_members'>
        ...
        <button class="btn btn-success pull-right" onclick="admin_update_members('<?php echo $company?>','<?php echo $grp_details->idd?>','<?php echo $grp_details->manager_in_charge?>' );" <?php if($grp_details->ii==1){ echo "disabled aria-hidden='true' data-toggle='tooltip' title='Not allowed to update members for Inactive group' "; }?> <?php echo $grp_details->company_id?>>UPDATE MEMBER/S</button>
      </div>
