...
<!-- SIDEBAR -->
  ...
  <!-- Start Content Header (Page header) -->
         ...
         <div class="box-header">
          ...
          <div style="height: 420px;">
             <ul class="nav nav-pills nav-stacked">
              ...
              <?php
              if($time_lock_pp=="hidden "){
              ?>
              <li class="text-danger"><a style='cursor: pointer;' title='Not Allowed.Check Access Rights.'><i class='fa fa-warning text-danger'></i> <span class="text-danger">Lock Plotting per Payroll Period Management</span></a></li>
              <?php
              }else{
              ?>
              ...
              <?php
              if($time_manage_schedule=="hidden "){
              ?>
              <li class="text-danger"><a style='cursor: pointer;' title='Not Allowed.Check Access Rights.'><i class='fa fa-warning text-danger'></i> <span  class="text-danger">Individual Plotting</span></a></li>
              <?php
              }else{                
              ?>
              ...
              if($time_manage_schedule=="hidden "){
              ?>
              <li class="text-danger"><a style='cursor: pointer;' title='Not Allowed.Check Access Rights.'><i class='fa fa-warning text-danger'></i> <span  class="text-danger">Group Plotting by Admin</span></a></li>
              <?php
              }else{                
              ?>
              <li><a style='cursor: pointer;' onclick="group_by_admin();"><i class='fa fa-circle-o text-success'></i> <span>Group Plotting by Admin</span></a></li>               
              <?php
              }
              ?>

              <?php
              if($time_view_sec_mng_plotted=="hidden "){
              ?>
              <li class="text-danger"><a style='cursor: pointer;' title='Not Allowed.Check Access Rights.'><i class='fa fa-warning text-danger'></i> <span  class="text-danger">Viewing of all Plotted Schedule of Section Managers</span></a></li>
              <?php
              }else{                
              ?>
              ...
              if($time_manage_schedule=="hidden "){
              ?>
              <li class="text-danger"><a style='cursor: pointer;' title='Not Allowed.Check Access Rights.'><i class='fa fa-warning text-danger'></i> <span  class="text-danger">Manual Uploading Thru Excel Template</span></a></li>
              <?php
              }else{                
              ?>
              <li><a style='cursor: pointer;' onclick="manual_upload();"><i class='fa fa-circle-o text-success'></i> <span>Manual Uploading Thru Excel Template</span></a></li>
              <?php
              }
               
            echo '
            <li>
            <a href="'.base_url().'app/time_work_schedule/index"><i class="fa fa-files-o"></i>Check Employee Schedule Type </a>
            </li>';
              ?>    
              </ul>
          </div>
    ...
    <script src="<?php echo base_url()?>public/plugins/select2/select2.full.min.js"></script>
      <?php 
        require_once(APPPATH.'views/app/time/plot_schedules/js_functions.php');
        require_once(APPPATH.'views/app/time/plot_schedules/manual_upload_js_function.php');
     ?>