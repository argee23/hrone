...
<label for="section" class="col-sm-2 control-label"><?php $check_dept=$this->uri->segment('4');?></label>
        <div class="col-sm-14" >
    <select class="form-control" name="section"  id="section" required onchange="fetch_sub_section()">
