...
<div class="panel panel-success">
  ...
  <div class="panel-heading"><strong><?php echo $employee->group_name; ?></strong> (<?php echo $employee->group_type; ?><?php if($employee->group_type === '102'){ echo ' : '.$employee->controlled_time_limit; } ?> )
  <i class="fa fa-arrow-circle-left fa-2x text-danger pull-right" data-toggle='tooltip' data-placement='left' title='View member(s)' onclick="view_group_employee('<?php echo $employee->flexi_group_id; ?>')"></i>
    ...
    <div class="row">
      ...
      <div class="form-group">
        <div class="col-sm-4">
        <p>Shift in and out</p>
        </div>
        <div class="col-sm-7">
            <label><?php echo $employee->standard_shift_in.'-'.$employee->standard_shift_out; ?></label>
        </div>
      </div>
      </div>
      ...
      <tbody>
        ...
        <?php } 
          ...
          <td><strong>Monday</strong></td>
          <td>
              <label><?php echo $employee->group_type; ?></label>
          </td>
          </tr>
        <?php } ?>
