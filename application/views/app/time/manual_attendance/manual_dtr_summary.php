...
<!-- 
  ...
  <form action="<?php echo base_url(); ?>app/time_manual_attendance/upload_manual_dtr_summary" method="post" name="upload_excel" enctype="multipart/form-data" target="_blank">
      <br>

	  <div class="form-group col-md-12">
	  <label for="type" class="col-sm-4 control-label">Download Allowed Template</label>
    <div class="col-sm-8">
	    <a href="<?php echo base_url().'app/time_manual_attendance/download_template_dtr_summary';?>"
