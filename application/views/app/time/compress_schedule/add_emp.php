<strong>GROUP NAME: <?php echo $gcInfo->compress_group_name;?></strong>

<form class="form-horizontal" method="post" action="<?php echo base_url()?>app/time_compress_schedule/filter_for_grouped_employees/" target="_blank">
