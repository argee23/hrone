...
<div class="col-md-6">
		<div class="panel panel-danger">
			<div class="panel-heading"><strong>Check employee you want to enroll in Contact Group Name <u><?php echo $gcInfo->compress_group_name;?></u></strong></div>
...
?>
			...
			<form class="form-horizontal" method="post" action="<?php echo base_url()?>app/time_compress_schedule/enrol_employee_grouped_contact/" >
...
<div class="col-md-6">
		<div class="panel panel-success">
			<div class="panel-heading"><strong>Currently Enrolled Employees in Group Named <u><?php echo $gcInfo->compress_group_name;?></u></strong></div>
			<div class="panel-body">
...
?>
			...
			<span class="text-danger">Click to Check | Uncheck All</span>
	<form class="form-horizontal" method="post" action="<?php echo base_url()?>app/time_compress_schedule/un_enrol_employee_grouped_contact/" >
	<input type="hidden" name="company_id" value="<?php echo $company_id;?>">
<?php
...
?>
			<button type="submit" class="btn btn-danger"><i class="fa fa-arrow-right"></i> Click to Remove Selected/Checked Employees</button>
...
<div class="col-md-12" style="margin-top: 20px">
		<div class="panel panel-danger">
			<div class="panel-heading"><strong>Currently Enrolled Employees in Other Group</u></strong></div>
			<div class="panel-body">
...
<tbody>
							...
							<?php
							if(!empty($all_grouped_enrolled)){
								foreach($all_grouped_enrolled as $e){
echo '
	<tr>
