...
$process_dtr_summary_state=$this->time_dtr_model->process_my_dtr_leave_adjustment($company_id,$pay_period,$employee_id,$salary_rate,$pay_type,$leave_adjustment_total);
