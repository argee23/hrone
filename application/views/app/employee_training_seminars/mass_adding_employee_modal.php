        ...
        <div class="panel-body">
          <span class="dl-horizontal col-sm-6">
            ...
            <dd  style="margin-top: 5px;">
                <select class="form-control" onchange="get_location_department_classification(this.value);" id="company">
...
<script type="text/javascript">
     ...
     function getemp_location(company)
     {
        ...
        xmlhttp2.open("GET","<?php echo base_url();?>app/employee_training_seminars/getemp_location/"+company,false);
        xmlhttp2.send();
     }
     ...
     function getemp_classification(company)
     {
        ...
        xmlhttp2.open("GET","<?php echo base_url();?>app/employee_training_seminars/getemp_classification/"+company,false);
        xmlhttp2.send();
     }
     function getemp_department(company)
     {
        ...
        xmlhttp2.open("GET","<?php echo base_url();?>app/employee_training_seminars/getemp_department/"+company,false);
        xmlhttp2.send();
     }
     ...
     function getemp_section(department)
     {
        ...
        xmlhttp2.open("GET","<?php echo base_url();?>app/employee_training_seminars/getemp_section/"+department+"/"+company,false);
        xmlhttp2.send();
     }
     ...
     function getemp_subsection(section)
     {
        ...
        xmlhttp2.open("GET","<?php echo base_url();?>app/employee_training_seminars/getemp_subsection/"+section+"/"+department+"/"+company,false);
        xmlhttp2.send();
     }
     ...
     function get_filtered_employees()
     {
        ...
        xmlhttp2.open("GET","<?php echo base_url();?>app/employee_training_seminars/get_filtered_employees/"+company+"/"+location+"/"+classification+"/"+department+"/"+section+"/"+subsection,false);
        xmlhttp2.send();
     }
  ...
  function mass_add_emp()
  {
    ...
    else
    {
      ...
      $('#smt_btn').show();
        ...
        xmlhttp2.open("GET","<?php echo base_url();?>app/employee_training_seminars/mass_add_emp/"+selected_,false);
        xmlhttp2.send();
