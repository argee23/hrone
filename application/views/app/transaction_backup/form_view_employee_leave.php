...
<div  id="printableArea"> <!-- this is important -->
 ...
 $cur_form= $this->uri->segment('6');
  ...
  <tr>
    <th colspan="4" style="text-align: center">APPLICATION FOR LEAVE OR ABSENCE FORM 
  ...
  <tr>
      <td ><p class="text-primary">TYPE OF LEAVE</p></td>  <td><?php echo $file_doc->leave_type;?></td>   
   <td><p class="text-primary">ADDRESS WHILE ON LEAVE:</p></td>
    <td><?php echo $file_doc->address;?></td> 
  </tr>
  <tr >
    <td><p class="text-primary">NO OF DAYS:</p></td>  <td><?php echo $file_doc->no_of_days;?></td>  
    <td ><p class="text-primary">EFFECTIVE DATE:</p></td><td >
    <?php 
...
$get_all_app=$this->transaction_employees_model->get_all_app_leave($file_doc->doc_no,$table_name,$dept,$sect,$clas,$loc,$sub,$file_doc->leave_type_id);
