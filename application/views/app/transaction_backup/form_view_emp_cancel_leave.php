...
<div  id="printableArea"> <!-- this is important -->
 ...
 $loc=$file_doc->location;
  ...
  <tr>
    ...
    <td>
    <p class="text-primary">DOCUMENT NO:</p></td>  <td><?php echo $file_doc->cancelled_doc_no;?>
    </td>   
  </tr>
  <tr>
...
$doc= $file_doc->doc;
$get_all_app=$this->transaction_employees_model->get_all_app($doc,$table_name,$dept,$sect,$clas,$loc,$sub);
