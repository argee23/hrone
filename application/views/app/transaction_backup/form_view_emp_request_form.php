...
<div  id="printableArea"> <!-- this is important -->
  ...
  <tr>
    <th colspan="4" style="text-align: center">EMPLOYEE REQUEST FORM
 ...
 <tr>
  ...
  <tr>
    ...
    <td valign="top" ><p class="text-primary">REQUEST(s): </p></td>
    <td>
      <ul style="list-style-type: square;">
        <?php 
            ...
            <li><input type="checkbox" <?php  foreach ($request as $r) { if($r==$rr->id){ echo "checked"; } else{} } ?>><?php echo $rr->title?></li><?php } if(empty($file_doc->request_other || $file_doc->request_other=='N/A' || $file_doc->request_other=='none')){}else{?>
             <li><input type="checkbox" checked> [Other/s][<?php echo $file_doc->request_other;?>]
            <?php } ?>

      </ul>
    </td>
    <td valign="top"><p class="text-primary">PERIOD OF EMPLOYMENT<br>(DATE FROM): </p><br>
    <p class="text-primary">SPECIFIC REASON /<br> PURPOSE of REQUEST: </p></td>
    <td valign="top" ><?php
