...
<div class="content-wrapper2">
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li class="active">Cancel <?php echo urldecode($this->uri->segment('5'));?> Transactions</li>
    </ol>
  </section>
    ...
    <div class="col-md-12">
      ...
      <div class="box box-info">
        ...
        <div class="box-header">
          <strong><a class="text-danger"><i class="fa fa-exclamation"></i> Cancel</a>&nbsp;<u> <?php echo urldecode($this->uri->segment('5'));?> Transactions</u></strong>     
          <form name="f" method="post" action="<?php echo base_url()?>app/transaction_employees/cancel_all_transactions/<?php echo $this->uri->segment('4');?>/<?php echo $this->uri->segment('5');?>" >                
...
<button type="button" id="to_view" class="btn btn-success pull-right btn-xs " onclick ="show_view()"><i class="fa fa-folder-open"></i> view mode?</button>
                   ...
                   <button type="submit" class="btn btn-danger btn-xs pull-right" onclick="return confirm('Are you sure you want to cancel all <?php echo urldecode($this->uri->segment('5'));?> ?')" data-toggle="tooltip" data-placement="left" title="" data-original-title="Click to cancel all <?php echo urldecode($this->uri->segment('5'));?> "><i class="fa fa-floppy-o"></i> Cancel All?</button>
	</form>
        </div>
        <div class="box-body">
...
<form name="f1" method="post" action="<?php echo base_url()?>app/transaction_employees/save_cancel_transactions/<?php echo $this->uri->segment('4');?>/<?php echo $this->uri->segment('5');?>" >        
            <table id="" class="table table-bordered table-striped">
              <thead>
                <tr>
                  ...
                  <td width="5%">Status</td>
                  <td width="20%"> 
 <button type="submit" class="btn btn-warning btn-xs pull-right" onclick="return confirm('Are you sure you want to cancel selected <?php echo urldecode($this->uri->segment('5'));?> ?')" data-toggle="tooltip" data-placement="left" title="" data-original-title="Click to cancel selected <?php echo urldecode($this->uri->segment('5'));?> "><i class="fa fa-floppy-o text-success"></i> Cancel / Update?</button>
                   </td>
                </tr>
              </thead>
