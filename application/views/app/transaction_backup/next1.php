...
<div class="panel panel-success">
  <div class="panel-heading"><strong>New Transaction Form</strong><small>  </small></div>
  ...
  <!-- <div><?php echo form_input(array('id'=>'label','name'=>'label'));?></div>
   <?php echo form_close(); ?> -->
    <div class="box-body">
        ...
        <div class="col-sm-10">
          <input type="text" class="form-control" name="fname" id="fname" placeholder="Form Title" value="" required>
        </div>
      </div>
...
<!--   JULY 9 edit
       ...
       <div class="form-group">
        ...
        <div class="col-sm-10">
          <TEXTAREA type="text" class="form-control" name="fdesc" id="fdesc" placeholder="Form Description" value="" required> </TEXTAREA>
        </div>
      </div>
  ...
  echo '  
      ...
      <div class="form-group">
        ...
        <div class="col-sm-10">
          ...
          <select class="form-control" name="type[]" id="type" data-toggle="collapse"  required>
      ...
      <div class="form-group">
        ...
        <div class="col-sm-10">
            <input type="number" class="form-control" name="max_length[]" id="max_length" placeholder="Max length or No. of fields(for selectbox)" value=""  min="1" required>
        </div>
      </div>
