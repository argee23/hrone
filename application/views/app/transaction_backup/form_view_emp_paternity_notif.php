...
<div  id="printableArea"> <!-- this is important -->
  ...
  <tr>
    <th colspan="4" style="text-align: center">MEMBERS PATERNITY NOTIFICATION FORM
 ...
 <tr>
  ...
  <tr>
    <td><p class="text-primary">SSS NUMBER:</p></td>
    <td>members sss number</td>
    <td><p class="text-primary">ADDRESS:</p></td>
    ...
    <tr>
    <td><p class="text-primary">SPOUSE NAME(LEGITIMATE):</p></td>
    ...
    <tr>
    <td><p class="text-primary">ADDRESS:</p></td>
    <td colspan="3"><?php echo $file_doc->spouse_name?></td>
  </tr>
    <tr>
    <td><p class="text-primary">EMPLOYER NAME(if employed):</p></td>
    <td><?php echo $file_doc->spouse_name?></td>
    <td><p class="text-primary">EMPLOYER ADDRESS:</p></td>
    <td><?php echo $file_doc->sss_number_spouse?></td>
  </tr>
  <tr>
    <td colspan="4" style="text-align: center;"><hr><p class="text-primary">-- EMPLOYEE CERTIFICATION --</p>This is to notify my employer that my wife which name appears above is pregnant and expected to give birth on or before : <?php 
