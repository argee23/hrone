          ...
          <div class="box box-primary">
                ...
                <!-- <div class="col-sm-10"> -->
                  <select class="form-control" name="company" id="company" onclick="view_company_udf(this.value)" required>
                    <option selected="selected" value="0">~ All company udf forms ~</option>
                      <?php 
...
////////////////////////////////////////////////////////////////////////////////
 ...
 {          
        ...
        xmlhttp.open("GET","<?php echo base_url();?>app/transaction_user_define_fields/add_new_emp_udf1/"+val,true);
        xmlhttp.send();
    ...
    {          
            ...
            xmlhttp.open("GET","<?php echo base_url();?>app/transaction_user_define_fields/edit_emp_udf1/"+val,true);
            xmlhttp.send();
    }
