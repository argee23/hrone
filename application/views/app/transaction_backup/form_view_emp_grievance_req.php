...
<div  id="printableArea"> <!-- this is important -->
  ...
  <tr>
    <th colspan="4" style="text-align: center">REQUEST FOR GRIEVANCE FORM
 ...
 <tr>
  ...
  <tr>
    <td><p class="text-primary">SECTION MANAGER</p></td>
    <td><?php echo $file_doc->section_manager_name;?></td>
    <td><p class="text-primary">LENGTH OF SERVICE</p></td>
    <td><?php echo $file_doc->service_length;?></td>
  </tr>
  <tr>
    <td colspan="2" style="text-align: center"><p class="text-primary" style="text-align: left">Nature of offense/case violation and sanction : </p>
<?php echo $file_doc->offense_nature;?></td>
    <td colspan="2" style="text-align: center"><p class="text-primary" style="text-align: left">Type and Reason for Grievance : </p>
 <?php echo $file_doc->reason;?>
    </td>
  </tr>
  <tr>
    <td  style="text-align: center"><p class="text-primary" style="text-align: left">Adjustment Desired : </p></td>
    <td colspan="3"><?php echo $file_doc->desired_adjustment;?></td>
  </tr>
  <tr>
  ...
  transform-origin: left top 50;"><p class="rubber_stamp t" <?php echo $style; ?> ><?php echo $file_doc->status; ?></p></label><br></td></tr>
