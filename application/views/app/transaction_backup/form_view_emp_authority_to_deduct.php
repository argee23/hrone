...
<div  id="printableArea"> <!-- this is important -->
  ...
  <tr>
    <th colspan="4" style="text-align: center">AUTHORITY TO DEDUCT FORM
  ...
  <tr style="text-align: center">
    <td colspan="4">That I Abanto, <b><u><?php echo $file_doc->first_name." ".$file_doc->middle_name." ".$file_doc->last_name;?></u></b> , hereby acknowledge the amount <b><u> Php <?php echo $file_doc->amount_of_advance;?>.00 </u></b> representing my advances for <?php echo $file_doc->advance_type;?>. <br><br> </td>
  </tr>
  <tr>
 ...
 <tr>
  ...
  <tr>
    <td><p class="text-primary">Deduction will start on</p></td>
    <td><?php 
    ...
    ?> (payday)</td>
    <td><p class="text-primary">Amounting</p></td>
    <td><?php echo $file_doc->deduction_amount;?> 
    <?php 
  ...
  <tr>
    <td><p class="text-primary">With</p></td>
    <td>Php <?php echo $file_doc->monthly_amortization;?>.00 Monthly Amortization</td>
