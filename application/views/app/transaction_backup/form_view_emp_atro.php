...
<!--   <tr>
  ...
  <td ><?php echo $file_doc->working_sched?> </td>
   ...
   <td><p class="text-primary">Number of Hours:</p></td>
  ...
  <?php
$note=$file_doc->holiday.$file_doc->holiday_type.$file_doc->IsRestday.$file_doc->IsSunday;
if($note!=="NONENONE00"){   
  ?>
  <tr>
    ...
    <td colspan="3">
        <?php
           if($file_doc->holiday=="NONE"){
            echo "";
           }else{
            echo "<i class='fa fa-check-circle'></i> Holiday: ".$file_doc->holiday;
           } 
           if($file_doc->holiday_type=="NONE"){
            echo "";
           }else{
            //ht : holiday type
            $ht=$file_doc->holiday_type;
            $ht=$this->transaction_employees_model->get_holiday_type($ht);
            if(!empty($ht)){
            echo " <i class='fa fa-arrow-right text-danger'></i> ".$ht->cValue; }
...
?>
  <tr>
    <td colspan="2">
      <p class="text-primary">Remarks:</p>
      <p style="text-indent: 100px;"><?php echo $file_doc->remarks;?></p>
    </td>
    <td colspan="2">
      <p class="text-primary">Entry Type:</p>
      <p style="text-indent: 100px;"><?php echo $file_doc->entry_type;?></p>
    </td>
  </tr>
  <tr>
    <td colspan="4"><hr></td>
