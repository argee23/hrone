...
<div  id="printableArea"> <!-- this is important -->
  ...
  <tr>
    <th colspan="4" style="text-align: center">TRIP TICKET FORM
  ...
  <tr>
    <td><p class="text-primary">Car Model:</p></td>
    <td><?php echo $this->transaction_employees_model->get_model($file_doc->plate_no);?></td>
    <td><p class="text-primary">Plate No:</p></td>
    <td><?php echo $file_doc->plate_no?></td>
  </tr>
  <tr>
    <td><p class="text-primary">Trip Time Out:</p></td>
    <td><?php echo $file_doc->trip_time_out?></td>
    <td><p class="text-primary">Trip Date:</p></td>
    <td><?php echo $file_doc->trip_date?></td>
  </tr>
  <tr>
    <td><p class="text-primary">To be return on date:</p></td>
    <td><?php echo $file_doc->to_be_return_on_date?></td>
    <td><p class="text-primary">To be return on time:</p></td>
    <td><?php echo $file_doc->to_be_return_on_time?></td>
  </tr>
  <tr>
    <td><p class="text-primary">Actual Time Out:</p></td>
    <td><?php echo $file_doc->actual_time_out?></td>
    <td><p class="text-primary">Actual Time In:</p></td>
    <td><?php echo $file_doc->actual_time_in?></td>
  </tr>
  <tr>
    <td><p class="text-primary">Destination From:</p></td>
    <td><?php echo $file_doc->destination_from?></td>
    <td><p class="text-primary">Destination To:</p></td>
    <td><?php echo $file_doc->destination_to?></td>
  </tr>
  <tr>
    <td><p class="text-primary">Kilometer Out:</p></td>
    <td><?php echo $file_doc->kilometer_out?></td>
    <td><p class="text-primary">Kilometer In:</p></td>
    <td><?php echo $file_doc->kilometer_in?></td>
  </tr>
  <tr>
    <td><p class="text-primary">Fuel Before:</p></td>
    <td><?php echo $file_doc->fuel_before?></td>
    <td><p class="text-primary">Fuel After:</p></td>
 ...
 <tr>
    ...
    <td><p class="text-primary">Other Details:</p></td>
