                          ...
                          <td>
                              ...
                              <?php } } else{
                                if($app->ApplicationStatus==4){ ?>
                                   ...
                                   <a style="cursor:pointer;" data-toggle='modal' data-target='#modall' href="<?php echo base_url('app/recruitments/update_application_status_blocked')."/".$app->job_id."/".$company_id."/".$employer_type."/".$app->idd."/"."4"."/".$filtered_status."/".$app->comp_id."/".$app->applicant_id;?>" >View Blocked Details</a>
