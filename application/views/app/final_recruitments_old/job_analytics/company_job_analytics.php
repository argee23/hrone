        ...
        <div class="well">
              <div class="MassUploading" style="height: 100px;">
                          ...
                          <div class="col-md-12" style="margin-top: 20px;">
                              <button class="btn btn-success pull-right btn-sm" onclick="job_filtering_analytics('<?php echo $employer_type;?>','<?php echo $company_id;?>');"><i class="fa fa-arrow-right"></i>Filter</button>
              </div>
        </div>
    </div>
</div>
