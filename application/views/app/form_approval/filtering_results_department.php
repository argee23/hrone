...
<table class="table table-bordered table-striped">
              <thead>
                <tr  class="info">
                   ...
                   <n class='<?php echo $clear_all_from_approver;?> pull-right'><i class='btn btn glyphicon glyphicon-remove'  onclick="delete_applocclassdivdept_all('<?php echo $company?>','<?php echo $d->department_id?>','<?php echo $identification?>','department','<?php echo $location?>','<?php echo $classification?>','<?php echo $division?>','<?php echo $department?>')"></i>[Delete Approvers in this department]</n></th>
                 </tr>
              </thead>  
              <tbody>
              <?php $section = $this->form_approval_model->filtering($d->department_id,'department_id','section');
                ...
                <td colspan="7" style="width:20%;" class='text-info'><i><b> <n class='text-danger'>Section:</n> <?php echo $s->section_name?></b></i>
                 <a class='<?php echo $clear_all_from_approver;?> pull-right' style='cursor: pointer;' onclick="delete_applocclassdivdept_all('<?php echo $company?>','<?php echo $s->section_id?>','<?php echo $identification?>','section','<?php echo $location?>','<?php echo $classification?>','<?php echo $division?>','<?php echo $department?>')">[Delete Approvers in this section]</a></td>
                </tr>
                ...
                <tr>
                  ...
                  <td><i  class='<?php echo $clear_all_from_approver;?> btn btn fa fa-<?php echo $system_defined_icons->icon_delete;?>' style='cursor: pointer;color:<?php echo $system_defined_icons->icon_delete_color;?>' onclick="delete_applocclassdivdept_all('<?php echo $company?>','<?php echo $a->id?>','<?php echo $identification?>','id','<?php echo $location?>','<?php echo $classification?>','<?php echo $division?>','<?php echo $department?>')"></i></td>
                </tr>
              <?php } } } } }?>
