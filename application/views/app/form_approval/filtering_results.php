...
<table class="table table-bordered">
              <thead>
                <tr  class="info">
                   <th colspan="7"><n class="text-danger" style="font-weight:bold;">Department: </n><n><b><?php echo  $d->dept_name?></b></n><n class='pull-right'><i class='<?php echo $clear_all_from_approver;?> btn btn glyphicon glyphicon-remove' onclick="delete_app_all('<?php echo $company?>','<?php echo $d->department_id?>','<?php echo $identification?>','department')"></i>[Delete Approvers in this department]</n></th>
                 </tr>
              </thead>  
              <tbody>
              <?php $section = $this->form_approval_model->filtering($d->department_id,'department_id','section');
                ...
                <?php 
                  ...
                  $subsection = '0';
                $approver_data = $this->form_approval_model->approver_data_filter($identification,$d->company_id,$division,$department,$section,$subsection); 
                ...
                <tr>
                  ...
                  <td><i  class='<?php echo $clear_all_from_approver;?> btn btn fa fa-<?php echo $system_defined_icons->icon_delete;?>' style='cursor: pointer;color:<?php echo $system_defined_icons->icon_delete_color;?>' onclick="delete_app_all('<?php echo $company?>','<?php echo $a->id?>','<?php echo $identification?>','id')"></i></td>
                </tr>
              <?php } } } }} ?>
