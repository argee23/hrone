...
<div class="alt2" dir="ltr" style=" margin: 0px; padding: 0px;border: 0px solid #919b9c;width: 100%; height: 390px;text-align: left;overflow: auto">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>   
                <a onclick="select_emp_transfer_approver('<?php echo $showEmployeeList->employee_id ?>','<?php echo $showEmployeeList->name?>')"  title="Select this user" ><font color="#ffffff"><i class="fa fa-external-link fa-lg" aria-hidden="true" data-dismiss="modal"></i></font>
                    </a>
                </td>
            </tr>
            <?php }?>
