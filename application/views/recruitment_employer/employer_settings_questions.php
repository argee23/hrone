           ...
           <div class="col-md-12 collapse" id="q<?php echo $type;?>">
                <div class="col-md-12">
                    <div class="col-md-4" style="text-align: right"><n class="text-danger">Company</n></div>
                        <div class="col-md-6">
                            <select class="form-control" onchange="by_company_questions(this.value,'<?php echo $type;?>','<?php echo $account;?>','hypothetical');">
    ...
    <?php if($company_id=='by_company'){?>
           ...
           <div class="col-md-12 collapse" id="q<?php echo $type;?>">
                <div class="col-md-12">
                    <div class="col-md-4" style="text-align: right"><n class="text-danger">Company</n></div>
                        <div class="col-md-6">
                            <select class="form-control" onchange="by_company_questions(this.value,'<?php echo $type;?>','<?php echo $account;?>','multiple_choice');">
                                <option value="" disabled selected>Select</option>
                                  <?php 
                                     foreach($companyList as $company)
                                        {
