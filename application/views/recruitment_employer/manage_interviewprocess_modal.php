      ...
      <div class="modal-body">
          ...
          <div class="col-md-10">
              ...
              <div class="col-md-12" style="margin-top: 20px;">
                ...
                <div class="col-md-7"><button class="col-md-12 btn btn-success" onclick="save_interview_process('<?php echo $company_id;?>','<?php echo $type;?>','<?php echo $account;?>');">SAVE</button></div>
              </div>
        ...
        <div class="col-md-12" style="margin-top: 20px;" id="action_interview_process">
          ...
          <div class="modal-footer" >
            ...
            <div class="col-md-12 pull-right" id="num_btn" style="display: none;">
              <button type="button" class="btn btn-success btn-sm" style="margin-top: 20px;margin-left: 10px;"  aria-hidden='true' data-toggle='tooltip' title='Click to save changes' onclick='saveupdate_numbering_inproc("<?php echo $company_id;?>","<?php echo $account;?>");'>Save Changes</button>
...
<script>
  ...
  function save_interview_process(company,type,account)
  { 
      ...
      xmlhttp.open("GET","<?php echo base_url();?>recruitment_employer/recruitment_employer_management/save_interview_process/"+ftitle+"/"+fdescription+"/"+fcolor+"/"+company+"/"+type+"/"+account,true);
      xmlhttp.send();
  ...
  function interview_process_action(company_id,id,action,account)
  {
    var result = confirm("Are you sure you want to "+action + " interview process id - "+id);
      ...
      xmlhttp.open("GET","<?php echo base_url();?>recruitment_employer/recruitment_employer_management/interview_process_action/"+company_id+"/"+id+"/"+action+"/"+account,true);
      xmlhttp.send();
    }
  }
  ...
  function interview_process_updatesave(company,id,account)
  { 
      ...
      xmlhttp.open("GET","<?php echo base_url();?>recruitment_employer/recruitment_employer_management/interview_process_updatesave/"+company+"/"+id+"/"+ft+"/"+fd+"/"+fc+"/"+account,true);
      xmlhttp.send();
  ...
  function saveupdate_numbering_inproc(company_id,account)
  {
    ...
    var result = confirm("Are you sure you want to update the interview process numbering of company id " + company_id + "?.");
       if(result == true)
       {
          ...
          {
            save_update_interview_process(count,company_id,value_numbering,value_id,account);
          }
       }
  }
  ...
  function save_update_interview_process(count,company_id,value_numbering,value_id,account)
  {
     if (window.XMLHttpRequest)
      ...
      xmlhttp.open("GET","<?php echo base_url();?>recruitment_employer/recruitment_employer_management/save_update_interview_process/"+count+"/"+company_id+"/"+value_numbering+"/"+value_id+"/"+account,true);
      xmlhttp.send();
  }
