           ...
           <table class="table table-hover" id='grp'>
              ...
              <?php  $i=0; foreach($employee_list as $emp){ 
                ...
                <tr <?php if($note=='no group yet'){ } else if($data[7] == $sec){} else{ echo "class='success'"; }?>>
                  <td><?php  if($note=='no group yet' AND $data[7]!=$sec){?> <input type='hidden' id='e_<?php echo $i;?>' value='0'><input type="checkbox" value="<?php echo $emp->employee_id?>" id="emp_<?php echo $i;?>" onclick="add_emp_selected('<?php echo $i;?>');"> <?php } elseif($data[7]==$sec){?>
                  <input type='hidden' id='e_<?php echo $i;?>' value='1'><input type="checkbox" value="<?php echo $emp->employee_id?>" id="emp_<?php echo $i;?>" onclick="add_emp_selected('<?php echo $i;?>');" checked> 
                  <?php } else{}?></td>
