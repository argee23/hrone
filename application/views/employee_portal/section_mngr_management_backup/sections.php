			                  ...
			                  <thead>
                  			  ...
                  			  <tbody>
                      			  ...
                      			  <tr>
		                          	...
		                          	<td><a href="<?php echo base_url().'employee_portal/section_mngr_management/view_schedule/' . $per->employee_id; ?>" target="_blank" class="btn btn-xs btn-warning"><span class="fa fa-calendar"></span> View Working Schedule</a></td>
                      			  </tr>
                      			<?php } ?>
                  			  </tbody>
              				</table>
