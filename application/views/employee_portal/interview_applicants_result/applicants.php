    ...
    <div class="tab-pane active" id="p_info">
      <div class="panel panel-success">
        <div class="panel-heading"><h4 class="text-danger">Interview Result
          <button class="btn btn-success btn-xs pull-right" onclick="filtering();">FILTER</button>
        </h4></div>

        <div class="col-md-12" id="filtering" style="display: none;">
            ...
            <div class="col-md-6">
              ...
              <div class="col-md-12"  style="margin-top: 20px;">
                <div class="col-md-12">
                    <label>Date Range <i>(based on interview date)</i></label><br>
                    &nbsp;&nbsp;<input type="checkbox" name="daterange" id="daterange" onclick="daterange();"> All Interview Date
                    <input type="hidden" value="0" id="daterange_value"> 
                </div>
              </div>
              <div class="col-md-12">
                <div class="col-md-6">
              ...
              <div class="col-md-12" style="margin-top: 10px;">
                  <div class="col-md-12"><button class="col-md-12 btn btn-success btn-sm" onclick="filter_result('<?php echo $id;?>');">FILTER</button></div>
              </div>
        ...
        <div class="panel-body" style="height:auto;" id="filtering_results">
          ...
          <?php foreach($applicants as $gt){?>
            <tr>  
              ...
              <div id="orig_action<?php echo $gt->id_;?>">
                <?php if($gt->interview_result=='pending'){?>
