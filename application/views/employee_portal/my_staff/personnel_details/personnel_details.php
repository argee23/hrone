            ...
            <div class="col-md-12" >
              <div class="panel panel-default">
                  <div class="panel-heading">
                      <h3><center><b>Employee 201 Information</b></center></h4><br>
                  </div>
                      ...
                      <div class="box box-solid" id='printableArea'>
                        ...
                        <table class="table table-bordered" id="des">
                          ...
                          <!--Personal Information-->
                            <tr class='info'>
                              <td colspan="6"><i class="glyphicon glyphicon-user"></i><b>Personal Information</b></td>
                              <td><n style='text-align: right;'><b><i>Employee id: <?php echo $employee_id;?></i></b></n></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                              ...
                              <center><i>Employee Picture</i>
                                 <img class="img img-thumbnail bg-gray" style="width: 150px;" src="<?php echo $this->my_staff_201_details_model->get_general_url(); ?>employee_picture/<?php echo $info->picture; ?>">
                                </center> 
                              </td>
                            </tr>
                            <tr>
                              ...
                              <td>  <n class='text-danger'><?php if (empty($info->birthday)) {} else { echo $this->my_staff_201_details_model->calculate_interval($info->birthday);?> <?php }?></n></td>
                          ...
                          <!--Start of address details-->
                            ...
                            <tr>
                              ...
                              <td rowspan='7' colspan="7"> <center><?php if(empty($residence)){ echo "<n><br><br><br><b>No Uploaded File</b></n>"; } else{?><img class="img img-thumbnail bg-gray" style="width: 250px;height:150px; " src="<?php echo base_url(); ?>public/employee_files/residence/<?php echo $residence;?>"><?php } ?></center></td>
                            </tr>
                            <tr>
                        ...
                        <table class="table table-bordered" id="des">
                          ...
                          <?php if(empty($family)){ echo "<tr><td colspan='7'><n class='text-info'> NO DATA FOUND.</n></td></tr>";} else{ foreach ($family as $fam) { ?>
                            ...
                            <tr>
                              ...
                              <td><n class='text-success'>Age </n></td>
                              <td><n class='text-danger'><?php if (empty($fam->birthday)) {} else { echo $this->my_staff_201_details_model->calculate_interval($fam->birthday);?> <?php }?></n> </td>
                            </tr>
                            <tr>
                          ...
                          <?php if(empty($employee_udf)){ echo "<tr><td colspan='7'><n class='text-info'> NO DATA FOUND.</n></td></tr>";} else{ 
                            ...
                            <tr>
                              ...
                              <td colspan="5"><n class='text-danger'>                         
                                    <?php 
                                        $data = $this->my_staff_201_details_model->get_udf_data($udf->emp_udf_col_id,$this->uri->segment("4"));
