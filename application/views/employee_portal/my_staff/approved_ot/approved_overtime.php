...
<div id="app">
  <div class="col-lg-12">
      <h2 class="page-header">Personnel Allowed & Approved OverTime Management<br><i style="font-size: 17px;">(all encoded OT here is already approved)</i></h2>
        ...
        <div class="col-md-3">
          <div class="panel panel-default">
            <div class="panel-heading"><n class='text-success'> <b><center>Manage/Check Encoded Allowed & Approved OT of Employees</center></b></n> </div>
            <div class="panel-body" id="filtering_">
                  <div class="form-group">
                    ...
                    <div class="col-sm-12" style="margin-top: 5px;">
                      <button class="col-md-12 btn btn-default" onclick="get_filtered_approved_ot();"><b>GENERATE <i class="fa fa-arrow-right"></i></b></button>
                    </div>
              ...
              <div class="panel-heading"><n class='text-success'> <b><center>Manage/Check Encoded Allowed & Approved OT of specific employee</center></b></n> </div>
            <div class="panel-body" id="filtering_">
                  <div class="form-group">
                    ...
                    <div class="col-sm-12" style="margin-top: 5px;">
                      <button class="col-md-12 btn btn-default" onclick="employee_approved_ot();"><b>GENERATE<i class="fa fa-arrow-right"></i></b></button>
                    </div>
                                ...
                                <td>
                                      ...
                                      <center>
                                          ...
                                          <a style='cursor:pointer;color:<?php echo $system_defined_icons->icon_delete_color;?>' onclick='delete_approved_ot("<?php echo $p->id;?>","<?php echo $p->date;?>")' aria-hidden='true' data-toggle='tooltip' title='Click to Delete Plotted OT Hour/s'  ><i  class="fa fa-<?php  echo $system_defined_icons->icon_delete;?> fa-lg  pull-left"></i></a>
                                           ...
                                           <a style='cursor:pointer;color:<?php echo $system_defined_icons->icon_add_color;?>' target="_blank" aria-hidden='true' data-toggle='tooltip' title='Click to Add Employee with approved ot hours'    href="<?php echo base_url().'employee_portal/my_staff_approved_ot/add_member_approved_ot';?>/<?php echo $p->id;?>/<?php echo $p->date;?>"  style='display: none;'><i  class="fa fa-<?php  echo $system_defined_icons->icon_add;?> fa-lg  pull-left"></i></a>
...
<script type="text/javascript">
    ...
    function get_employees_for_general(val)
     {
          ...
          xmlhttp2.open("GET","<?php echo base_url();?>employee_portal/my_staff_approved_ot/get_employees/"+date,false);
          xmlhttp2.send();
    ...
    function save_pre_approved()
    {
              ...
              { 
                ...
                { 
                    ...
                    if (window.XMLHttpRequest)
                    {
                      ...
                      xmlhttp2.open("GET","<?php echo base_url();?>employee_portal/my_staff_approved_ot/save_approved_ot/"+employee_result+"/"+hours+"/"+reas+"/"+count+"/"+date,false);
                      xmlhttp2.send();
                    }
      ...
      function add_member_approved_ot(id,date)
      {
          ...
          xmlhttp2.open("GET","<?php echo base_url();?>employee_portal/my_staff_approved_ot/add_member_approved_ot/"+date+"/"+id,false);
          xmlhttp2.send();
      ...
      function add_member_save_pre_approved(id,date)
      {
           ...
           else
           {
                if(error=="")
                {
                  ...
                  xmlhttp2.open("GET","<?php echo base_url();?>employee_portal/my_staff_approved_ot/add_member_save_pre_approved/"+id+"/"+date+"/"+selected_hrs+"/"+selected_employee+"/"+count+"/"+reas,false);
                  xmlhttp2.send();  
                }
                else
                {
      ...
      function delete_approved_ot_member(id,idd,date)
      {
        ...
        if(result == true)
        {
            ...
            xmlhttp2.open("GET","<?php echo base_url();?>employee_portal/my_staff_approved_ot/delete_approved_ot_member/"+id+"/"+idd+"/"+date,false);
            xmlhttp2.send();  
          }
      }
      ...
      function get_filtered_approved_ot()
      {
        ...
        else
        {
          ...
          if (window.XMLHttpRequest)
            ...
            xmlhttp.open("GET","<?php echo base_url();?>employee_portal/my_staff_approved_ot/get_filtered_approved_ot/"+from+"/"+to,true);
            xmlhttp.send();
        }
      }
      ...
      function employee_approved_ot()
      {
        ...
        else 
        {
            ...
            xmlhttp.open("GET","<?php echo base_url();?>employee_portal/my_staff_approved_ot/employee_approved_ot/"+employee_id+"/"+date,true);
            xmlhttp.send();
       ...
       function add_new_group()
      {
        $('#downloaded_template_file').hide();
          ...
          xmlhttp.open("GET","<?php echo base_url();?>employee_portal/my_staff_approved_ot/add_new_group/",true);
          xmlhttp.send();
      }
      ...
      function edit_group_approved_ot(id,date)
      {
        $('#downloaded_template_file').hide();
         if (window.XMLHttpRequest)
          ...
          xmlhttp.open("GET","<?php echo base_url();?>employee_portal/my_staff_approved_ot/edit_group_approved_ot/"+id+"/"+date,true);
          xmlhttp.send();
      }
       ...
       function view_approved_ot(id,date)
    {
        ...
        if (window.XMLHttpRequest)
          ...
          xmlhttp.open("GET","<?php echo base_url();?>employee_portal/my_staff_approved_ot/view_approved_ot/"+id+"/"+date,true);
          xmlhttp.send();
    ...
    function delete_approved_ot(id,date)
    {
      ...
      if(result == true)
      {
          ...
          xmlhttp2.open("GET","<?php echo base_url();?>employee_portal/my_staff_approved_ot/delete_approved_ot/"+id+"/"+date,false);
          xmlhttp2.send();        
      }
    }
     ...
     function upload_member_approved_ot(id,date,group_name)
      {
          ...
          xmlhttp.open("GET","<?php echo base_url();?>employee_portal/my_staff_approved_ot/upload_approved_ot_group/"+id+"/"+date,true);
          xmlhttp.send();
      }
