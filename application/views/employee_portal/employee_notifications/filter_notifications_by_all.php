         <table class="table table-responsive table-sm" id="notif">
                  ...
                  <tbody> 
                    <?php 
                      ...
                      $i=1; foreach($notifications as $f){
                      if($f->count==0){}
                      else{
                        $form_info  = $this->employee_notifications_model->get_notif_notyet_acknowledge_filter($f->t_table_name,$this->session->userdata('employee_id'),$status,$from,$to,'result');
                      ...
                      ?>
                       <td>
                        ...
                        <td>
                           <?php if(empty($d->time_acknowledge))
                                { ?>
