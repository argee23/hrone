...
<div>
    <!-- Start of Side View -->
    <div class="col-md-3">
      <div class="panel box box-default" style="height:517px;">
        <div class="panel-heading"><h4>Personnel Forms Report<span class="pull-right"><i class="fa fa-gear"></i></span></h4></div>
        <div class="panel-body  fixed-panel-side mCustomScrollbar" data-mcs-theme="dark"">
          <ul class="nav nav-pills nav-stacked">
              <li><a style="cursor:pointer;" onclick="view_crystal_report('forms_report','default');"><i class='fa fa-circle-o'></i> <span>Default Crystal Reports</span></a></li>
              <li><a style="cursor:pointer;" onclick="view_crystal_report('forms_report','sys');"><i class='fa fa-circle-o'></i> <span>Manage Crystal Reports</span></a></li>
              <li><a style="cursor:pointer;" onclick="view_fr_generate_reports('forms_report');"><i class='fa fa-circle-o'></i> <span>Generate Reports</span></a></li>
