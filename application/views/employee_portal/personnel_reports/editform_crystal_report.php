      ...
      <div class="box box-default"></div>
        <h4><center><n class="text-danger">Check the fields you want to view in printing reports</n></center></h4>
          ...
          <div class="box box-default"></div>
            ...
            <button class="btn btn-success pull-right" style="margin-left: 4px;margin-right: 4px;" onclick="save_crystal_reports('update','<?php echo $type?>','<?php echo $id?>');">SAVE CHANGES</button>
