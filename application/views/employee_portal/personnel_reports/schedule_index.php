...
<div>
    ...
    <div class="col-md-3">
      <div class="panel box box-default" style="height:517;">
        <div class="panel-heading"><h4>Personnel Schedule Reports<span class="pull-right"><i class="fa fa-gear"></i></span></h4></div>
        <div class="panel-body  fixed-panel-side mCustomScrollbar" data-mcs-theme="dark"">
          <ul class="nav nav-pills nav-stacked">
             <!--  <li><a style="cursor:pointer;"  onclick="view_crystal_report('schedule','default');"><i class='fa fa-circle-o'></i> <span>Default Crystal Reports</span></a></li> -->
                <li><a style="cursor:pointer;" onclick="view_crystal_report('schedule');"><i class='fa fa-circle-o'></i> <span>Manage Crystal Reports</span></a></li>
              <li><a style="cursor:pointer;" onclick="view_schedule_generate_reports('schedule');"><i class='fa fa-circle-o'></i> <span>Generate Reports</span></a></li>
