...
<div class="col-md-12">
    ...
    <button class="btn btn-success pull-right" style="margin-left: 4px;margin-right: 4px;" onclick="save_crystal_report('<?php echo $company;?>','<?php echo $notification;?>','save_add','save')">SAVE</button>
