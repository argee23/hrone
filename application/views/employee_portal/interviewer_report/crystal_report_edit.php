...
<div class="col-md-12" style="margin-top: 15px;">
  <center><h4 class="text-danger">Check the fields you want to view in printing reports</h4></center>
    ...
    <?php $i=0; foreach($fields_default as $fd){
         $check_exist = $this->applicant_interview_result_report_model->check_if_selected($details->id,$fd->id);
...
<div class="col-md-12" style="margin-top: 40px;">
    <button class="btn btn-info pull-right btn-sm"  onclick="location.reload();">BACK</button>
    <button class="btn btn-success pull-right btn-sm" style="margin-left: 4px;margin-right: 4px;" onclick="update_crystal_report('<?php echo $details->id;?>');">SAVE</button>
    <button class="btn btn-danger pull-right" style="margin-left: 4px;margin-right: 4px;"  onclick="reset1();">UNCHECK/CHECK ALL</button>
</div>