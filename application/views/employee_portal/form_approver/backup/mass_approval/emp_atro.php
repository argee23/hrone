    ...
    <div class="box-body">
      <div class="col-md-8"> <!-- Form Content -->
        <span class="dl-horizontal col-sm-6">
          ...
          <dt>No. of Hours</dt>
          <dd><?php echo $form->info->form->no_of_hours; ?></dd>
          <dt>Conversion Type</dt>
         

          <?php if ($form->info->form->atro_conversion == 'IL') { ?>
            <dd>Convert to Incentive Leave</dd>
          <?php }
          else
          { ?>
            <dd>With Pay</dd>
          ...
          <dt>ATRO Date</dt>
          <dd><?php echo date("F d, Y", strtotime($form->info->form->atro_date)); ?></dd>
      ...
      <input type="hidden" class="form-control" rows="2" name="<?php echo $form->doc_no;?>_company_id" id="company_id<?php echo $i?>" value="<?php echo $form->info->filer->company_id;?>">
      <div class="col-md-3">
