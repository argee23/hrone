    ...
    <div class="box-body">
      <div class="col-md-8"> <!-- Form Content -->
        <span class="dl-horizontal col-sm-6">
          ...
          <dd><?php echo $form->info->form->spouse_name; ?></dd>
          <dt>Spouse's SSS No.</dt>
          <dd><?php echo $form->info->form->sss_number_spouse; ?></dd>
          <dt>Spouse Address</dt>
          <dd><?php echo $form->info->form->spouse_address; ?></dd>
          <dt>Employer's Name</dt>
          <dd><?php echo $form->info->form->employer_name; ?></dd>
          <dt>Employer's Address</dt>
          <dd><?php echo $form->info->form->employer_address; ?></dd>
        ...
        <span class="dl-horizontal col-sm-6">
          ...
          <dt>Labor Date</dt>
          <dd><?php echo date("F d, Y", strtotime($form->info->form->give_birth_date)); ?></dd>
          <dt>Child Level</dt>
          <dd><?php echo strtoupper($form->info->form->child_level); ?></dd>
