    ...
    <div class="box-body">
      <div class="col-md-8"> <!-- Form Content -->
        <span class="dl-horizontal col-sm-6">
          ...
          <dt>Time IN Date</dt>
          <dd><?php
                  $ti_m=substr($form->info->form->time_in_date, 5,2);
                  $ti_d=substr($form->info->form->time_in_date, 8,2);
                  $ti_y=substr($form->info->form->time_in_date, 0,4);
          ...
          <dd>
            <?php
                $to_m=substr($form->info->form->time_out_date, 5,2);
                $to_d=substr($form->info->form->time_out_date, 8,2);
                $to_y=substr($form->info->form->time_out_date, 0,4);
        ...
        <span class="dl-horizontal col-sm-6">
          ...
          <dt>Covered Date</dt>
          <dd><?php echo date("F d, Y", strtotime($form->info->form->covered_date)); ?></dd>
          <dt>Reason</dt>
