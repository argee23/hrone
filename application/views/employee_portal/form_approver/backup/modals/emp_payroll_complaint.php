<!-- Modal -->
<div class="modal fade" id="emp_payroll_complaint" role="dialog">
      ...
      <div class="modal-body">
        ...
        <div class="panel-body">
          <span class="dl-horizontal col-sm-6">
            ...
            <dd>{{form_name}}</dd>
             <dt>Type of Complaint</dt>
            <dd>{{form.complaint}}</dd>
            <dt>Payroll Complaints</dt>
            <dd>{{form.complaint_desc}}</dd>
            <dt>Payroll Period</dt>
            <dd>{{form.complete_from | date: "mediumDate"}} to {{form.complete_to | date: "mediumDate"}}</dd>
            <dt>
                <span ng-if="form.complaint_type==1 || form.complaint_type==14">No. of Day/s</span>
                <span ng-if="form.complaint_type==15">Other/s</span>
                <span ng-if="form.complaint_type!=15 && form.complaint_type!=1 && form.complaint_type!=14">No. of Hour/s</span>
            </dt>
            <dd>{{form.hours_days_others}}</dd>
          </span>
          <span class="dl-horizontal col-sm-6">
            <dt>Date Filed</dt>
