<!-- Modal -->
<div class="modal fade" id="emp_bap_claim" role="dialog">
      ...
      <div class="modal-body">
        ...
        <div class="panel-body">
          <span class="dl-horizontal col-md-6">
            ...
            <dd>{{form.deceased_name}}</dd>
            <dt>Birthday</dt>
            <dd>{{form.deceased_bdate | date: "mediumDate"}}</dd>
            <dt>Religion</dt>
            <dd>{{form.religion_name}}</dd>
            <dt>Relationship</dt>
            <dd>{{form.relationship_name}}</dd>
            <dt>Date of Death</dt>
            <dd>{{form.death_date | date: "mediumDate"}}</dd>
          </span>
          <span class="dl-horizontal col-md-6">
            <dt>Date Filed</dt>
            <dd>{{form.date_created | date: "mediumDate"}}</dd>
            <dt>Burial Date</dt>
            <dd>{{form.burial_date | date: "mediumDate"}}</dd>
            <dt>Interment Burial Place</dt>
            <dd>{{form.funeral_wake_place}}</dd>
            <dt>Funeral/Wake</dt>
            <dd>{{form.interment_burial_place}}</dd>
            <dt>Status</dt>
            <dd>{{form.status}}</dd>
          </span>
        </div>
