<!-- Modal -->
<div class="modal fade" id="emp_grievance_request" role="dialog">
      ...
      <div class="modal-body">
        ...
        <div class="panel-body">
          <span class="dl-horizontal col-sm-6">
            ...
            <dd>{{form.offense_nature}}</dd>
            <dt>Desired Adjustment</dt>
            <dd>{{form.desired_adjustment}}</dd>
            <dt>Hearing Date</dt>
            <dd>{{form.hearing_date | date: "mediumDate"}}</dd>
            <dt>Hearing Time</dt>
            <dd>{{form.hearing_time}}</dd>
          </span>
          <span class="dl-horizontal col-sm-6">
            <dt>Date Filed</dt>
