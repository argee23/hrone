<!-- Modal -->
<div class="modal fade" id="emp_authority_to_deduct" role="dialog">
      ...
      <div class="modal-body">
        ...
        <div class="panel-body">
          <span class="dl-horizontal col-sm-6">
            ...
            <dd>{{form_name}}</dd>
            <dt>Deduction will start on</dt>
            <dd>{{form.deduction_start | date: "mediumDate"}}</dd>
            <dt>With</dt>
             <dd>{{form.deduction_amount | number:2}}</dd>
            <dt>Amounting</dt>
            <dd>{{form.monthly_amortization | number:2}}</dd>
          </span>
          <span class="dl-horizontal col-sm-6">
            <dt>Date Filed</dt>
