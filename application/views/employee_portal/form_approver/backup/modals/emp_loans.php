<!-- Modal -->
<div class="modal fade" id="emp_loans" role="dialog">
      ...
      <div class="modal-body">
        ...
        <div class="panel-body">
          <span class="dl-horizontal col-sm-6">
            ...
            <dd>{{form_name}}</dd>
            <dt>Loan Type</dt>
            <dd>{{form.loan_type_desc}}</dd>
            <dt>Loan Amount</dt>
            <dd>{{form.loan_amount}}</dd>
            <dt>Schedule Deduction</dt>
            <dd>{{form.cutoff}}</dd>
            <dt>Amortization</dt>
            <dd>{{form.amortization}}</dd>
          </span>
          <span class="dl-horizontal col-sm-6">
            <dt>Date Filed</dt>
            <dd>{{form.date_created | date: "mediumDate"}}</dd>
            <dt>Date Granted</dt>
            <dd>{{form.date_granted | date: "mediumDate"}}</dd>
            <dt>Reason</dt>
            <dd>{{form.reason}}</dd>
            <dt>Status</dt>
            <dd>{{form.status}}</dd>
