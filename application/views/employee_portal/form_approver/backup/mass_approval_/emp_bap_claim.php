    ...
    <div class="box-body">
      <div class="col-md-8"> <!-- Form Content -->
        <span class="dl-horizontal col-sm-6">
          ...
          <dt>Name of Deceased</dt>
          <dd><?php echo $form->info->form->deceased_name; ?></dd>
          <dt>Birthday</dt>
          <dd><?php echo date("F d, Y", strtotime($form->info->form->deceased_bdate)); ?></dd>
          <dt>Religion</dt>
          <dd><?php echo $form->info->form->religion_name; ?></dd>
          <dt>Relationship</dt>
          <dd><?php echo $form->info->form->relationship_name; ?></dd>
          <dt>Date of Death</dt>
          <dd><?php echo date("F d, Y", strtotime($form->info->form->death_date)); ?></dd>
        ...
        <span class="dl-horizontal col-sm-6">
          ...
          <dt>Burial Date</dt>
          <dd><?php echo date("F d, Y", strtotime($form->info->form->burial_date)); ?></dd>
          <dt>Interment Burial Place</dt>
          <dd><?php echo $form->info->form->funeral_wake_place; ?></dd>
          <dt>Funeral/Wake</dt>
          <dd><?php echo $form->info->form->interment_burial_place; ?></dd>
