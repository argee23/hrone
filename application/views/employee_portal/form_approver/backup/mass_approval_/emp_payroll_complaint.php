...
<div class="panel panel-default">
  <div class="panel-body">
    ...
    <?php $i=1;  foreach($forms as $form) { 
      $type= $form->info->form->complaint_type;
      ?>
    ...
    <div class="box-body">
      <div class="col-md-8"> <!-- Form Content -->
        <span class="dl-horizontal col-sm-6">
          ...
          <dd><?php echo $form->info->form->complaint; ?></dd>
          <dt>Payroll Complaints</dt>
        <dd><?php echo $form->info->form->complaint_desc; ?></dd>
          <dt>Payroll Period</dt>
          <dd><?php echo date("F d, Y", strtotime($form->info->form->complete_from))." <br>". date("F d, Y", strtotime($form->info->form->complete_to)) ?></dd>
          <dt><?php if($type==1 || $type==14){ echo "No. of Hours/s"; } else if($type==15){ echo "Other/s"; } else{ echo "No. of Day/s"; }?></dt>
          <dd><?php echo $form->info->form->hours_days_others; ?></dd>
