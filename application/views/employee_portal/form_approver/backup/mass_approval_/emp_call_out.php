    ...
    <div class="box-body">
      <div class="col-md-8"> <!-- Form Content -->
        <span class="dl-horizontal col-sm-6">
          ...
          <dt>Call Out Time In</dt>
          <dd><?php echo $form->info->form->call_out_time_in; ?></dd>
          <dt>Call Out Time Out</dt>
         <dd><?php echo $form->info->form->call_out_time_out; ?></dd>
          <dt>Call Out Time In Date</dt>
          <dd><?php echo $form->info->form->call_out_time_in_date; ?></dd>
          <dt>Call Out Time Out Date</dt>
          <dd><?php echo $form->info->form->call_out_time_out_date; ?></dd>
        ...
        <span class="dl-horizontal col-sm-6">
          ...
          <dt>Call Out ate</dt>
            <dd><?php echo date("F d, Y", strtotime($form->info->form->call_out_date)); ?></dd>
          <dt>Reason</dt>
