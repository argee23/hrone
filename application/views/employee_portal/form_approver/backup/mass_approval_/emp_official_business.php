...
<div class="col-md-12">
    ...
    <div class="box-body">
      <div class="col-md-8"> <!-- Form Content -->
        <span class="dl-horizontal col-sm-6">
          ...
          <dt>Company Name</dt>
          <dd><?php echo $form->info->form->company_name; ?></dd>
          <dt>Company Address</dt>
          <dd><?php echo $form->info->form->company_address; ?></dd>
          <dt>Inclusive Date/s</dt>
          <dd><?php echo $form->info->form->from_date . " to " . $form->info->form->to_date; ?></dd>
          <dt>Inclusive Time</dt>
          <dd><?php echo $form->info->form->from_time . " to " . $form->info->form->to_time; ?></dd>
 ...
 <?php $checker = $this->form_approver_model->approval_level_checker($form->doc_no,$this->session->userdata('employee_id'),$form_name->t_table_name);
      ...
      <div class="col-md-3">
        ...
        <h3 class='text-danger'>Waiting for your approval turn.</h3>
         <input  value='rejected' id='rejected".$i."' type='radio' hidden>
          <input value='approved' id='approved".$i."' type='radio' hidden>
           <input value='cancelled' id='cancelled".$i."' type='radio' hidden>
           <textarea hidden class='form-control' rows='1' id='comment".$i."'></textarea>";}?> <!-- end form -->
    </div>
