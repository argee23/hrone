    ...
    <div class="box-body">
      <div class="col-md-8"> <!-- Form Content -->
        <span class="dl-horizontal col-sm-6">
          ...
          <dd><?php echo ucwords($form->info->form->name_of_wife); ?></dd>
          <dt>Wife's Employer</dt>
          <dd><?php echo ucwords($form->info->form->employer_name); ?></dd>
          <dt>Employer Address</dt>
          <dd><?php echo ucwords($form->info->form->employer_address); ?></dd>
          <dt>Taxable Year</dt>
          <dd><?php echo $form->info->form->taxable_year; ?></dd>
          <dt>No. of Dependents</dt>
          <dd><?php echo $form->info->form->no_of_dependents; ?></dd>
