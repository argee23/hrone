  ...
  <div class="panel-body">
    <div class="col-md-12">
      ...
      <div class="col-md-12"  id="collapse2" class="collapse">
        ...
        <div class='col-md-1'>
          <input  name="choices" value="cancelled" type="radio" onabort="" click="mass_approved(this.value);">&nbsp;Cancel
        </div>
        <div class='col-md-1'>
    ...
    <div class="box-body">
      <div class="col-md-8"> <!-- Form Content -->
        <span class="dl-horizontal col-sm-6">
          ...
          <dt>No of Days</dt>
          <dd><?php echo date("F d, Y", strtotime($form->info->form->no_of_days)); ?></dd>
