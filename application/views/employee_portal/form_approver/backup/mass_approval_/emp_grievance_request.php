    ...
    <div class="box-body">
      <div class="col-md-8"> <!-- Form Content -->
        <span class="dl-horizontal col-sm-6">
          ...
          <dt>Nature of Offense</dt>
          <dd><?php echo $form->info->form->offense_nature; ?></dd>
          <dt>Desired Adjustment</dt>
          <dd><?php echo $form->info->form->desired_adjustment; ?></dd>
          <dt>Hearing Date</dt>
          <dd><?php echo date("F d, Y", strtotime($form->info->form->hearing_date)); ?></dd>
          <dt>Hearing Time</dt>
          <dd><?php echo $form->info->form->hearing_time; ?></dd>
