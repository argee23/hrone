    ...
    <div class="box-body">
      <div class="col-md-8"> <!-- Form Content -->
        <span class="dl-horizontal col-sm-6">
          ...
          <dt>Worth</dt>
          <dd><?php echo number_format($form->info->form->grocery_items_worth,2); ?></dd>
          <dt>Net Pay</dt>
          <dd><?php echo number_format($form->info->form->net_pay,2); ?></dd>
          <dt>Cripples/Coop Balance</dt>
          <dd><?php echo number_format($form->info->form->coop_balance,2); ?></dd>
          <dt>Last Payroll Period</dt>
          <dd><?php echo $form->info->form->month_from . "/" . $form->info->form->day_from . "/" . $form->info->form->year_from . " to " . $form->info->form->month_to . "/". $form->info->form->day_to . "/".$form->info->form->year_to; ?>
          </dd>
