  ...
  <div class="panel-body">
    ...
    <div class="box-body">
      ...
      <div class="radio">
          ...
          <input name="<?php echo $form->doc_no;?>_status" value="approved" id='approved<?php echo $ud?>'  type="radio">
              Approve
          </label>
      </div>
      <div class="radio">
        <label for="radio4">
          <input name="<?php echo $form->doc_no;?>_status" value="cancelled" id='cancelled<?php echo $ud?>' type="radio">
              Cancel
        </label>
      </div>
      <div class="radio">
        <label for="radio4">
          <input name="<?php echo $form->doc_no;?>_status" value="rejected" id='rejected<?php echo $ud?>' type="radio">
              Reject
        </label>
      </div>
      </div>
