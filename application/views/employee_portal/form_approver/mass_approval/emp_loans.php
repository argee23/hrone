    ...
    <div class="box-body">
      <div class="col-md-8"> <!-- Form Content -->
        <span class="dl-horizontal col-sm-6">
          ...
          <dt>Loan Type</dt>
          <dd><?php echo $form->info->form->loan_type_desc; ?></dd>
          <dt>Loan Amount</dt>
          <dd><?php echo number_format($form->info->form->loan_amount,2); ?></dd>
          <dt>Schedule Deduction</dt>
          <dd><?php echo $form->info->form->cutoff; ?></dd>
          <dt>Amortization</dt>
          <dd><?php echo number_format($form->info->form->amortization,2); ?></dd>
        ...
        <span class="dl-horizontal col-sm-6">
          ...
          <dt>Date Granted</dt>
          <dd><?php echo date("F d, Y", strtotime($form->info->form->date_granted)); ?></dd>
          <dt>Reason</dt>
