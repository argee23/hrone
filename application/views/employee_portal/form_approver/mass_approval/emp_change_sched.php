    ...
    <div class="box-body">
      <div class="col-md-8"> <!-- Form Content -->
        <span class="dl-horizontal col-sm-6">
         ...
         <dd>
              <?php
                $sched_dates = $this->transaction_employees_model->get_schedule_dates($form->doc_no);
                $ii=1;
                foreach($sched_dates as $l)
                { 
                  $day =  date("D", strtotime($l->the_date));
                  if($ii==count($sched_dates))
                  {
                    echo $l->the_date;
                  }
                  else
           ...
           <dt>New Working Schedule</dt>
          <dd><?php echo $form->info->form->time_to; ?></dd>
