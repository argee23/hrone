    ...
    <div class="box-body">
      <div class="col-md-8"> <!-- Form Content -->
        <span class="dl-horizontal col-sm-6">
          ...
          <dt>Leave Doc No</dt>
          <dd>
                <center><span class="text-info"><strong><a href="<?php echo base_url();?>/employee_portal/form_approver/view/<?php echo $form->info->form->doc_no; ?>/employee_leave/<?php echo $form_name->identification; ?>" target="_blank"><?php echo $form->info->form->doc_no;?></a></strong></span></center>
          </dd>
          <dt>No of Days</dt>
          <dd><?php if($form->info->form->no_of_days=='0.5'){ echo "Halfday"; } else{ echo $form->info->form->days; if($form->info->form->days > 1) { echo " days"; } else{ echo " day";} } ?></dd>
