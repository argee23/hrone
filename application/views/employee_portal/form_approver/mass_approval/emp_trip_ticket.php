    ...
    <div class="box-body">
      <div class="col-md-8"> <!-- Form Content -->
        <span class="dl-horizontal col-sm-6">
          ...
          <dt>Car Model</dt>
          <dd><?php echo $form->info->form->car;?></dd>
          <dt>Car Plate No.</dt>
          <dd><?php echo $form->info->form->plate_no;?></dd>
          <dt>Trip Time Out</dt>
          <dd><?php echo $form->info->form->trip_time_out;?></dd>
          <dt>Trip Date</dt>
          <dd><?php echo date("F d, Y", strtotime($form->info->form->trip_date));?></dd>
          <dt>To be returned on date</dt>
          <dd><?php echo date("F d, Y", strtotime($form->info->form->to_be_return_on_date));?></dd>
          <dt>To be returned on time</dt>
          <dd><?php echo $form->info->form->to_be_return_on_time;?></dd>
          <dt>Kilometer Out</dt>
          <dd><?php echo $form->info->form->kilometer_out;?></dd>
          <dt>Kilometer In</dt>
          <dd><?php echo $form->info->form->kilometer_in;?></dd>
        ...
        <span class="dl-horizontal col-sm-6">
          ...
          <dt>Reason</dt>
          <dd><?php echo $form->info->form->purpose; ?></dd>
           <dt>Destination From</dt>
          <dd><?php echo $form->info->form->destination_from;?></dd>
          <dt>Destination To</dt>
          <dd><?php echo $form->info->form->destination_to;?></dd>
          <dt>Fuel Before</dt>
          <dd><?php echo $form->info->form->fuel_before;?></dd>
          <dt>Fuel After</dt>
          <dd><?php echo $form->info->form->fuel_after;?></dd>
          <dt>Status</dt>
