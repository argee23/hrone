    ...
    <div class="box-body">
      <div class="col-md-8"> <!-- Form Content -->
        <span class="dl-horizontal col-sm-6">
          ...
          <dd><?php echo $form->info->form->month_from . "/" . $form->info->form->day_from . "/" . $form->info->form->year_from . " to " . $form->info->form->month_to . "/". $form->info->form->day_to . "/".$form->info->form->year_to; ?></dd>
