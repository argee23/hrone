<!-- Modal -->
<div class="modal fade" id="emp_call_out" role="dialog">
      ...
      <div class="modal-body">
        ...
        <div class="panel-body">
          <span class="dl-horizontal col-sm-6">
            ...
            <dd>{{form_name}}</dd>
            <dt>Call Out Date</dt>
            <dd>{{form.call_out_date  | date: "mediumDate"}}</dd>
         
          <dt>Call Out Time In</dt>
            <dd>{{form.call_out_time_in}}</dd>
            <dt>CAll Out Time Out</dt>
            <dd>{{form.call_out_time_out}}</dd>
            
            <dt>Call Out Time In Date</dt>
            <dd>{{form.call_out_time_in_date  | date: "mediumDate"}}</dd>
            <dt>Call Out Time Out Date</dt>
            <dd>{{form.call_out_time_out_date  | date: "mediumDate"}}</dd>
