<!-- Modal -->
<div class="modal fade" id="emp_grocery_items_loan" role="dialog">
       ...
       <span class="text-info"><strong><a href="<?php echo base_url();?>/employee_portal/form_approver/view/{{form.doc_no}}/{{table_name}}/{{form_name}}" target="_blank">{{form.doc_no}}</a></strong></span>
        ...
        <div class="panel-body">
          <span class="dl-horizontal col-md-6">
            ...
            <dd>{{form_name}}</dd>
            <dt>Worth</dt>
            <dd>{{form.grocery_items_worth}}</dd>
            <dt>Net Pay</dt>
            <dd>{{form.net_pay}}</dd>
            <dt>Cripples/Coop Balance</dt>
            <dd>{{form.coop_balance}}</dd>
            <dt>Last Payroll Period</dt>
            <dd>{{form.month_from + "/" +form.day_from+"/"+form.year_from+ " to " + form.month_to +"/"+form.day_to+"/"+form.year_to}}</dd>
          </span>
          <span class="dl-horizontal col-md-6">
            <dt>Date Filed</dt>
