<!-- Modal -->
<div class="modal fade" id="emp_atro" role="dialog">
      ...
      <div class="modal-body">
        ...
        <div class="panel-body">
          <span class="dl-horizontal col-sm-6">
            ...
            <dd>{{form_name}}</dd>
            <dt>No. of Hours</dt>
            <dd>{{form.no_of_hours}}</dd>
            <dt>Conversion Type</dt>
            <dd ng-show="form.atro_conversion == 'IL'">Convert to Incentive Leave</dd>
            <dd ng-show="form.atro_conversion == 'with_pay'">With Pay</dd>
            <dt>ATRO Date</dt>
            <dd>{{form.atro_date | date: "mediumDate"}}</dd>
          </span>
          <span class="dl-horizontal col-sm-6">
            <dt>Date Filed</dt>
        ...
        <input type="hidden" class="form-control" rows="2" name="company_id" id="company_id" value="{{filer.company_id}}">
        <div class="col-sm-6">
