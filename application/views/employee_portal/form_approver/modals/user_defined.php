      ...
      <div class="modal-body">
        ...
        <div class="panel-body">
          <span class="dl-horizontal col-sm-6">
            ...
            <dd>{{form_name}}</dd>
            <span ng-repeat="(key, val) in form" ng-if="key != 'id' && key != 'employee_id' && key != 'doc_no' && key != 'date_created' && key != 'status' && key != 'IsDeleted' && key != 'remarks' && key != 'InActive' && key != 'status_update_date' && key != 'entry_type' && key != 'company_id'">
            <dt>{{key}}</dt>
            <dd>{{val}}</dd>
