<!-- Modal -->
<div class="modal fade" id="emp_time_complaint" role="dialog">
      ...
      <div class="modal-body">
        ...
        <div class="panel-body">
          <span class="dl-horizontal col-sm-6">
            ...
            <dd>{{form_name}}</dd>
            <dt>Time In Date</dt>
            <dd>{{form.time_in_date | date: "mediumDate"}}</dd>
            <dt>Time Out Date</dt>
            <dd>{{form.time_out_date | date: "mediumDate"}}</dd>
             <dt>Time In</dt>
            <dd>{{form.time_in}}</dd>
            <dt>Time Out</dt>
            <dd>{{form.time_out}}</dd>
          ...
          <span class="dl-horizontal col-sm-6">
            ...
            <dt>Covered Date</dt>
            <dd>{{form.covered_date | date: "mediumDate"}}</dd>
            <dt>Reason</dt>
            <dd>{{form.reason}}</dd>
            <dt>Status</dt>
            <dd>{{form.status}}</dd>
