<br> 
<form enctype="multipart/form-data" method="post" action="<?php echo base_url()?>employee_portal/reports_personnel_attendance/saveupdate_crystal_report" >
      ...
      <div class="box box-default"></div>
        <h4><center><n class="text-danger">Check the fields you want to view in printing reports</n></center></h4>
          <?php  $i=0; foreach($crystal_report_list as $row) {
           $checked=$this->reports_personnel_attendance_model->crystal_report_details_fields($crd->id,$row->id);
          ...
          <div class="box box-default"></div>
            ...
            <a class="btn btn-warning pull-right" style="margin-left: 4px;margin-right: 4px;"  onclick="action_crystal_report('delete','<?php echo $crystal_id;?>');" >DELETE</a>
