                      ...
                      <?php $i=1; foreach($crystal_report as $c){?>
                          <tr>
                              ...
                              <td>
                                   ...
                                   <a  style='cursor:pointer;color:<?php echo $system_defined_icons->icon_view_color;?>' onclick="viewupdate_crystal_report('view','<?php echo $c->id;?>');" aria-hidden='true' data-toggle='tooltip' title='Click to View Crystal Report'  ><i  class="fa fa-<?php  echo $system_defined_icons->icon_view;?> fa-lg  pull-left"></i></a>

                                   <a  style='cursor:pointer;color:<?php echo $system_defined_icons->icon_delete_color;?>' onclick="action_crystal_report('delete','<?php echo $c->id;?>');" aria-hidden='true' data-toggle='tooltip' title='Click to Delete Crystal Report'  ><i  class="fa fa-<?php  echo $system_defined_icons->icon_delete;?> fa-lg  pull-left"></i></a>

                                   <a style='cursor:pointer;color:<?php echo $system_defined_icons->icon_edit_color;?>'  onclick="viewupdate_crystal_report('update','<?php echo $c->id;?>');" data-toggle='modal' data-target='#modal'  aria-hidden='true' data-toggle='tooltip' title='Click to Update Crystal Report'  ><i  class="fa fa-<?php  echo $system_defined_icons->icon_edit;?> fa-lg  pull-left"></i></a>
                                  <?php if($c->InActive==1)
                                  {?>
                                    <a  style='cursor:pointer;color:<?php echo $system_defined_icons->icon_disable_color;?>' onclick="action_crystal_report('enable','<?php echo $c->id;?>'); " aria-hidden='true' data-toggle='tooltip' title='Click to Enable Crystal Report'  ><i  class="fa fa-<?php  echo $system_defined_icons->icon_disable;?> fa-lg  pull-left"></i></a>
                                  <?php } else{?>
                                    <a  style='cursor:pointer;color:<?php echo $system_defined_icons->icon_enable_color;?>' onclick="action_crystal_report('disable','<?php echo $c->id;?>'); " aria-hidden='true' data-toggle='tooltip' title='Click to Disable Crystal Report'  ><i  class="fa fa-<?php  echo $system_defined_icons->icon_enable;?> fa-lg  pull-left"></i></a>
                                  <?php } ?>
