    ...
    <!-- Start Content Header (Page header) -->
      <section class="content-header">
        <h1>
          <br>
           Reports
           <small>Personnel Transaction Reports</small>
        </h1>
       <ol class="breadcrumb">
          <br>
 ...
 <script type="text/javascript">
  ...
  function get_transaction(id,identification)
  {
      ...
      xmlhttp.open("GET","<?php echo base_url();?>employee_portal/reports_personnel_transactions/get_transaction/"+id+"/"+identification,true);
      xmlhttp.send();
  }
  ...
  function add_crystal_report(id,identification)
  {
      ...
      xmlhttp.open("GET","<?php echo base_url();?>employee_portal/reports_personnel_transactions/add_crystal_report/"+id+"/"+identification,true);
      xmlhttp.send();
  }
  ...
  function  action_crystal_report(action, id, identification, crystal_id)
  {
        ...
        { 
            ...
            xmlhttp.open("GET","<?php echo base_url();?>employee_portal/reports_personnel_transactions/action_crystal_report/"+action+"/"+id+"/"+identification+"/"+crystal_id,true);
            xmlhttp.send();
        }
  }
   ...
   function viewupdate_crystal_report(action, id, identification, crystal_id)
   {
            if (window.XMLHttpRequest)
              ...
              xmlhttp.open("GET","<?php echo base_url();?>employee_portal/reports_personnel_transactions/viewupdate_crystal_report/"+action+"/"+id+"/"+identification+"/"+crystal_id,true);
              xmlhttp.send();
   }
   ...
   function generate_report(id,identification)
   {
      ...
      xmlhttp.open("GET","<?php echo base_url();?>employee_portal/reports_personnel_transactions/generate_report/"+id+"/"+identification,true);
      xmlhttp.send();
   }
    ...
    function generate_report_employment(id,identification)
   {
      ...
      xmlhttp.open("GET","<?php echo base_url();?>employee_portal/reports_personnel_transactions/generate_report_employment/"+id+"/"+identification,true);
      xmlhttp.send();
   }
  ...
  function get_classification(company)
  {
    var xmlhttp;
      if (window.XMLHttpRequest)
              ...
              xmlhttp.open("GET","<?php echo base_url();?>employee_portal/reports_personnel_transactions/get_classification/"+company,true);
              xmlhttp.send();
  }
  ...
  function get_location(company)
  {
    var xmlhttp;
      if (window.XMLHttpRequest)
              ...
              xmlhttp.open("GET","<?php echo base_url();?>employee_portal/reports_personnel_transactions/get_location/"+company,true);
              xmlhttp.send();
  }
  ...
  function get_department(company)
  {
     var xmlhttp;
      if (window.XMLHttpRequest)
              ...
              xmlhttp.open("GET","<?php echo base_url();?>employee_portal/reports_personnel_transactions/get_department/"+company,true);
              xmlhttp.send();
  }
  ...
  function emp_get_section(department)
  {
      ...
      else
      {
        ...
        if (window.XMLHttpRequest)
                ...
                xmlhttp.open("GET","<?php echo base_url();?>employee_portal/reports_personnel_transactions/emp_get_section/"+company+"/"+department,true);
                xmlhttp.send();
    }
  }
