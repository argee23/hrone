          ...
          <div class="box-body">
                      <form class="form-horizontal" method="post" action="<?php echo base_url()?>employee_portal/reports_personnel_form_approval/generate_report_result/" target="_blank">
                            ...
                            <div class="col-md-12" style="margin-top: 10px;">
                              <div class="col-md-3">Date From<br> <i>(based on pproval date)</i></div>
                              <div class="col-md-6">
                            ...
                            <div class="col-md-12" style="margin-top: 10px;">
                              <div class="col-md-3">Date To <br><i>(based on pproval date)</i></div>
                              <div class="col-md-6">
