  ...
  <div class="col-md-12" style="padding-bottom: 50px;" id="action"> 
    <div class="col-md-12">
      <div class="col-md-12" style="margin-top: 20px;">
                      <form class="form-horizontal" method="post" action="<?php echo base_url()?>employee_portal/reports_personnel_approved_ot/generate_report_result_employment/" target="_blank">
