      ...
      <div class="box box-default"></div>
        <h4><center><n class="text-danger">Check the fields you want to view in printing reports</n></center></h4>
          ...
          <div class="col-md-4">
            ...
            <div class="col-md-1"><input type="checkbox" class="option_check" name="checkselected<?php echo $row->id?>"  value="<?php echo $row->id?>" id="r_<?php echo $i?>" <?php echo $dd;?> disabled></div>
          </div>
          ...
          <div class="box box-default"></div>
            ...
            <button class="btn btn-warning pull-right" style="margin-left: 4px;margin-right: 4px;"  onclick="del_stat_crystal_report('<?php echo $id;?>')">DELETE</button>
