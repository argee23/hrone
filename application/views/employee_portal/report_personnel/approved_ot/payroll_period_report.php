      ...
      <div class="col-md-12" style="padding-top: 30px;" id="all_action">
          <div class="col-md-12">
                      <form class="form-horizontal" method="post" action="<?php echo base_url()?>employee_portal/reports_personnel_approved_ot/generate_report_result_payroll_period/" target="_blank">
                            ...
                            <div class="col-md-12" style="margin-top: 10px;">
                              <div class="col-md-3">Option<br></div>
                              <div class="col-md-6">
