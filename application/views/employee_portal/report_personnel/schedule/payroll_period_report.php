  ...
  <div class="col-md-12" style="padding-bottom: 50px;" id="action"> 
    <div class="box box-success">
      ...
      <div class="col-md-12" style="padding-top: 30px;" id="all_action">
          ...
          <div class="box-body">
                      <form class="form-horizontal" method="post" action="<?php echo base_url()?>employee_portal/reports_personnel_schedule/generate_report_result_payroll_period/" target="_blank">
