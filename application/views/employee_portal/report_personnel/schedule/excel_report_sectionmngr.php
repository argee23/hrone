...
?>
<form enctype="multipart/form-data" method="post" action="<?php echo base_url()?>employee_portal/reports_personnel_schedule/excel_report_section_mngr_result" target="_blank">
<div class="col-md-12">    
        ...
        <div class="col-md-12" style="margin-top: 10px;">
         ...
         <div class="col-md-3">  
              <label class="pull-right">Select Fields</label> 
                    ...
                    <input type='hidden' name='grp' id='grp' value="<?php echo $grp;?>">
