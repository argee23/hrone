...
if($proceed_acknowledge=="yes"){
	...
	$check_first=$this->My_payslip_model->check_acknowledge_tertin_month_payslip($company_id,$employee_id,$payroll_period_id,$month_cover);
	...
	if($is_already_acknow=="no" OR $is_already_acknow==""){
		...
		$this->My_payslip_model->acknowledge_tertin_month_payslip($company_id,$employee_id,$payroll_period_id,$month_cover);
		$ispayslip_viewed=1;
	}else{
