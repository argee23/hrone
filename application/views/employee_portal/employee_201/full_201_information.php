        ...
        <!--start here-->
          <div class="col-md-12">
              ...
              <table class="table table-bordered" id="des">
                ...
                <!--Personal Information-->
                  ...
                  <tr>
                    ...
                    <td>  <n class='text-danger'><?php if (empty($info->age)) {} else { echo $this->employee_201_model->calculate_interval($info->birthday);?> <?php }?></n></td>
                  ...
                  <tr>
                    ...
                    <td><n class='text-danger'><?php echo $info->civil_status?></n></td>
                  </tr>
                ...
                <!--Start of address details-->
                  ...
                  <tr>
                    ...
                    <td><n class='text-danger'><?php echo $info->permanent_city_name?></n></td>
                    <td><n class='text-success'>Province </n></td>
                    <td><n class='text-danger'><?php echo $info->permanent_province_name?></n></td>
                    <td rowspan='7' colspan="7"> <center><img class="img img-thumbnail bg-gray" style="width: 250px;height:150px; " src="<?php echo base_url(); ?>public/employee_files/residence/<?php echo $info->residence_map; ?>"></center></td>
                  </tr>
                  <tr>
                    <td colspan='1' align="right" style="width:20%"><n class='text-success'>Address</n></td>
                    <td><n class='text-danger'><?php echo $info->permanent_address?></n></td>
                    <td><n class='text-success'>Years of Stay </n></td>
                    <td><n class='text-danger'><?php echo $info->permanent_address_years_of_stay?></n></td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    <td colspan='1' align="right" style="width:20%"><n class='text-success'>City :</n></td>
                    <td><n class='text-danger'><?php echo $info->present_city_name?></n></td>
                    <td><n class='text-success'>Province </n></td>
                    <td><n class='text-danger'><?php echo $info->present_province_name?></n></td>
                    
                  </tr>
                  <tr>
                    <td colspan='1' align="right" style="width:20%"><n class='text-success'>Address :</n></td>
                    <td><n class='text-danger'><?php echo $info->present_address?></n></td>
                    <td><n class='text-success'>Years of Stay </n></td>
                    <td><n class='text-danger'><?php echo $info->present_address_years_of_stay?></n></td>
                  </tr>
                ...
                <!--Start of contact details-->
                  ...
                  <tr>
                    ...
                    <td colspan="1"><n class='text-danger'><?php echo $info->mobile_1?></n></td>
                    <td colspan="1"><n class='text-danger'><?php echo $info->mobile_2?></n></td>
                    <td colspan="1"><n class='text-danger'><?php echo $info->mobile_3?></n></td>
                    <td colspan="2"><n class='text-danger'><?php echo $info->mobile_4?></n></td>
                  </tr>
                  <tr>
                    <td colspan='2' align="right" style="width:20%"><n class='text-success'>Mobile Number </n></td>
                    <td colspan="1"><n class='text-danger'><?php echo $info->tel_1?></n></td>
                    <td colspan="4"><n class='text-danger'><?php echo $info->tel_2?></n></td>
                  ...
                  <tr>
                    ...
                    <td colspan="2"><n class='text-danger'><?php echo $info->email?></n></td>
                    <td colspan='1' align="right" style="width:20%"><n class='text-success'>Facebokk </n></td>
                    <td colspan="2"><n class='text-danger'><?php echo $info->facebook?></n></td>
                  </tr>
                  
                  <tr>
                    <td colspan='2' align="right" style="width:20%"><n class='text-success'>Twitter </n></td>
                    <td colspan="2"><n class='text-danger'><?php echo $info->twitter?></n></td>
                    <td colspan='1' align="right" style="width:20%"><n class='text-success'>Instagram </n></td>
                    <td colspan="2"><n class='text-danger'><?php echo $info->instagram?></n></td>
                  </tr>
                ...
                <!--start of employment details-->
                  ...
                  <tr>
                    ...
                    <td colspan="2"><n class='text-danger'><?php echo $info->employment_info->division_name;?></n></td>
                    <td colspan='1' align="right" style="width:20%"><n class='text-success'>Department </n></td>
                    <td colspan="2"><n class='text-danger'><?php echo $info->employment_info->dept_name;?></n></td>
                  </tr>
                  <tr>
                    <td colspan='2' align="right" style="width:20%"><n class='text-success'>Section </n></td>
                    <td colspan="2"><n class='text-danger'><?php echo $info->employment_info->section_name;?></n></td>
                    <td colspan='1' align="right" style="width:20%"><n class='text-success'>Subsection </n></td>
                    <td colspan="2"><n class='text-danger'><?php echo $info->employment_info->subsection_name;?></n></td>
                  </tr>
                  <tr>
                    <td colspan='2' align="right" style="width:20%"><n class='text-success'>Position </n></td>
                    <td colspan="2"><n class='text-danger'><?php echo $info->employment_info->position_name;?></n></td>
                    <td colspan='1' align="right" style="width:20%"><n class='text-success'>Employment </n></td>
                    <td colspan="2"><n class='text-danger'><?php echo $info->employment_info->employment_name;?></n></td>
                  </tr>
                  <tr>
                    <td colspan='2' align="right" style="width:20%"><n class='text-success'>Classification </n></td>
                    <td colspan="2"><n class='text-danger'><?php echo $info->employment_info->classification_name;?></n></td>
                  </tr>
              ...
              <table class="table table-bordered" id="des">
                ...
                <?php if(empty($family)){ echo "<tr><td colspan='7'><n class='text-info'> NO DATA FOUND.</n></td></tr>";} else{ foreach ($family as $fam) { ?>
                  ...
                  <tr>
                    ...
                    <td><n class='text-success'>Age </n></td>
                    <td><n class='text-danger'><?php if (empty($fam->age)) {} else { echo $this->employee_201_model->calculate_interval($fam->birthday);?> <?php }?></n> </td>
                  </tr>
                  <tr>
              ...
              <table class="table table-bordered" id="des">
                ...
                <tbody>
                <?php if(empty($educ)){ echo "<tr><td colspan='7'><n class='text-info'> NO DATA FOUND.</n></td></tr>";} else{ foreach ($educ as $ed) { ?>
                  <tr>
              ...
              <table class="table table-bordered" id="des">
                ...
                <tbody>
                <?php if(empty($work)){ echo "<tr><td colspan='7'><n class='text-info'> NO DATA FOUND.</n></td></tr>";} else{ foreach ($work as $w) { ?>
                  <tr>
              ...
              <table class="table table-bordered" id="des">
                ...
                <tbody>
                <?php if(empty($trainings)){ echo "<tr><td colspan='7'><n class='text-info'> NO DATA FOUND.</n></td></tr>";} else{ foreach ($trainings as $t) { ?>
                  <tr>
              ...
              <table class="table table-bordered" id="des">
                ...
                <tbody>
                <?php if(empty($char)){ echo "<tr><td colspan='7'><n class='text-info'> NO DATA FOUND.</n></td></tr>";} else{ foreach ($char as $c) { ?>
                  <tr>
              ...
              <table class="table table-bordered" id="des">
                ...
                <tbody>
                <?php if(empty($dep)){ echo "<tr><td colspan='7'><n class='text-info'> NO DATA FOUND.</n></td></tr>";} else{ foreach ($dep as $d) {  $name=$d->first_name." ".$d->middle_name." ".$d->last_name. "".$d->name_ext."";?>
                  <tr>
              ...
              <table class="table table-bordered" id="des">
                ...
                <tbody>
                <?php if(empty($skills)){ echo "<tr><td colspan='7'><n class='text-info'> NO DATA FOUND.</n></td></tr>";} else{ foreach ($skills as $s) { ?>
                  <tr>
               ...
               <table class="table table-bordered" id="des">
                ...
                <?php if(empty($employee_udf)){ echo "<tr><td colspan='7'><n class='text-info'> NO DATA FOUND.</n></td></tr>";} else{ 
                  ...
                  <tr>
                    ...
                    <td colspan="5"><n class='text-danger'>                         <?php 
