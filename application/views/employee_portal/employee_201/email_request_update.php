...
<h3>Status : <a style="color:blue;"><?php echo $stat_all?></a></h3>
  ...
  <tr>
   ...
   <br>
   <strong>
    <br>Request for 201 Update</strong>
    </th>
  </tr>
  <tr>
    <th colspan="4"></th>
  ...
  <?php $me = $this->employee_transactions_model->getInfo($this->session->userdata('id'));?>
  <tr>
