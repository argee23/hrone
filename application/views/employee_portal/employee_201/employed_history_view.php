...
<div class="panel panel-success">
  <div class="panel-heading"><strong>EMPLOYMENT DATES HISTORY</strong>
  <?php if(empty($employed_history_view)){}else{?><a class="btn btn-success btn-xs pull-right" style="cursor: pointer;" onclick="view_detailed_history();">View more details</a><?php } ?>
         ...
         <div class="force-overflow">
          <div class="row">
            ...
            <table class="table table-bordered" id="example1">
              ...
              <tbody>
              <?php foreach($employed_history_view as $res){?>
                <tr>
                  <td>
            ...
            <?php if(!empty($employed_history_view))
            { foreach($employed_history_view as $res){ ?>
                <div class="panel panel-danger">
                  <div class="panel-heading"><strong>Employment Date :
                    <?php $month=substr($res->date_employed, 5,2);
                      $day=substr($res->date_employed, 8,2);
                      $year=substr($res->date_employed, 0,4);
                        ...
                        <table class="table table-bordered table-striped">
                          <tbody>
                            <tr>
                              ...
                              <td>Details: </td>
                              <td><n class="text-info"><?php echo $res->details;?></n></td>
                            </tr>
