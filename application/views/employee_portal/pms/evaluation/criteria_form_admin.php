                                  ...
                                  <table class="table table-bordered" >
                                          <tbody> 
                                                ...
                                                foreach($res2 as $res2){?>
                                                  <tr><td style="text-align: left; vertical-align: left; width:50%;"><?php echo $res2->description.'<br>';?></td>
                                                    <?php if(!empty($res1->measurement)){ ?><td><b>measurement:</b> <?php echo $res1->measurement.'%<br>';?></td><?php } ?>
                                                    <td><b>Weight:</b> <?php echo $res2->weight.'%<br>';?></td>

                                                               <?php if(!empty($res1->target)){ ?><td><b>target:</b> <?php echo $res1->target.'%<br>';?></td><?php } ?>
                                                   ...
                                                   <input type="hidden" id="w" name="weight[]" value="<?php echo $res2->weight; ?>"  >
                                                    <input type="hidden" name="criteria_id[]" value="<?php echo $res2->id ?>"  >
                                                            ...
                                                            <input type="hidden" name="c" value="admin"  >
                                                              ...
                                                              <input class="form-control" type="hidden" name="appraisal_date" value="<?php echo $get_date->appraisal_period_type_dates ?>" ?>
...
<?php $e = $this->pms_model->self_eval_score($doc_no,$res2->id,'admin'); if($e){     ?>
                                                <?php foreach($e as $e) { ?>
                                  <tr>  <?php                
                                                ...
                                                <td><?php        echo '<strong>Evaluator level :</strong>0<br>'; ?></td><td><?php echo '<strong>Name :</strong>'.$e->fullname.'<br>';?></td><td><?php   echo '<strong>score :</strong>'.$e->score; ?></td>
                                      
                                                <?php  }?></tr><?php }} ?>
<?php $w = $this->pms_model->qweqwewqe($doc_no,$res2->id,'admin'); if($w){     ?>
                                  ...
                                  <tr>               
                                           ...
                                           <td>
                                                 ...
                                                 <?php   foreach($w as $w) {  
                                                  ...
                                                  if($w->employee_id==$this->session->userdata('employee_id')){
                                                                
                                                                
                                                  }else{?>
                                                  <?php echo  '<strong>'.$w->fullname.str_repeat("&nbsp;", 20).'</strong>'.$w->score.str_repeat("&nbsp;", 10).'<br>';  ?>   
                  ...
                  Comments
                  <textarea  class="form-control" style="height: 90px;" name="com[]"><?php echo $com; ?></textarea>
           </div>
                            </div>
                        </div>
                    </div>
