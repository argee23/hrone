        ...
        <table class="table table-responsive">
          ...
          <tbody>
              ...
              <tr>
                ...
                <td><?=$mf->doc_no?></td>
                <td>
                  <?php $q = $this->pms_model->get_current_appraisal_schedule($mf->doc_no); echo date("F d, Y", strtotime($mf->appraisal_period_type_dates));; ?>
                </td>
                <td><?php $q = $this->pms_model->get_current_appraisal_schedule($mf->doc_no); echo $mf->coverage; ?></td>
                <td>
                  <?php if($mf->status == 'pending'){?>
                    <span class="label label-warning">Pending</span>
                  <?php }else if($mf->status == 'approved'){?>
