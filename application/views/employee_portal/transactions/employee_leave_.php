            ...
            <div class="col-md-12" style="overflow: auto;">
                 ...
                 <table class="table table-bordered" id="blocked_leave">
                      ...
                      if($leave->is_system_default=="1"){// do not show na here the incentive leave for offset : kc nakaseparate sya sa baba.
                        ...
                        ?>
                        <tr>
                          <td><?php echo $leave->leave_type_id;?><input type="hidden" value="<?php echo $av?>" name="id<?php echo $leave->leave_type_id?>" id="id<?php echo $leave->leave_type_id?>"></td>
                          <td><?php echo $leave->leave_type?></td>
                          <td><?php echo $leave->available?></td>
                          <td><?php if(empty($with_pay)){ echo "0"; } else { echo $with_pay; }?></td>
                          <td><?php if(empty($approved)){ echo "0"; } else { echo $approved; }?></td>
                           <td><?php if(empty($count_pending_leave)){ echo "0"; } else { echo $count_pending_leave; }?></td>
                          <td><?php echo $av;?></td>
                        </tr>
...
//=========================Start incentive leave
          ...
          <tr>
            ...
            <td>'.$il_leave_type->leave_type.'</td>
