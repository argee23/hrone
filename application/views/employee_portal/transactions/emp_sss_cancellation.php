...
<div class="panel panel-default">
  ...
  <h4 class="panel-header">REQUEST OF SSS CANCELLATION</h4>
  <hr>
  ...
  <form class="form-horizontal" name="add_med_re" method="post" enctype="multipart/form-data"  action="add_cancel_sss" onsubmit="document.getElementById('smbt').disabled=true;">
