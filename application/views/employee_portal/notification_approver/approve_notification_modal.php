 <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <?php } ?>
         ...
         <form class="form-horizontal" method="post" action="<?php echo base_url()?>employee_portal/notification_approver/respond_notification" >
         <div class="panel panel-default">
        <div class="panel-heading">
        ...
        <input type="hidden" name="approval_level" value="<?php echo $approval_level;?>">
        <div class="radio">
