...
<div class="col-md-12">
        ...
        <div class="col-md-10">
            <form enctype="multipart/form-data" method="post" action="<?php echo base_url()?>employee_portal/overtime_management_section_mngr_approved_ot/save_update_approved_ot_group/" >
