 <table class="table table-hover" id="overtime">
                  <thead>
                      <tr class='danger'>
                        ...
                        <th><center><input type="text" id="hrs" style="width:50px;margin-left:20px;" onkeypress="return isNumberKey(this, event);" placeholder="Hrs" onkeyup="hours_all(this.value,'All');"></center></th>
