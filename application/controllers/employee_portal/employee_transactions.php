...
class Employee_transactions extends General {
	...
	function __construct() {
		...
		$this->load->model("employee_portal/employee_transactions_leave_credits_model");
	...
	public function redirect_to($page)
	{
		...
		else
		{
			...
			{
				//per hour leave
				$this->data['allow_per_hour_leave']  = $this->employee_transactions_model->allow_per_hour_leave_settings();
				$this->data['compress_schedule'] = $this->employee_transactions_leave_compress_model->compress_schedule();
				...
				$this->data['incentive_leave'] = $this->employee_transactions_model->get_incentive_leave_credit_allow($this->session->userdata('employee_id'),$il_leave_type->id);
...
public function get_filed_in_between($payroll_period, $status, $tbl , $form_name , $option , $date_from , $date_to)
	...
	public function get_leave_details($id,$cutoff)
	{
