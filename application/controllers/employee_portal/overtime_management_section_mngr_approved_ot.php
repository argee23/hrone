...
class Overtime_management_section_mngr_approved_ot extends General {

	function __construct() {
		parent::__construct();	
		$this->load->model("employee_portal/overtime_management_section_mngr_approved_ot_model");
	...
	{
		$this->data['plotted'] = $this->overtime_management_section_mngr_approved_ot_model->plotted_details();
		$this->data['group_members'] = $this->overtime_management_section_mngr_approved_ot_model->group_members_checker();
		$this->data['message'] = $this->session->flashdata('message');
		$this->data['onload'] = $this->session->flashdata('onload');
		$this->load->view('employee_portal/header');	
		$this->load->view('employee_portal/overtime_management/approved_ot/approved_overtime', $this->data);
	...
	public function add_new_group()
	{
		...
		$this->load->view('employee_portal/overtime_management/approved_ot/add_new_group', $this->data); 
	}
	...
	{
		$insert = $this->overtime_management_section_mngr_approved_ot_model->save_approved_ot_group();
		...
		redirect(base_url().'employee_portal/overtime_management_section_mngr_approved_ot/index',$this->data);
	}
	...
	{
		$this->data['id'] = $id;
		$this->data['details'] = $this->overtime_management_section_mngr_approved_ot_model->edit_group_approved_ot($id);
		$this->load->view('employee_portal/overtime_management/approved_ot/edit_group_approved_ot', $this->data); 
	}
	...
	{
		$insert = $this->overtime_management_section_mngr_approved_ot_model->save_update_approved_ot_group();
	...
	{
		$this->data['id'] = $id;
		$this->data['plotted'] = $this->overtime_management_section_mngr_approved_ot_model->view_approved_ot($id,$date);
		$this->load->view('employee_portal/overtime_management/approved_ot/approved_overtime_employee', $this->data);
	}

	//delete group 
	public function delete_approved_ot($id,$date)
	{
		$delete = $this->overtime_management_section_mngr_approved_ot_model->delete_approved_ot($id);
	...
	{
		$this->data['date']=$date;
		$this->data['group_members'] = $this->overtime_management_section_mngr_approved_ot_model->group_members();
		$this->load->view('employee_portal/overtime_management/approved_ot/general_allowed_overtime_members', $this->data); 
	}
	...
	{
		$insert = $this->overtime_management_section_mngr_approved_ot_model->save_approved_ot($emp,$hrs,$reason,$count,$date);
	}
	...
	public function add_member_approved_ot($id,$date)
	{
		...
		$this->data['reason']=$this->overtime_management_section_mngr_approved_ot_model->get_ot_reason($id);
		$this->data['group_members'] = $this->overtime_management_section_mngr_approved_ot_model->group_members();
		$this->data['selected_group_member'] = $this->overtime_management_section_mngr_approved_ot_model->selected_group_member($id);
		$this->load->view('employee_portal/overtime_management/approved_ot/add_member_approved_ot', $this->data); 

	}

	public function add_member_save_pre_approved($id,$date,$hours,$employee,$count,$reason)
	{
		$insert = $this->overtime_management_section_mngr_approved_ot_model->add_member_save_pre_approved($id,$date,$hours,$employee,$count,$reason);
	}

	//delete
	public function delete_approved_ot_member($id,$idd,$date)
	{
		$delete = $this->overtime_management_section_mngr_approved_ot_model->delete_approved_ot_member($id);
	...
	public function upload_approved_ot_group($id,$date)
	{
		$this->data['id'] = $id;
		$this->data['date'] = $date;
		$this->load->view('employee_portal/overtime_management/approved_ot/upload_approved_ot_group', $this->data);
	}
							...
							?>
								<tr>
									...
									<td>
										...
										<?php 
												$name = $this->overtime_management_section_mngr_approved_ot_model->employee_name($employee_id);
												echo $employee_id.' ('.$name.')';
												$check_employee = $this->overtime_management_section_mngr_approved_ot_model->check_employee_under_sm($employee_id);
												...
												{
													$check_employee_existing_ot_hr = $this->overtime_management_section_mngr_approved_ot_model->check_employee_with_existing_ot_hr($employee_id,$date,$id);
													if(empty($check_employee_existing_ot_hr))
													{
															$check_employee_existing = $this->overtime_management_section_mngr_approved_ot_model->check_employee_with_existing($employee_id,$date,$id);
									...
									<td>
										<?php
					                        ...
					                        $yy =  date("Y", strtotime($datef));
					                        			$attendance = $this->overtime_management_section_mngr_approved_ot_model->get_employee_attendance($employee_id,$date);
					                                    $individual_schedules = $this->overtime_management_section_mngr_approved_ot_model->get_individual_schedules($employee_id,$datef,$m,$yy);
					                                    ...
					                                    {
					                                      $fixed_schedules = $this->overtime_management_section_mngr_approved_ot_model->checker_if_fixed_sched($employee_id,$datef);
					                                      ...
					                                      {
					                                          $group_schedules = $this->overtime_management_section_mngr_approved_ot_model->checker_if_group_sched($employee_id,$datef);
									...
									<td>
										<?php if($action=='Save')
										{
											...
											if($error==false)
											{
												...
												$insert_data = $this->overtime_management_section_mngr_approved_ot_model->insert_approved_ot($id,$date,$employee_id,$ot_hour);
	...
	public function save_ot_approved_ot($id,$date)
	{
		...
		$insert = $this->overtime_management_section_mngr_approved_ot_model->saveapproved_ot($id,$date);
		$this->session->set_flashdata('check',"1");
		$this->session->set_flashdata('onload',"checker()");
		redirect(base_url().'employee_portal/overtime_management_section_mngr_approved_ot/add_member_approved_ot/'.$id.'/'.$date,$this->data);
	}

	public function get_filtered_approved_ot($from,$to)
	{
		$this->data['plotted'] = $this->overtime_management_section_mngr_approved_ot_model->get_filtered_approved_ot($from,$to);
		$this->load->view('employee_portal/overtime_management/approved_ot/filtered_approved_ot', $this->data);
	}

	public function employee_approved_ot($employee_id,$date)
	{
		$this->data['plotted'] = $this->overtime_management_section_mngr_approved_ot_model->employee_approved_ot($employee_id,$date);
		$this->load->view('employee_portal/overtime_management/approved_ot/employee_approved_ot', $this->data);
	}
