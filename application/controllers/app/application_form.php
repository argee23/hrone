...
class Application_form extends General{
	...
	public function search_job_main($criteria,$category, $province,$city,$specialization,$rangefrom,$rangeto,$criteria)
	{
		$data = $this->application_form_model->search_a_job_main($criteria, $category ,$province,$city,$specialization,$rangefrom,$rangeto,$criteria);
		echo json_encode($data);
	}

	public function search_job_location($criteria,$category,$province,$city)
	{
		$data = $this->application_form_model->search_a_job_location($criteria,$category,$province,$city);
		echo json_encode($data);
	}

	public function search_job_specialization($specialization)
	{
		$data = $this->application_form_model->search_job_specialization($specialization);
		echo json_encode($data);
	}

	public function search_job_salary($criteria,$category,$salaryfrom,$salaryto)
	{
		$data = $this->application_form_model->search_job_salary($criteria,$category,$salaryfrom,$salaryto);
		echo json_encode($data);
	}
	...
	public function update_priority_choice()
	{
		$id = $this->session->userdata('employee_id');
		$update = $this->application_form_model->update_priority_choice($id);
		$this->session->set_flashdata('feedback', 'You have successfully updated your priority choice.');
		redirect('app/application_form/profile#priority_choice');
	}
