...
class Payroll_other_deduction_emp_enrollment extends General{

	function __construct(){
		parent::__construct();	
		$this->load->model("app/payroll_other_deduction_emp_enrollment_model");
...
public function other_deduction_emp_enrollment_option(){	 

		$company_id=$this->uri->segment('4');
		$this->data['company_classifications']= $this->general_model->get_company_classifications($company_id);
		$this->data['paytypeList_deduction'] = $this->payroll_other_deduction_emp_enrollment_model->paytypeList_deduction();
		$this->load->view('app/payroll/other_deduction_emp_enrollment/other_deduction_select_option',$this->data);		
	}

public function other_deduction_manual_encoding(){	 

		$company_id=$this->uri->segment('4');
		$this->data['company_classifications']= $this->general_model->get_company_classifications($company_id);
		$this->data['paytypeList_deduction'] = $this->payroll_other_deduction_emp_enrollment_model->paytypeList_deduction();
		$this->load->view('app/payroll/other_deduction_emp_enrollment/view',$this->data);		
	}	
//GET GROUP BY PAYTYPE=================================================================================
	public function by_group(){	
			...
			$this->load->view('app/payroll/other_deduction_emp_enrollment/by_group',$this->data);	
...
//GET PAYROLL PERIOD BY GROUP PAYTYPE=================================================================================
	public function by_payroll_period(){	
		...
		$this->data['pay_per_deduction'] = $this->payroll_other_deduction_emp_enrollment_model->payroll_per_per_company_pay_type($company_id,$pay_type,$pay_type_group);//$company_id

		$this->data['deduction_type'] = $this->payroll_other_deduction_emp_enrollment_model->getDeductionTypes($company_id);	
			$this->load->view('app/payroll/other_deduction_emp_enrollment/by_payroll_period',$this->data);	
...
public function show_div_dept(){
		...
		$this->load->view('app/payroll/other_deduction_emp_enrollment/show_div_dept',$this->data);
	}	
...
public function show_section(){
		...
		$this->load->view('app/payroll/other_deduction_emp_enrollment/show_section',$this->data);
	}	
	
public function clear_fetched_sub_sec(){

		$this->load->view('app/payroll/other_deduction_emp_enrollment/show_clear_fetched_sub_sec',$this->data);
	}
...
public function show_sub_section(){
		...
		$this->load->view('app/payroll/other_deduction_emp_enrollment/show_sub_section',$this->data);
	}
public function generate_deduction(){
		...
		$this->data['employee'] = $this->payroll_other_deduction_emp_enrollment_model->get_deduction_employeeList($company_id,$comp_division_setting,$sub_sec_setting,$pay_type_group);
		$this->data['deduction_enrollment'] = $this->payroll_other_deduction_emp_enrollment_model->getDeductionEnrollments();
		$this->data['deduction_type'] = $this->payroll_other_deduction_emp_enrollment_model->getDeductionTypes($company_id);	
		$this->load->view('app/payroll/other_deduction_emp_enrollment/generate_deduction',$this->data);
	}
...
function save_deduction_enrollment(){
		...
		$this->payroll_other_deduction_emp_enrollment_model->save_deduction_enrollment(); //pati po yung nasa parenthesis nito
