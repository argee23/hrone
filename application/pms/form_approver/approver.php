            ...
            <tbody>   
             ...
             <?php foreach ($employee as $employee)
              ...
              <tr class="my_hover">
                      ...
                      <td><a onclick="dependents_modal('<?php echo $employee->doc_no ?>','<?php echo $employee->fullname ?>','<?php echo $employee->classification ?>','<?php echo $employee->position_name ?>','<?php echo $employee->dept_name ?>','<?php echo $employee->location_name ?>','<?php echo $employee->doc_no ?>','<?php echo $employee->employee_id ?>','<?php echo $employee->appro_level; ?>');get('<?php echo $employee->appro_level ?>','<?php echo $employee->doc_no ?>','<?php echo $employee->employee_id ?>'); form_name='<?php echo $employee->doc_no ;?>'; table_name='<?php echo $employee->doc_no ?>'; identification='<?php echo $employee->doc_no ;?>'" href="<?php base_url('employee_portal/pms/get_form_details/'); ?>" data-toggle="modal" data-target="#myModal1"><strong><?php echo strtoupper($employee->doc_no) ?></strong></a></td>
                        
                  <td><?php echo strtoupper($employee->fullname) ?></td>
              
                <td><center><a href="" target="_blank"><span class="badge bg-green">View Details</span></a></center></td>
              </tr>
...
function dependents_modal(doc_no,name,classification,position,dept,l,ref,employee_id,appro_level){
     ...
     function next_appro(){
            ...
            $.ajax({ 
                ...
                type: 'POST',
                 data: {appro_level:appro_level,doc_no:doc_no,form_title_array:form_title_array,score_array:score_array,weight_array:weight_array,total_array:total_array,c_score_array:c_score_array,rate_array:rate_array,c_cid_array:c_cid_array,c_employee_id:c_employee_id,c_form_part:c_form_part},
