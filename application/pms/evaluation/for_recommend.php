 ...
 <input type="checkbox" class="i" checked="" /> 
    ...
    <!------------------------------------------------------------------------------------------------------------------------------->
                  <div class="col-md-4" style="padding: 10px; text-align: left" ><input type="hidden" name="for_lateral_transfer_ref" value="<?php if(!empty($exist->for_lateral_transfer_ref)){ echo $exist->for_lateral_transfer_ref;} ?>">
                    <label><?php if(!empty($exist->position)){?><input class="Recommend" type="checkbox" checked /> <?php }else{ ?><input class="Recommend" type="checkbox" name="for_lateral_transfer" /> <?php } ?> For Lateral Transfer</label>
                   <select class="form-control" name="position"> <?php if($exist->position){?> <option selected=""><?php echo $exist->position ?></option> <?php }else{foreach($transfer_posi as $position){ ?>  <option value="<?php echo $position->position_name; ?>"><?php echo $position->position_name; ?></option> <?php } } ?> 
                  </select>
                  Department
                    <select class="form-control" name="department"> <?php if($exist->department){?> <option selected=""><?php echo $exist->department ?></option> <?php }else{foreach($dept as $dept){ ?>  <option value="<?php echo $dept->dept_name; ?>"><?php echo $dept->dept_name; ?></option> <?php } }?> </select>
                  </div>
        <!------------------------------------------------------------------------------------------------------------------------------->            
                  <div class="col-md-4" style="padding: 10px; text-align: left" >
