                                  ...
                                  <table class="table table-bordered" >
                                          ...
                                          <div class="col-lg-12 abc">
                                                ...
                                                <?php foreach($e as $e) {
                                                  ...
                                                  <?php }else{
                                                  echo '<strong>Evaluator level :</strong>'.$e->eval_level.'<br>';
                                                  echo '<strong>Name :</strong>'.$e->fullname.'<br>';
                                                  echo '<strong>score :</strong>'.$e->score;
                                                  echo '<hr>';
                                                } } }?>
                                              <div class="star-rating" >
                                                  <?php $q = $this->pms_model->get_score_admin_evaluation($doc_no,$res2->id,'admin'); if($q){       
                                                  foreach($q as $q){
                                                ...
                                                <option selected="" value="<?php echo $c; ?>"> <?php if(!empty($q->score)){echo $q->score.' '; echo $q->score_equivalent; } ?></option>
                                                  <?php foreach($grading as $scale){ if($scale->score != $c){?>
