...
class Payroll_other_addition_excel_upload_model extends CI_Model{
...
public function check_exist($employee_id,$pay_period,$oa_id,$company_id){ 
...
public function insertImport($data)//model for insertImport
    {
        $query = $this->db->insert('other_addition_enrollment', $data); 
		if(!$query)
		{
		   return False;
		}
...
public function insertImportmass($data)//model for insertImport
    {
        $query = $this->db->insert('other_addition_enrollment', $data); 
		if(!$query)
		{
...
public function oaidnotexist($oa_id_checker)
    {    
        $this->db->where('id', $oa_id_checker);
