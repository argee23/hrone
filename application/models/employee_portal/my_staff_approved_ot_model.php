...
class My_staff_approved_ot_model extends CI_Model{
	...
	public function check_employee_filed_ot($employee_id,$date)
	{
		$where = '(status="pending" or status = "approved")';

		$this->db->where(array('employee_id'=>$employee_id,'atro_date'=>$date));
		$this->db->where($where);
